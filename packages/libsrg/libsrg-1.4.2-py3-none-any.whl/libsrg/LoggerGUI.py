...
from libsrg import LoggingWatcher
...
class LoggerGUI:
    ...
    def _service_status(self):
        ...
        if batch:
            self.watcher_lab[
                'text'] = f"Logging counters: {str(libsrg.LoggingCounter.get_instance().count_at_level_name)}"
        for record in batch:
...
class DummyMain(libsrg.LoggingAppBase):
