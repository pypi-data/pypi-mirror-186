...
class TaskHandler:
    ...
    def load_task_handlers(self):
        self.task_handlers = self.load_conf('task_handlers.json')
    ...
    def get_task_handler(self, taskname:str):
        assert taskname in self.task_handlers, f"Task {taskname} not defined."
        return self.task_handlers[taskname]
