...
import geezlibs
from geezlibs import types, raw, utils
...
async def get_chunk(
    *,
    ...
    from_date: datetime = geezlibs.zero_datetime()
):
...
class GetChatHistory:
    async def get_chat_history(
        ...
        offset: int = 0,
        offset_id: int = 0,
        offset_date: datetime = geezlibs.zero_datetime()
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~geezlibs.types.Message` objects.
