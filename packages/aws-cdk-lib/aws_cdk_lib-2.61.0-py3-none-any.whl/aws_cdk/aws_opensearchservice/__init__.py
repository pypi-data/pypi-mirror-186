    ...
    class ServiceSoftwareOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param automated_update_date: ``CfnDomain.ServiceSoftwareOptionsProperty.AutomatedUpdateDate``.
            :param cancellable: ``CfnDomain.ServiceSoftwareOptionsProperty.Cancellable``.
            :param current_version: ``CfnDomain.ServiceSoftwareOptionsProperty.CurrentVersion``.
            :param description: ``CfnDomain.ServiceSoftwareOptionsProperty.Description``.
            :param new_version: ``CfnDomain.ServiceSoftwareOptionsProperty.NewVersion``.
            :param optional_deployment: ``CfnDomain.ServiceSoftwareOptionsProperty.OptionalDeployment``.
            :param update_available: ``CfnDomain.ServiceSoftwareOptionsProperty.UpdateAvailable``.
            :param update_status: ``CfnDomain.ServiceSoftwareOptionsProperty.UpdateStatus``.
