...
def getArea(outputs,d,df):
    ...
    for i in range(len(contours)):
        ...
        #cv2.putText(img, "{}".format(inten), (int(item[100][0][0]), int(item[100][0][1])), cv2.FONT_HERSHEY_SIMPLEX, 2, (192, 245, 162) , 5)
        #cv2.putText(img, "{}".format(round(math.log(area_cm),2)), (int(item[0][0][0]), int(item[0][0][1])), cv2.FONT_HERSHEY_SIMPLEX, 2, (192, 245, 162) , 5)
    return img
...
#predict("/Users/akshay/OneDrive - Universitaet Bern/spheroid/mustafaImg/",0.7)
