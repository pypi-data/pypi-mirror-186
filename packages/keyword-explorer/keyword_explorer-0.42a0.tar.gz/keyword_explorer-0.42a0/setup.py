...
====================================
There are six applications in this project, _KeywordExplorer_, _TweetsCountExplorer_, _TweetDownloader_, _WikiPageviewExplorer_, _TweetEmbedExplorer_, and _ModelExplorer_. They, and the classes that support them, can be installed with pip:
