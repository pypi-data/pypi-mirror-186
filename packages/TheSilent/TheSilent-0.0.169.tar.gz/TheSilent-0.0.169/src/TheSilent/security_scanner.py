...
def security_scanner(url, secure = True, tor = False, depth = 0, my_file = " "):
    clear()

    my_subdomain_takeover = subdomain_takeover(url, secure, depth, my_file)
    my_sql_injection_scanner = sql_injection_scanner(url, secure, depth, my_file)
