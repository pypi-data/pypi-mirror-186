...
def link_scanner(url, secure = True, tor = False, depth = 1, my_file = " "):
    if secure == True:
        my_secure = "https://"
    ...
    while True:
        ...
        while website_list:
            ...
            try:
                if website_list[counter].count("/") - 2 > depth and depth != "all":
        ...
        try:
            ...
            if website_list[tracker].count("/") - 2 <= depth and depth != "all":
                website_list = list(dict.fromkeys(website_list))
