...
class Party:
    ...
    def extract_config_from_stream(self, data):
        ...
        if 'info' in self.local_training and (  
           'crypto' in self.local_training['info'] ) and ( 
           'key_manager' in self.local_training['info']['crypto'] ) and (
           'key_mgr_info' in self.local_training['info']['crypto']['key_manager'] ) and ( 
           'info' in local_training_agg ) and (
           'crypto' in local_training_agg['info'] ) and (
           'key_manager' in local_training_agg['info']['crypto'] ) :
            local_training_agg['info']['crypto']['key_manager']['key_mgr_info'] = self.local_training['info']['crypto']['key_manager']['key_mgr_info']
