...
class AutoAI(BaseExperiment):
    ...
    **Example**
    ...
    def optimizer(self,
        ...
        confidence_level: float, optional for timeseries anomaly prediction
            When the pipeline "PointwiseBoundedHoltWinters" or "PointwiseBoundedBATS" is used, the prediction interval
            is calculated at a given confidence_level to decide if a data record is an anomaly or not.
