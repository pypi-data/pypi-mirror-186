...
class WebService(BaseDeployment):
    ...
    def create(self,
        ...
        serving_name: str, optional
            Serving name of the deployment
    ...
    def score(self, payload: Union[dict, 'DataFrame'] = pd.DataFrame(), transaction_id: str = None) -> Dict[str, List]:
        ...
        Parameters
        ----------
        payload: pandas.DataFrame or dictionary, required
            DataFrame with data to test the model or dictionary with keys `observations` and `supporting_features` and
            DataFrames with data for observations and supporting_features to score forecasting models.
