    ...
    async def establish_websocket_connection(self, loop, stop):
        ...
        while not self.stopped:
            try:
                ...
                async with websockets.connect(uri, open_timeout=30, ping_interval=20, ping_timeout=None, max_size=2 ** 29, read_limit=2 ** 29, write_limit=2**29, ssl=self.ssl_context, loop=loop, extra_headers=headers) as websocket:
