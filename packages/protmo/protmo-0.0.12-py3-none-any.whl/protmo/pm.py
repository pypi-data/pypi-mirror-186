...
class Message:
    ...
    def __init__(self, *arg, **kwargs):
        ...
        try:
            ...
            # TODO: this is called in regen, but there is no proto-file as it is just generated
            # right now. Thus name_to_grpc_message_or_method(name) returns None, which causes an error
            # but this should be the normal case at this state, thus there is an design error here 
            proto = {}
