...
app.add_typer(cfgapp, name="config", no_args_is_help=True)
app.add_typer(cfgapp, name="conf", no_args_is_help=True, hidden=True)
app.add_typer(cfgapp, name="cf", no_args_is_help=True, hidden=True)
