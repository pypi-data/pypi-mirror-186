...
class Theme(QObject):
    ...
    def style(self):
        ...
        #embedded_widget_content QPushButton {
            background: $button_bg;
            color: $button_fg;
        ...
        #embedded_widget_content QComboBox::drop-down {
        ...
        #embedded_widget_content QPushButton:hover {
            background: $button_hover_bg;
        }
        
        #embedded_widget_content QPushButton:pressed {
            background: $button_hover_bg;
            border: 2px solid $button_pressed_border;
        }
