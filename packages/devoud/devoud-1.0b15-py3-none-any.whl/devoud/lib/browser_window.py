...
class BrowserWindow(QMainWindow):
    def __init__(self):
        ...
        self.profile.setCachePath(str(FS.local_path_config))
        ...
        QShortcut(QKeySequence("Ctrl+W"), self).activated.connect(lambda: self.tab_widget.close_tab(self.tab_widget.currentIndex()))
