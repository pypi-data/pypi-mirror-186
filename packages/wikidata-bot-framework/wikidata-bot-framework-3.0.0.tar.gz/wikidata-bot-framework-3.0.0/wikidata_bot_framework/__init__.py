...
class PropertyAdderBot(ABC):
    ...
    def same_main_property(
        self, existing_claim: pywikibot.Claim, new_claim: pywikibot.Claim, page: EntityPage
    ) -> bool:
    ...
    def same_qualifier(
        self, existing_qualifier: pywikibot.Claim, new_qualifier: pywikibot.Claim, main_claim: pywikibot.Claim, page: EntityPage
    ) -> bool:
                    ...
                    for qualifier_data in qualifiers:
                        ...
                        if qualifier not in new_claim.qualifiers.get(
                            ...
                            for existing_qualifier in new_claim.qualifiers[
                                ...
                                if self.same_qualifier(existing_qualifier, qualifier, new_claim, item):
                                    break
                                else:
