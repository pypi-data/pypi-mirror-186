...
def create_line_on_line(network: JavaHandle, bbs_or_bus_id: str, new_line_id: str, new_line_r: float, new_line_x: float, new_line_b1: float, new_line_b2: float, new_line_g1: float, new_line_g2: float, line_id: str, line1_id: str, line1_name: str, line2_id: str, line2_name: str, position_percent: float, create_fictitious_substation: bool, fictitious_voltage_level_id: str, fictitious_voltage_level_name: str, fictitious_substation_id: str, fictitious_substation_name: str) -> None: ...
def revert_create_line_on_line(network: JavaHandle, line_to_be_merged1_id: str, line_to_be_merged2_id: str, line_to_be_deleted: str, merged_line_id: str, merged_line_name: str) -> None: ...
...
def create_feeder_bay(network: JavaHandle, throw_exception: Optional[bool], reporter: Optional[JavaHandle], dataframes: List[Optional[Dataframe]], element_type: ElementType) -> None: ...
def create_branch_feeder_bays_line(network: JavaHandle, dataframe: Dataframe) -> None: ...
def create_branch_feeder_bays_twt(network: JavaHandle, dataframe: Dataframe) -> None: ...
def get_line_feeder_bays_metadata() -> List[SeriesMetadata]: ...
def get_twt_feeder_bays_metadata() -> List[SeriesMetadata]: ...
...
def close() -> None: ...
def remove_feeder_bays(network: JavaHandle, connectable_ids: List[str]) -> None: ...
def replace_tee_point_by_voltage_level_on_line(network: JavaHandle, tee_point_line1: str, tee_point_line2: str, tee_point_line_to_remove: str, bbs_or_bus_id: str, new_line1_id: str, new_line2_id: str, new_line1_name: str, new_line2_name: str) -> None: ...
