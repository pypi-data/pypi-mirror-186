    ...
    def plot_spiketrain(self, sweeps = None, features = None, show_all_stable = False, xlim = [0, 2.5],\
        ...
        if ~np.isnan(df_spiketrain['avg_rate'].values[0]): 
            ...
            if features is not None: 
                ...
                df_spikes = df_spikes[df_spikes.sweep_number_supra.isin(sweeps)] # filter for selected sweeps 
                ...
                for feature in features: 
                    if feature == 'max_spike_index': # max ap feature 
                        for sweep in np.unique(df_spikes.sweep_number_supra.values): 
                    ...
                    elif feature != 'max_spike_index': # remaining features 
                        for sweep in np.unique(df_spikes.sweep_number_supra.values): 
            ...
            spiketrain_plot(t = self.sweeptimes, i = self.stimuli, v = self.sweepdata, sweeps = sweeps,\
                    ...
                    figextension = figextension) # spike train plot 
