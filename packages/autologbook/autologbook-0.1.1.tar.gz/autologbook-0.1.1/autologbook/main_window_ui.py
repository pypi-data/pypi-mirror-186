...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_protocol_folder.setWhatsThis(_translate("MainWindow",
                                                            "<html><head/><body><p><span style=\" font-weight:600;\">Click here to select a folder to be monitored. </span></p><p>It is recommended to name this folder as ProtocolID-Project-Responsible as, for example, 2204123-RADCAS-Bulgheroni</p></body></html>"))
        self.select_protocol_folder.setText(_translate("MainWindow", "Select folder"))
        self.mirror_checkBox.setToolTip(
            _translate("MainWindow", "<html><head/><body><p>Activate mirroring</p></body></html>"))
        self.mirror_checkBox.setWhatsThis(_translate("MainWindow",
                                                     "<html><head/><body><p>Activating the mirroring will start the automatic copy of all files present in the protocol folder to the mirroring folder.</p></body></html>"))
        ...
        self.select_mirroring_folder.setToolTip(
            _translate("MainWindow", "<html><head/><body><p>Select a mirroring folder</p></body></html>"))
        self.select_mirroring_folder.setWhatsThis(_translate("MainWindow",
                                                             "<html><head/><body><p><span style=\" font-weight:600;\">Select a mirroring folder</span></p><p>This folder <span style=\" font-weight:600;\">must </span>have be named as ProtocolID-Project-Responsible and must be on R:\\A226\\Results. If not, the watchdog won\'t be able to start.</p></body></html>"))
        ...
        self.select_microscope_comboBox.setToolTip(_translate("MainWindow",
                                                              "<html><head/><body><p><span style=\" font-weight:600;\">Select the microscope as appropriate.</span></p></body></html>"))
        ...
        self.custom_ownership_checkbox.setToolTip(_translate("MainWindow",
                                                             "<html><head/><body><p>Activate custom protocol parameters (ID / Projet name / Project responsible)</p></body></html>"))
        ...
        self.open_explorer_pushbuttom.setWhatsThis(_translate("MainWindow",
                                                              "<html><head/><body><p><span style=\" font-weight:600;\">Open protocol folder</span></p><p>Click this button to open a file explorer pointing to either the protocol folder or the mirroring one if the mirroing option is activated.</p></body></html>"))
        self.open_explorer_pushbuttom.setText(_translate("MainWindow", "Open protocol folder"))
        self.open_browser_button.setToolTip(
            _translate("MainWindow", "<html><head/><body><p>Open the protocol webpage</p></body></html>"))
        self.open_browser_button.setText(_translate("MainWindow", "Open protocol webpage"))
        self.edit_custom_html_file_pushbutton.setToolTip(
            _translate("MainWindow", "<html><head/><body><p>Open the interactive protocol editor</p></body></html>"))
