...
class ManagedDatabaseRedis(
    ...
    def put_properties(
        ...
        *,
        ...
        recovery_basebackup_name: typing.Optional[builtins.str] = None,
        ...
        :param recovery_basebackup_name: Name of the basebackup to restore in forked service. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/upcloud/r/managed_database_redis#recovery_basebackup_name ManagedDatabaseRedis#recovery_basebackup_name}
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "recovery_basebackup_name": "recoveryBasebackupName",
...
class ManagedDatabaseRedisProperties:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument recovery_basebackup_name", value=recovery_basebackup_name, expected_type=type_hints["recovery_basebackup_name"])
        ...
        if recovery_basebackup_name is not None:
            self._values["recovery_basebackup_name"] = recovery_basebackup_name
    ...
    @builtins.property
    def recovery_basebackup_name(self) -> typing.Optional[builtins.str]:
        ...
        '''
        result = self._values.get("recovery_basebackup_name")
        return typing.cast(typing.Optional[builtins.str], result)
...
class ManagedDatabaseRedisPropertiesOutputReference(
    ...
    @jsii.member(jsii_name="resetRecoveryBasebackupName")
    def reset_recovery_basebackup_name(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetRecoveryBasebackupName", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="recoveryBasebackupNameInput")
    def recovery_basebackup_name_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "recoveryBasebackupNameInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="recoveryBasebackupName")
    def recovery_basebackup_name(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "recoveryBasebackupName"))

    @recovery_basebackup_name.setter
    def recovery_basebackup_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa9e216adbbe8576438fd6601bf4a4b58ddf62036c60c0f9eb4e5b281636d841)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "recoveryBasebackupName", value)
...
def _typecheckingstub__aa9e216adbbe8576438fd6601bf4a4b58ddf62036c60c0f9eb4e5b281636d841(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
