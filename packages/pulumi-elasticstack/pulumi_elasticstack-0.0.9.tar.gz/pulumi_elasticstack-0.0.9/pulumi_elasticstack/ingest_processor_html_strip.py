...
__all__ = [
    'IngestProcessorHtmlStripResult',
    'AwaitableIngestProcessorHtmlStripResult',
    'ingest_processor_html_strip',
    'ingest_processor_html_strip_output',
]

@pulumi.output_type
class IngestProcessorHtmlStripResult:
    """
...
class AwaitableIngestProcessorHtmlStripResult(IngestProcessorHtmlStripResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorHtmlStripResult(
...
def ingest_processor_html_strip(description: Optional[str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorHtmlStripResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorHtmlStrip:IngestProcessorHtmlStrip', __args__, opts=opts, typ=IngestProcessorHtmlStripResult).value

    return AwaitableIngestProcessorHtmlStripResult(
...
@_utilities.lift_output_func(ingest_processor_html_strip)
def ingest_processor_html_strip_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorHtmlStripResult]:
    """
    Removes HTML tags from the field. If the field is an array of strings, HTML tags will be removed from all members of the array.
