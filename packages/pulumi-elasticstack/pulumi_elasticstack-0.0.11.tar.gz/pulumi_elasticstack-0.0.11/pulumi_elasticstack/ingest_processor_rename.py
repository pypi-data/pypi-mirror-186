...
__all__ = [
    'IngestProcessorRenameResult',
    'AwaitableIngestProcessorRenameResult',
    'ingest_processor_rename',
    'ingest_processor_rename_output',
]

@pulumi.output_type
class IngestProcessorRenameResult:
    """
...
class AwaitableIngestProcessorRenameResult(IngestProcessorRenameResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorRenameResult(
...
def ingest_processor_rename(description: Optional[str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorRenameResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorRename:IngestProcessorRename', __args__, opts=opts, typ=IngestProcessorRenameResult).value

    return AwaitableIngestProcessorRenameResult(
...
@_utilities.lift_output_func(ingest_processor_rename)
def ingest_processor_rename_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorRenameResult]:
    """
    Renames an existing field. If the field doesn’t exist or the new name is already used, an exception will be thrown.
