...
__all__ = [
    'IngestProcessorTrimResult',
    'AwaitableIngestProcessorTrimResult',
    'ingest_processor_trim',
    'ingest_processor_trim_output',
]

@pulumi.output_type
class IngestProcessorTrimResult:
    """
...
class AwaitableIngestProcessorTrimResult(IngestProcessorTrimResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorTrimResult(
...
def ingest_processor_trim(description: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorTrimResult:
    """
    ...
    **NOTE:** This only works on leading and trailing whitespace.
    ...
    :param str target_field: The field to assign the trimmed value to, by default `field` is updated in-place.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorTrim:IngestProcessorTrim', __args__, opts=opts, typ=IngestProcessorTrimResult).value

    return AwaitableIngestProcessorTrimResult(
...
@_utilities.lift_output_func(ingest_processor_trim)
def ingest_processor_trim_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorTrimResult]:
    """
    Trims whitespace from field. If the field is an array of strings, all members of the array will be trimmed.
