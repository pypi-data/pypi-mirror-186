...
__all__ = [
    'IngestProcessorUppercaseResult',
    'AwaitableIngestProcessorUppercaseResult',
    'ingest_processor_uppercase',
    'ingest_processor_uppercase_output',
]

@pulumi.output_type
class IngestProcessorUppercaseResult:
    """
...
class AwaitableIngestProcessorUppercaseResult(IngestProcessorUppercaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorUppercaseResult(
...
def ingest_processor_uppercase(description: Optional[str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorUppercaseResult:
    """
    ...
    :param str field: The field to make uppercase.
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorUppercase:IngestProcessorUppercase', __args__, opts=opts, typ=IngestProcessorUppercaseResult).value

    return AwaitableIngestProcessorUppercaseResult(
...
@_utilities.lift_output_func(ingest_processor_uppercase)
def ingest_processor_uppercase_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorUppercaseResult]:
    """
    Converts a string to its uppercase equivalent. If the field is an array of strings, all members of the array will be converted.
