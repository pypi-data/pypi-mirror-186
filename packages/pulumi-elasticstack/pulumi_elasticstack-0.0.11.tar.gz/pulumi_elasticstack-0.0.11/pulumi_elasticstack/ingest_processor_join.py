...
__all__ = [
    'IngestProcessorJoinResult',
    'AwaitableIngestProcessorJoinResult',
    'ingest_processor_join',
    'ingest_processor_join_output',
]

@pulumi.output_type
class IngestProcessorJoinResult:
    """
...
class AwaitableIngestProcessorJoinResult(IngestProcessorJoinResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorJoinResult(
...
def ingest_processor_join(description: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorJoinResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorJoin:IngestProcessorJoin', __args__, opts=opts, typ=IngestProcessorJoinResult).value

    return AwaitableIngestProcessorJoinResult(
...
@_utilities.lift_output_func(ingest_processor_join)
def ingest_processor_join_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorJoinResult]:
    """
    Joins each element of an array into a single string using a separator character between each element. Throws an error when the field is not an array.
