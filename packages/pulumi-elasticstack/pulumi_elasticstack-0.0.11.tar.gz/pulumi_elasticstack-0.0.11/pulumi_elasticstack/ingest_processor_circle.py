...
__all__ = [
    'IngestProcessorCircleResult',
    'AwaitableIngestProcessorCircleResult',
    'ingest_processor_circle',
    'ingest_processor_circle_output',
]

@pulumi.output_type
class IngestProcessorCircleResult:
    """
    A collection of values returned by IngestProcessorCircle.
    """
    def __init__(__self__, description=None, error_distance=None, field=None, id=None, if_=None, ignore_failure=None, ignore_missing=None, json=None, on_failures=None, shape_type=None, tag=None, target_field=None):
        if description and not isinstance(description, str):
            raise TypeError("Expected argument 'description' to be a str")
        pulumi.set(__self__, "description", description)
        if error_distance and not isinstance(error_distance, float):
            raise TypeError("Expected argument 'error_distance' to be a float")
        pulumi.set(__self__, "error_distance", error_distance)
    ...
    @property
    @pulumi.getter(name="errorDistance")
    def error_distance(self) -> float:
        ...
        """
        return pulumi.get(self, "error_distance")
...
class AwaitableIngestProcessorCircleResult(IngestProcessorCircleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorCircleResult(
...
def ingest_processor_circle(description: Optional[str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorCircleResult:
    """
    ...
    :param float error_distance: The difference between the resulting inscribed distance from center to side and the circle’s radius (measured in meters for `geo_shape`, unit-less for `shape`)
    :param str field: The string-valued field to trim whitespace from.
    ...
    :param str shape_type: Which field mapping type is to be used when processing the circle.
    ...
    __args__['errorDistance'] = error_distance
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorCircle:IngestProcessorCircle', __args__, opts=opts, typ=IngestProcessorCircleResult).value

    return AwaitableIngestProcessorCircleResult(
        description=__ret__.description,
        error_distance=__ret__.error_distance,
        field=__ret__.field,
        id=__ret__.id,
        if_=__ret__.if_,
...
@_utilities.lift_output_func(ingest_processor_circle)
def ingest_processor_circle_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorCircleResult]:
    """
    Helper data source to which can be used to create a processor to convert circle definitions of shapes to regular polygons which approximate them.
