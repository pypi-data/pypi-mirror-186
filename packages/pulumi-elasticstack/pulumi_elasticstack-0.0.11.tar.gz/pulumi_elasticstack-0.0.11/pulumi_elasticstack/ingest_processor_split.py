...
__all__ = [
    'IngestProcessorSplitResult',
    'AwaitableIngestProcessorSplitResult',
    'ingest_processor_split',
    'ingest_processor_split_output',
]

@pulumi.output_type
class IngestProcessorSplitResult:
    """
    A collection of values returned by IngestProcessorSplit.
    """
    def __init__(__self__, description=None, field=None, id=None, if_=None, ignore_failure=None, ignore_missing=None, json=None, on_failures=None, preserve_trailing=None, separator=None, tag=None, target_field=None):
        ...
        if preserve_trailing and not isinstance(preserve_trailing, bool):
            raise TypeError("Expected argument 'preserve_trailing' to be a bool")
        pulumi.set(__self__, "preserve_trailing", preserve_trailing)
    ...
    @property
    @pulumi.getter(name="preserveTrailing")
    def preserve_trailing(self) -> Optional[bool]:
        """
        Preserves empty trailing fields, if any.
        """
        return pulumi.get(self, "preserve_trailing")
...
class AwaitableIngestProcessorSplitResult(IngestProcessorSplitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorSplitResult(
...
def ingest_processor_split(description: Optional[str] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorSplitResult:
    """
    ...
    :param str field: The field to split
    ...
    :param bool preserve_trailing: Preserves empty trailing fields, if any.
    :param str separator: A regex which matches the separator, eg `,` or `\\s+`
    ...
    __args__['preserveTrailing'] = preserve_trailing
    __args__['separator'] = separator
    __args__['tag'] = tag
    __args__['targetField'] = target_field
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorSplit:IngestProcessorSplit', __args__, opts=opts, typ=IngestProcessorSplitResult).value

    return AwaitableIngestProcessorSplitResult(
        ...
        preserve_trailing=__ret__.preserve_trailing,
        separator=__ret__.separator,
        tag=__ret__.tag,
        target_field=__ret__.target_field)


@_utilities.lift_output_func(ingest_processor_split)
def ingest_processor_split_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  preserve_trailing: Optional[pulumi.Input[Optional[bool]]] = None,
                                  separator: Optional[pulumi.Input[str]] = None,
                                  tag: Optional[pulumi.Input[Optional[str]]] = None,
                                  target_field: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorSplitResult]:
    """
    Splits a field into an array using a separator character. Only works on string fields.
