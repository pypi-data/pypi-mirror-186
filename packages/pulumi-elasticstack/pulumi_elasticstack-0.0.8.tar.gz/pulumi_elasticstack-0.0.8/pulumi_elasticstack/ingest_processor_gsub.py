...
__all__ = [
    'IngestProcessorGsubResult',
    'AwaitableIngestProcessorGsubResult',
    'ingest_processor_gsub',
    'ingest_processor_gsub_output',
]

@pulumi.output_type
class IngestProcessorGsubResult:
    """
...
class AwaitableIngestProcessorGsubResult(IngestProcessorGsubResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorGsubResult(
...
def ingest_processor_gsub(description: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorGsubResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorGsub:IngestProcessorGsub', __args__, opts=opts, typ=IngestProcessorGsubResult).value

    return AwaitableIngestProcessorGsubResult(
...
@_utilities.lift_output_func(ingest_processor_gsub)
def ingest_processor_gsub_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorGsubResult]:
    """
    Converts a string field by applying a regular expression and a replacement. If the field is an array of string, all members of the array will be converted. If any non-string values are encountered, the processor will throw an exception.
