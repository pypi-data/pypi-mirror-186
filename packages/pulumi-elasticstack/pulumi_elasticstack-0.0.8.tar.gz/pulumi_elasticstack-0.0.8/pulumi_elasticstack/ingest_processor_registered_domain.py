...
__all__ = [
    'IngestProcessorRegisteredDomainResult',
    'AwaitableIngestProcessorRegisteredDomainResult',
    'ingest_processor_registered_domain',
    'ingest_processor_registered_domain_output',
]

@pulumi.output_type
class IngestProcessorRegisteredDomainResult:
    """
...
class AwaitableIngestProcessorRegisteredDomainResult(IngestProcessorRegisteredDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorRegisteredDomainResult(
...
def ingest_processor_registered_domain(description: Optional[str] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorRegisteredDomainResult:
    """
    ...
    :param str field: Field containing the source FQDN.
    ...
    :param str target_field: Object field containing extracted domain components. If an `<empty string>`, the processor adds components to the document’s root.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorRegisteredDomain:IngestProcessorRegisteredDomain', __args__, opts=opts, typ=IngestProcessorRegisteredDomainResult).value

    return AwaitableIngestProcessorRegisteredDomainResult(
...
@_utilities.lift_output_func(ingest_processor_registered_domain)
def ingest_processor_registered_domain_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorRegisteredDomainResult]:
    """
    Extracts the registered domain (also known as the effective top-level domain or eTLD), sub-domain, and top-level domain from a fully qualified domain name (FQDN). Uses the registered domains defined in the Mozilla Public Suffix List.
