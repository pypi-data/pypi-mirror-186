...
__all__ = [
    'IngestProcessorDropResult',
    'AwaitableIngestProcessorDropResult',
    'ingest_processor_drop',
    'ingest_processor_drop_output',
]

@pulumi.output_type
class IngestProcessorDropResult:
    """
...
class AwaitableIngestProcessorDropResult(IngestProcessorDropResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IngestProcessorDropResult(
...
def ingest_processor_drop(description: Optional[str] = None,
                          if_: Optional[str] = None,
                          ignore_failure: Optional[bool] = None,
                          on_failures: Optional[Sequence[str]] = None,
                          tag: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIngestProcessorDropResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/ingestProcessorDrop:IngestProcessorDrop', __args__, opts=opts, typ=IngestProcessorDropResult).value

    return AwaitableIngestProcessorDropResult(
...
@_utilities.lift_output_func(ingest_processor_drop)
def ingest_processor_drop_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IngestProcessorDropResult]:
    """
    Drops the document without raising any errors. This is useful to prevent the document from getting indexed based on some condition.
