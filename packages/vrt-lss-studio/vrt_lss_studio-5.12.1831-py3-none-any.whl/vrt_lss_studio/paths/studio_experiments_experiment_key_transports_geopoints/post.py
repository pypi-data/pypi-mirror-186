...
SchemaFor200ResponseBodyApplicationJson = WebTransportGeopointList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_transports_geopoints_oapg(
        self,
...
class ReadTransportsGeopoints(BaseApi):
    ...
    def read_transports_geopoints(
        ...
        return self._read_transports_geopoints_oapg(
            body=body,
