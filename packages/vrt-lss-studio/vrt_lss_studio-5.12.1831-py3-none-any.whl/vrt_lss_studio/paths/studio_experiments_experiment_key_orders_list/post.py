...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TableOrderColumnType
...
# body param
SchemaForRequestBodyApplicationJson = TableOrderFilterList


request_body_table_order_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TableOrderList
...
class BaseApi(api_client.Api):
    ...
    def _read_orders_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_order_filter_list.serialize(body, content_type)
