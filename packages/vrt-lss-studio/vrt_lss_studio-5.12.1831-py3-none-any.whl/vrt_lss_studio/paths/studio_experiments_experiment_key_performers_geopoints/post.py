...
SchemaFor200ResponseBodyApplicationJson = WebPerformerGeopointList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_performers_geopoints_oapg(
        self,
...
class ReadPerformersGeopoints(BaseApi):
    ...
    def read_performers_geopoints(
        ...
        return self._read_performers_geopoints_oapg(
            body=body,
