...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TableTripColumnType
...
# body param
SchemaForRequestBodyApplicationJson = TableTripFilterList


request_body_table_trip_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TableTripList
...
class BaseApi(api_client.Api):
    ...
    def _read_trips_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_trip_filter_list.serialize(body, content_type)
