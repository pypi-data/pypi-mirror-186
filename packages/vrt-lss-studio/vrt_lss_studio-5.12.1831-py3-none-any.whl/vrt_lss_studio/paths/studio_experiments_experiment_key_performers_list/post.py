...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TablePerformerColumnType
...
# body param
SchemaForRequestBodyApplicationJson = TablePerformerFilterList


request_body_table_performer_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TablePerformerList
...
class BaseApi(api_client.Api):
    ...
    def _read_performers_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_performer_filter_list.serialize(body, content_type)
...
class ReadPerformers(BaseApi):
    ...
    def read_performers(
        ...
        return self._read_performers_oapg(
            body=body,
