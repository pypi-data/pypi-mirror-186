...
# body param
SchemaForRequestBodyApplicationJson = WebOrder


request_body_web_order = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebOrder
...
class BaseApi(api_client.Api):
    ...
    def _create_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_order.serialize(body, content_type)
