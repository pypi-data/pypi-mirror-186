...
# body param
SchemaForRequestBodyApplicationJson = UniversalData


request_body_universal_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_json_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_universal_data.serialize(body, content_type)
