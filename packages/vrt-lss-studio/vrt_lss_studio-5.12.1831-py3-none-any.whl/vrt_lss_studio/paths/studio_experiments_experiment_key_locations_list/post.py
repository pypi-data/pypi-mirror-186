...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TableLocationColumnType
...
# body param
SchemaForRequestBodyApplicationJson = TableLocationFilterList


request_body_table_location_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TableLocationList
...
class BaseApi(api_client.Api):
    ...
    def _read_locations_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_location_filter_list.serialize(body, content_type)
...
class ReadLocations(BaseApi):
    ...
    def read_locations(
        ...
        return self._read_locations_oapg(
            body=body,
