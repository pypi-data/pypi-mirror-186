...
# body param
SchemaForRequestBodyApplicationJson = WebTrip


request_body_web_trip = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WebTrip
...
class BaseApi(api_client.Api):
    ...
    def _update_trip_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_trip.serialize(body, content_type)
