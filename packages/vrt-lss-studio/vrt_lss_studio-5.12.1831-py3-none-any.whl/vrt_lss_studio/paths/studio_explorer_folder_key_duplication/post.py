...
# Path params
FolderKeySchema = UniqueKey
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'folder_key': typing.Union[FolderKeySchema, ],
    }
)
...
request_path_folder_key = api_client.PathParameter(
    name="folder_key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FolderKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = FolderSpecification


request_body_folder_specification = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = UniqueKey
...
class BaseApi(api_client.Api):
    ...
    def _duplicate_folder_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_folder_specification.serialize(body, content_type)
...
class DuplicateFolder(BaseApi):
    ...
    def duplicate_folder(
        ...
        return self._duplicate_folder_oapg(
            body=body,
