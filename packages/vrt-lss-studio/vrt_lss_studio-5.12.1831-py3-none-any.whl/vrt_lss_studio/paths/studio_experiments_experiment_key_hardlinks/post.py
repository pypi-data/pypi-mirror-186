...
# body param
SchemaForRequestBodyApplicationJson = WebHardlink


request_body_web_hardlink = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebHardlink
...
class BaseApi(api_client.Api):
    ...
    def _create_hardlink_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_hardlink.serialize(body, content_type)
...
class CreateHardlink(BaseApi):
    ...
    def create_hardlink(
        ...
        return self._create_hardlink_oapg(
            body=body,
