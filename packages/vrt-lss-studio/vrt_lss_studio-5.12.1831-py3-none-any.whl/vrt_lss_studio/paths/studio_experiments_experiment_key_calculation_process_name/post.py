...
ProcessNameSchema = BasicProcess
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'experiment_key': typing.Union[ExperimentKeySchema, ],
        'process_name': typing.Union[ProcessNameSchema, ],
    }
)
...
request_path_process_name = api_client.PathParameter(
    name="process_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProcessNameSchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_experiment_calculation_oapg(
        self,
...
class RunExperimentCalculation(BaseApi):
    ...
    def run_experiment_calculation(
        ...
        return self._run_experiment_calculation_oapg(
