...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'essence_key': typing.Union[EssenceKeySchema, None, ],
    }
)
...
request_path_essence_key = api_client.PathParameter(
    name="essence_key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EssenceKeySchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
class ReadPerformer(BaseApi):
    ...
    def read_performer(
        ...
        return self._read_performer_oapg(
