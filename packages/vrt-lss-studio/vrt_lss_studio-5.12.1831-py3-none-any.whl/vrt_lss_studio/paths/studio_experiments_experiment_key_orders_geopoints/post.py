...
SchemaFor200ResponseBodyApplicationJson = WebOrderGeopointList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_orders_geopoints_oapg(
        self,
...
class ReadOrdersGeopoints(BaseApi):
    ...
    def read_orders_geopoints(
        ...
        return self._read_orders_geopoints_oapg(
            body=body,
