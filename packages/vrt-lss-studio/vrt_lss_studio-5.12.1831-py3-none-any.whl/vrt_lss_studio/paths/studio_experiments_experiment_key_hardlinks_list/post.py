...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TableHardlinkColumnType
...
# body param
SchemaForRequestBodyApplicationJson = TableHardlinkFilterList


request_body_table_hardlink_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TableHardlinkList
...
class BaseApi(api_client.Api):
    ...
    def _read_hardlinks_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_hardlink_filter_list.serialize(body, content_type)
...
class ReadHardlinks(BaseApi):
    ...
    def read_hardlinks(
        ...
        return self._read_hardlinks_oapg(
            body=body,
