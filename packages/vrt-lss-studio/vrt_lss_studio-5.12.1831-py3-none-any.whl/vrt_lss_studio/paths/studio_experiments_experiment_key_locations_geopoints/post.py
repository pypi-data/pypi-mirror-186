...
SchemaFor200ResponseBodyApplicationJson = WebLocationGeopointList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_locations_geopoints_oapg(
        self,
...
class ReadLocationsGeopoints(BaseApi):
    ...
    def read_locations_geopoints(
        ...
        return self._read_locations_geopoints_oapg(
            body=body,
