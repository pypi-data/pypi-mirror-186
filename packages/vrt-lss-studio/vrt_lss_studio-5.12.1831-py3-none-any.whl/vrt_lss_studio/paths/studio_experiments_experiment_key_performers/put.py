...
# body param
SchemaForRequestBodyApplicationJson = WebPerformer


request_body_web_performer = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WebPerformer
...
class BaseApi(api_client.Api):
    ...
    def _update_performer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_performer.serialize(body, content_type)
...
class UpdatePerformer(BaseApi):
    ...
    def update_performer(
        ...
        return self._update_performer_oapg(
            body=body,
