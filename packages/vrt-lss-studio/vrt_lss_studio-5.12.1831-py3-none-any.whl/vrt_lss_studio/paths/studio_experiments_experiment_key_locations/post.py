...
# body param
SchemaForRequestBodyApplicationJson = WebLocation


request_body_web_location = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebLocation
...
class BaseApi(api_client.Api):
    ...
    def _create_location_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_location.serialize(body, content_type)
