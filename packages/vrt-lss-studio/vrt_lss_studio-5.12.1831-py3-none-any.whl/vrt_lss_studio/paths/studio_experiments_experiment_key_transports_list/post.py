...
from vrt_lss_studio import api_client, exceptions
...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 10000000
        inclusive_minimum = 1
SortColumnSchema = TableTransportColumnType
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'sort_column': typing.Union[SortColumnSchema, ],
...
request_query_sort_column = api_client.QueryParameter(
    name="sort_column",
    style=api_client.ParameterStyle.FORM,
    schema=SortColumnSchema,
    explode=True,
)
...
# Path params
ExperimentKeySchema = UniqueKey
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'experiment_key': typing.Union[ExperimentKeySchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = TableTransportFilterList


request_body_table_transport_filter_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TableTransportList
...
class SchemaFor400ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def schema_errors() -> typing.Type['SchemaErrorList']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schema_errors"]) -> 'SchemaErrorList': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tracedata"], typing_extensions.Literal["message"], typing_extensions.Literal["schema_errors"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schema_errors"]) -> typing.Union['SchemaErrorList', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tracedata"], typing_extensions.Literal["message"], typing_extensions.Literal["schema_errors"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        schema_errors: typing.Union['SchemaErrorList', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
class BaseApi(api_client.Api):
    ...
    def _read_transports_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_transport_filter_list.serialize(body, content_type)
...
class ReadTransports(BaseApi):
    ...
    def read_transports(
        ...
        return self._read_transports_oapg(
            body=body,
