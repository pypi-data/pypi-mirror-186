...
# body param
SchemaForRequestBodyApplicationJson = WebTransport


request_body_web_transport = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WebTransport
...
class BaseApi(api_client.Api):
    ...
    def _update_transport_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_transport.serialize(body, content_type)
...
class UpdateTransport(BaseApi):
    ...
    def update_transport(
        ...
        return self._update_transport_oapg(
            body=body,
