...
class AssignedPerformer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["shift_key"], typing_extensions.Literal["performer_key"], typing_extensions.Literal["shift_time"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["shift_key"], typing_extensions.Literal["performer_key"], typing_extensions.Literal["shift_time"], ]):
