...
class TableTripFilter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['TableTripColumnType']:
                return TableTripColumnType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'TableTripColumnType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'TableTripColumnType': ...
