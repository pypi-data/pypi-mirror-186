        ...
        class properties:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableOrderFilter']:
                        return TableOrderFilter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableOrderFilter'], typing.List['TableOrderFilter']],
                ...
                def __getitem__(self, i: int) -> 'TableOrderFilter':
