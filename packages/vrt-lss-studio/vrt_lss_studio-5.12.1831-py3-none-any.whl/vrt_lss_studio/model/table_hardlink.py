...
class TableHardlink(
        ...
        class properties:
            ...
            class elements(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableHardlinkFields']:
                        return TableHardlinkFields
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableHardlinkFields'], typing.List['TableHardlinkFields']],
                ...
                def __getitem__(self, i: int) -> 'TableHardlinkFields':
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> 'TableHardlinkFields': ...
