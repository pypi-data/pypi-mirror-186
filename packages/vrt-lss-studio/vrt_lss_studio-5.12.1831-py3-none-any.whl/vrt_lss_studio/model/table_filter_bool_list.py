...
class TableFilterBoolList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["elements"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["elements"], ]):
