...
class TableOrderFilter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['TableOrderColumnType']:
                return TableOrderColumnType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'TableOrderColumnType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'TableOrderColumnType': ...
