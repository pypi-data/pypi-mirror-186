...
class TablePerformerFilterList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TablePerformerFilter']:
                        return TablePerformerFilter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TablePerformerFilter'], typing.List['TablePerformerFilter']],
                ...
                def __getitem__(self, i: int) -> 'TablePerformerFilter':
