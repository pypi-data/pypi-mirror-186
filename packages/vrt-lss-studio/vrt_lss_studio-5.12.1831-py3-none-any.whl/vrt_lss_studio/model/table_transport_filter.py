...
class TableTransportFilter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['TableTransportColumnType']:
                return TableTransportColumnType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'TableTransportColumnType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'TableTransportColumnType': ...
