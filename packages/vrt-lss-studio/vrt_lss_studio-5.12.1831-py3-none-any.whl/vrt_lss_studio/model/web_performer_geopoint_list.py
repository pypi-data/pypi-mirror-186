...
class WebPerformerGeopointList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class geopoints(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WebPerformerGeopoint']:
                        return WebPerformerGeopoint
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WebPerformerGeopoint'], typing.List['WebPerformerGeopoint']],
                ...
                def __getitem__(self, i: int) -> 'WebPerformerGeopoint':
