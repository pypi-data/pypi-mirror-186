...
class TableTransportFields(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["essence_key"], typing_extensions.Literal["essence_type"], typing_extensions.Literal["enabled"], typing_extensions.Literal["pristine"], typing_extensions.Literal["working_time"], typing_extensions.Literal["transport_type"], typing_extensions.Literal["trip_key"], typing_extensions.Literal["location_keys"], typing_extensions.Literal["trips_count"], ]):
