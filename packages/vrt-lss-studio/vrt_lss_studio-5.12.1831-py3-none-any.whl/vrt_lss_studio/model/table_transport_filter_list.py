...
class TableTransportFilterList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableTransportFilter']:
                        return TableTransportFilter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableTransportFilter'], typing.List['TableTransportFilter']],
                ...
                def __getitem__(self, i: int) -> 'TableTransportFilter':
