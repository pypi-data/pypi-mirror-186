...
class ReplanSettings(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def strategy() -> typing.Type['ReplanStrategy']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["strategy"]) -> 'ReplanStrategy': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["strategy"], typing_extensions.Literal["trips_settings"], typing_extensions.Literal["geo_settings"], typing_extensions.Literal["calculation_settings"], typing_extensions.Literal["external_routing"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["strategy"]) -> typing.Union['ReplanStrategy', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["strategy"], typing_extensions.Literal["trips_settings"], typing_extensions.Literal["geo_settings"], typing_extensions.Literal["calculation_settings"], typing_extensions.Literal["external_routing"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        strategy: typing.Union['ReplanStrategy', schemas.Unset] = schemas.unset,
