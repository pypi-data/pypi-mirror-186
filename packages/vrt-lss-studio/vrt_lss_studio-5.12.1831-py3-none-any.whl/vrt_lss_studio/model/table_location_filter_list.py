        ...
        class properties:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableLocationFilter']:
                        return TableLocationFilter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableLocationFilter'], typing.List['TableLocationFilter']],
                ...
                def __getitem__(self, i: int) -> 'TableLocationFilter':
