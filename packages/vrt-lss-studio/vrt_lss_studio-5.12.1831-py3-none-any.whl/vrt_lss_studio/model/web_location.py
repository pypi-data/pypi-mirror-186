...
class WebLocation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def fields() -> typing.Type['TableLocationFields']:
                return TableLocationFields
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'TableLocationFields': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked_essences"]) -> 'LinkedEssenceList': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["location"], typing_extensions.Literal["fields"], typing_extensions.Literal["linked_essences"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['TableLocationFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked_essences"]) -> typing.Union['LinkedEssenceList', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["location"], typing_extensions.Literal["fields"], typing_extensions.Literal["linked_essences"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        location: 'Location',
        fields: typing.Union['TableLocationFields', schemas.Unset] = schemas.unset,
