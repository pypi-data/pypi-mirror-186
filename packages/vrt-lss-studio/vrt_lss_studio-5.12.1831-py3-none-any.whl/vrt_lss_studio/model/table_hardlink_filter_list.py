        ...
        class properties:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableHardlinkFilter']:
                        return TableHardlinkFilter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableHardlinkFilter'], typing.List['TableHardlinkFilter']],
                ...
                def __getitem__(self, i: int) -> 'TableHardlinkFilter':
