...
class OrderFact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["order_key"], typing_extensions.Literal["time"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["order_key"], typing_extensions.Literal["time"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], ]):
