...
class TableLocationFilter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['TableLocationColumnType']:
                return TableLocationColumnType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'TableLocationColumnType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'TableLocationColumnType': ...
