...
class TransportFact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transport_key"], typing_extensions.Literal["position"], typing_extensions.Literal["time"], typing_extensions.Literal["key"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transport_key"], typing_extensions.Literal["position"], typing_extensions.Literal["time"], typing_extensions.Literal["key"], ]):
