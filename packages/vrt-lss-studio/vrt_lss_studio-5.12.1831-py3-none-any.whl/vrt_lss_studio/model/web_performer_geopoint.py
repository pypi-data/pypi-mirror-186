...
class WebPerformerGeopoint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["point_type"], typing_extensions.Literal["shift_key"], typing_extensions.Literal["performer_key"], typing_extensions.Literal["geopoint"], typing_extensions.Literal["trip_key"], typing_extensions.Literal["stop_number"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["point_type"], typing_extensions.Literal["shift_key"], typing_extensions.Literal["performer_key"], typing_extensions.Literal["geopoint"], typing_extensions.Literal["trip_key"], typing_extensions.Literal["stop_number"], ]):
