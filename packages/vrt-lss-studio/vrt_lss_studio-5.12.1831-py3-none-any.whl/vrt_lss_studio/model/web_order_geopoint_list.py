        ...
        class properties:
            ...
            class geopoints(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WebOrderGeopoint']:
                        return WebOrderGeopoint
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WebOrderGeopoint'], typing.List['WebOrderGeopoint']],
                ...
                def __getitem__(self, i: int) -> 'WebOrderGeopoint':
