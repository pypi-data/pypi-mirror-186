...
class TableHardlinkFilter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['TableHardlinkColumnType']:
                return TableHardlinkColumnType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'TableHardlinkColumnType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'TableHardlinkColumnType': ...
