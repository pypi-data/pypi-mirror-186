        ...
        class properties:
            ...
            class geopoints(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WebLocationGeopoint']:
                        return WebLocationGeopoint
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WebLocationGeopoint'], typing.List['WebLocationGeopoint']],
                ...
                def __getitem__(self, i: int) -> 'WebLocationGeopoint':
