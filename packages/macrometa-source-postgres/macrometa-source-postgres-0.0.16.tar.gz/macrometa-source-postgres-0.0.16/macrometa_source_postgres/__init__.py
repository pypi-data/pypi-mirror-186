...
from macrometa_source_postgres.sync_strategies import full_table, sample_data
...
from macrometa_source_postgres.sync_strategies.sample_data import fetch_samples
...
class PostgresSourceConnector(C8Connector):
    ...
    def logo(self) -> str:
        ...
        return "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAKYAAAAeCAMAAACRz5VdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXN" \
               "SR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAACfUExURQAAADBAQEBAQDo6Sjg4QDg4SDY8RzU1RTU6RTo6QDk9STg4RDg8RDg8SDY5" \
               "QzY5RjY9Qzk5Rjk9Rjg7Rjg6RTc5RTc5RDk5Rzk7RDk7Rzg6Rjg8Rjg6Rjg8Rjc7Rzk7Rjk9Rjk6RTk8RTg7RTg7Rzg5Rjg7Rjc6R" \
               "jk6Rjc6Rjg7RTg7Rzg8RTg6Rjc7Rjk7Rjg6Rjg7Rjc7Rjk7Rjg7Ru6YlAkAAAA0dFJOUwAQEB8gIC8wMDA/QEBAUFBQUFBfYG9wcH" \
               "Bwf3+AgI+Pj5CQn5+goK+vsL+/v8DPz9/f7+8P0Xu0AAAEYklEQVRYw9WXW3PbNhCFDxGgggs0phSUTlTICkVGtNGUBKHz/39bH3g" \
               "RbSmTTNzMqOcJvAj4iMXZXQH/J4mVWQkAkGtnjCn2VeXX8sYYt22oqirEsE9tVTWhdNba3LfhlkBlu5POe79eaadN4f1aiiZ2YW90" \
               "3N4OZqv3HPSwScMgmI8k2cvD461Qut12pKw3nLXVieRJh3c3ghn0hKbiGZOVJcnn0t0IZmdGsOC41MOBZPAjZlZN2v8n4KJoIskYi" \
               "smmpoppcaN6eHU0J0z/xHjez9hkiSyf7PCWYucHBfZvTwAypjLXUudH9hsAMJHBaaltGfkoADC82s27Eew+l26tBxP1+r0TkXTtas" \
               "Kspx/o1zMsVfkfwqy5GUcqnQTwgZ2anu3YiUvMp99GTPuZjS09SdJ9XUebSNvjAhNf+G1fxfqHMGM/D0s6SHbi/HDH5hKzcGHEjCT" \
               "bfMBsSUUGV1/B9LRvxjzNQ+0tAtULV9NeYE4bOGD2iiRZelKRLtormDVXMPsYY1cbADD7LsYuOOCvKvVVpaZbtVxVKqs2porRQmyb" \
               "GLt6PWzhsnBkfH6JxPICM2vtiMkz5kklvku9mWOzwJSpx5a1ldIeuQUcD1YK7WIn/nDpH+cUtgy5lLbo/qRVrNMut+pDaqyA/pgeA" \
               "ajIFPx6PPiGL090xnCBiWAH2/xOks+j7x8/0kbXujPm327QPvVqy0+TnR4QwrQHbgy64W7yB60iFQB5vueHIIZEprA3QM5XSY79Ja" \
               "bz5bCbieR9PRkqrII7H3TFFAZVhUCcg1Se8HQaElRmxYhZnxbHeIxDfZqOnz9NdhG2aCJ7mfNVkry2m1k/RL1xZCunvNnpOxsVrgQ" \
               "dUOdpHYWOfeOdWZ0tFOYlDO34ctuPedc3XC2X3zG8mBzAHZ8vMVHawetOlRs/5/dHUZ+attNXMd0Z8x1gizK0ZC2vYzoAiFN58N4r" \
               "GxZRTkQ4iSXQZ7ormCpYkgw67NVqqvC9XgspRV5fwcxSuQj6pDyFEbOcV61nzKd2rpMSluULzJyPL0pUjyuYODzsyKM8lnbL+3Zsl" \
               "1yMjTNxcwXz/PUy1tm8ZGhHTJUep6QwY9o52cYeWTrNBVeyBXaLBCVjr65iZp12O1lmvoufxFjW/XvjihCu5U1AxaGum65XCOOShg" \
               "cgBgDIY18Ys97G44yJw8kBgKiTBvLUOwkAwsSkAezYOwEAq22iBcDWzFrNYW+qrivMal27EfP+q/dOX7cQoI7sQoipFEB2TF1TVV3" \
               "aAXCR0QLKNSFUhTifTcDFFELHoIcJEmPXRabhGuoYGUNMTGXkFlg2a+eltQZcWZV+wrT9dzoxa+38FdJaO0VRSgh5ttDS1dpaLRZX" \
               "zuWLa0g7TJMd5sbkWzJzhQ8/36Zlc1Wp+5+aQH/vhbsRszXlG9rJw+lBAjB12uCXKCu/kCSf/ZuadBcimWKpftV/Dm9JMqmAm5bbu" \
               "qoqZLO5bUwcmmKRL29Xyllxa0z/AulYyQ5nZH1hAAAAAElFTkSuQmCC"
    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty('dbname', 'Database Name', ConfigAttributeType.STRING, True, False,
                           ...
                           default_value='postgres'),
            ConfigProperty('filter_schemas', 'Source Schema', ConfigAttributeType.STRING, True, False,
            ...
            ConfigProperty('ssl', 'Use SSL', ConfigAttributeType.STRING, False, False,
                           description='If enabled, connection will fail if the server does not accept SSL connections'
                                       ' or the client certificate is not recognized.',
                           default_value='false'),
            ...
            ConfigProperty('itersize', 'Iterator Size', ConfigAttributeType.INT, False, False,
                           description='PG cursor size for INCREMENTAL or FULL_TABLE.',
                           default_value='20000'),
