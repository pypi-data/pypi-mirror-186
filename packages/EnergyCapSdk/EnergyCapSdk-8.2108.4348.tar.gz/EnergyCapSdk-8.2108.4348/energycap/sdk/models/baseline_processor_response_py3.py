...
class BaselineProcessorResponse(Model):
    ...
    def __init__(self, *, include_in_cap: bool=None, adjust_area: bool=None, adjusted_cost_type=None, adjust_winter: bool=None, adjust_summer: bool=None, baseline_months: int=None, baseline_start_date=None, savings_start_date=None, use_extended_weather: bool=None, extended_weather_start_date=None, cooling_temp: int=None, cooling_intercept: float=None, cooling_max_degree_days: float=None, cooling_max_use: float=None, cooling_r2: float=None, cooling_min_r2: float=None, cooling_calculated_r2: float=None, cooling_slope: float=None, cooling_std_dev: float=None, heating_temp: int=None, heating_intercept: float=None, heating_max_degree_days: float=None, heating_max_use: float=None, heating_r2: float=None, heating_min_r2: float=None, heating_calculated_r2: float=None, heating_slope: float=None, heating_std_dev: float=None, native_use_unit=None, baseline_bills=None, **kwargs) -> None:
