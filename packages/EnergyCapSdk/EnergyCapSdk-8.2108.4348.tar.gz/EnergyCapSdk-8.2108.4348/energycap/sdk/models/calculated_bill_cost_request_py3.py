...
class CalculatedBillCostRequest(Model):
    ...
    def __init__(self, *, use_current_meters_rate_schedule: bool=None, fixed_unit_cost=None, unit_cost_meter_id: int=None, fixed_amount: float=None, copy_cost_from_meter=None, cost_calculation=None, **kwargs) -> None:
