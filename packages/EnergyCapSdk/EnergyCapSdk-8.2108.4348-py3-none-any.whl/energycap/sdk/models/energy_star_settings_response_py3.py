...
class EnergyStarSettingsResponse(Model):
    ...
    def __init__(self, *, pm_account_manager_full_name: str=None, pm_account_manager_user_name: str=None, notification_recipients=None, earliest_submission_period: int=None, **kwargs) -> None:
