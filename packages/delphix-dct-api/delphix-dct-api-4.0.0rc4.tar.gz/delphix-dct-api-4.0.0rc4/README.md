...
*AuthorizationApi* | [**add_objects_to_access_group_policy**](docs/AuthorizationApi.md#add_objects_to_access_group_policy) | **POST** /access-groups/{accessGroupId}/policies/{policyId}/objects | Add objects to the access group policy.
*AuthorizationApi* | [**add_tags_to_policy**](docs/AuthorizationApi.md#add_tags_to_policy) | **POST** /access-groups/{accessGroupId}/policies/{policyId}/object-tags | Add object tags to the access group policy.
...
*AuthorizationApi* | [**delete_access_group_policy_object_tags**](docs/AuthorizationApi.md#delete_access_group_policy_object_tags) | **POST** /access-groups/{accessGroupId}/policies/{policyId}/object-tags/delete | Remove tags from the access group policy.
*AuthorizationApi* | [**delete_access_group_policy_objects**](docs/AuthorizationApi.md#delete_access_group_policy_objects) | **POST** /access-groups/{accessGroupId}/policies/{policyId}/objects/delete | Remove objects from the access group policy.
...
*AuthorizationApi* | [**get_access_group_policy**](docs/AuthorizationApi.md#get_access_group_policy) | **GET** /access-groups/{accessGroupId}/policies/{policyId} | Get access group policy.
...
*AuthorizationApi* | [**update_access_group_policy**](docs/AuthorizationApi.md#update_access_group_policy) | **PATCH** /access-groups/{accessGroupId}/policies/{policyId} | Update access group policy.
...
## Documentation For Models
 ...
 - [DeleteObjectTags](docs/DeleteObjectTags.md)
 ...
 - [MaskingJobx](docs/MaskingJobx.md)
 ...
 - [UpdateAccessGroupPolicy](docs/UpdateAccessGroupPolicy.md)
