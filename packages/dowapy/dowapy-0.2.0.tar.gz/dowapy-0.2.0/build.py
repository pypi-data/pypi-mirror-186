...
class BuildExtWithoutPlatformSuffix(cython_build_ext):
...
#         extensions = [
#             'src/CosmosCore/*.py',
#             'src/CosmosCore/Application/*.py',
#             'src/CosmosCore/Application/console/*.py'
#         ]
#         includePaths = [
            
#         ]
#         # gcc args hack : enable optimizations
#         os.environ['CFLAGS'] = '-03'
