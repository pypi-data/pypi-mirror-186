...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.label_source.sizePolicy().hasHeightForWidth())
        self.label_source.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.label_srcpath.sizePolicy().hasHeightForWidth())
        self.label_srcpath.setSizePolicy(sizePolicy)
