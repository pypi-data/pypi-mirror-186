...
from bot.objects import Object, Wd, items, keys, register, update, values
from bot.objects import edit, kind, load, save
from bot.objects import ObjectDecoder, ObjectEncoder
from bot.objects import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "bot.objects.Object")
