...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.4.6',
 'watchmen-indicator-surface==16.4.6',
 'watchmen-inquiry-surface==16.4.6',
 'watchmen-pipeline-surface==16.4.6']

extras_require = \
{'boto3': ['boto3>=1.24.20,<2.0.0'],
 'collector': ['watchmen-collector-kernel==16.4.6'],
