...
class MsbModelMetaFields(MsbModel):
	...
	updated_at = models.DateTimeField(db_column=COLUMN_NAME_UPDATED_AT, auto_now=True, default=timezone.now)
	updated_by = models.IntegerField(db_column=COLUMN_NAME_UPDATED_BY, null=True, default=None)
	created_at = models.DateTimeField(db_column=COLUMN_NAME_CREATED_AT, auto_now_add=True, default=timezone.now)
