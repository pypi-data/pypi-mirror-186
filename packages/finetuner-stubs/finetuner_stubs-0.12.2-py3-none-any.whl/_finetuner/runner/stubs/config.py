...
MinerType = (
    Optional[Literal[miners]] if len(miners) > 0 else Optional[constr(min_length=1)]
)
...
class HyperParametersConfig(BaseModel):
    ...
    optimizer_options: Optional[Dict[str, Any]] = Field(
        default_factory=lambda: {},
    ...
    loss_options: Optional[Dict[str, Any]] = Field(
        default_factory=lambda: {},
    ...
    miner_options: Optional[Dict[str, Any]] = Field(
        default_factory=lambda: {},
        description=(
