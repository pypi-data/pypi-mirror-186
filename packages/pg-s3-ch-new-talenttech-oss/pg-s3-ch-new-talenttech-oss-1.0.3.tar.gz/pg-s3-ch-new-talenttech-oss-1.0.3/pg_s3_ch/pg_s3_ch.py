...
class PGS3CH:
    ...
    def transform_params(self):
        ...
        self.need_clear_s3 = self.config.get("need_clear_s3", False)
        self.incremental = bool(self.config.get("incremental", False))
        self.by_date = bool(self.config.get("by_date", False))
        self.partition_key = self.config.get("partition_key", "tuple()")
        self.sorting_key = self.config.get("sorting_key", "id")
        ...
        if self.by_date:
            ...
            self.date_field = self.config.get("date_field", "created_at")
        ...
        self.ch_exclude_columns_str = self.ch_config.get("ch_exclude_columns", "ts_captured")
