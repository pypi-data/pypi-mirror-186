...
from hestia_earth.models.ipcc2013ExcludingFeedbacks.gwp100 import TERM_ID, run

class_path = f"hestia_earth.models.ipcc2013ExcludingFeedbacks.{TERM_ID}"
fixtures_folder = f"{fixtures_path}/ipcc2013ExcludingFeedbacks/{TERM_ID}"
