...
class JdbcDatastoreDef(DatastoreDef):
    ...
    def __repr__(self):
        return (
            ...
            f"view_query= {self.view_query!r}, "
...
class BoxDatastoreDef(DatastoreDef):
    ...
    def __init__(
        self,
        file_format: FileFormat,
        global_file_id: Optional[str] = None,
        ...
        :param upload_path : string made up of a folder id and a file name separated by a slash
        """
    ...
    def __repr__(self):
        return (
            f"{self.__class__.__name__}(file_format={self.file_format!r},"
            f"global_file_id={self.global_file_id!r},upload_path={self.upload_path!r},"
            f"params={self.params},resource_type={self.resource_type!r})"
        )
