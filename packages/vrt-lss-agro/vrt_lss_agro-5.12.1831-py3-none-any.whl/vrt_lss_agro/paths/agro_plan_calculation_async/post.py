...
from vrt_lss_agro import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = PlanTask


request_body_plan_task = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_plan_calculation_async_oapg(
        self,
    ...
    def _run_plan_calculation_async_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_plan_task.serialize(body, content_type)
...
class RunPlanCalculationAsync(BaseApi):
    ...
    def run_plan_calculation_async(
        ...
        return self._run_plan_calculation_async_oapg(
            body=body,
