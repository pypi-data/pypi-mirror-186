...
SchemaFor200ResponseBodyApplicationJson = PlanResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_plan_calculation_oapg(
        self,
...
class RunPlanCalculation(BaseApi):
    ...
    def run_plan_calculation(
        ...
        return self._run_plan_calculation_oapg(
            body=body,
