...
class CostForecast(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CostForecastElement']:
            return CostForecastElement

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CostForecastElement'], typing.List['CostForecastElement']],
    ...
    def __getitem__(self, i: int) -> 'CostForecastElement':
