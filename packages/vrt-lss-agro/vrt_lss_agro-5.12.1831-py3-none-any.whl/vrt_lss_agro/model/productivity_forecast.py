...
class ProductivityForecast(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ProductivityForecastElement']:
            return ProductivityForecastElement

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ProductivityForecastElement'], typing.List['ProductivityForecastElement']],
    ...
    def __getitem__(self, i: int) -> 'ProductivityForecastElement':
