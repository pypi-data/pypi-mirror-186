...
class CapacityForecastElement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["capacity"], typing_extensions.Literal["date_window"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["capacity"], typing_extensions.Literal["date_window"], ]):
