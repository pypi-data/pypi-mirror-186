...
class CostForecastElement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cost"], typing_extensions.Literal["date_window"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cost"], typing_extensions.Literal["date_window"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        cost: typing.Union[MetaOapg.properties.cost, decimal.Decimal, int, ],
        date_window: 'DateWindow',
