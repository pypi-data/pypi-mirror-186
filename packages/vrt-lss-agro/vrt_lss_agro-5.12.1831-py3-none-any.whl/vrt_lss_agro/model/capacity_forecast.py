...
class CapacityForecast(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CapacityForecastElement']:
            return CapacityForecastElement

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CapacityForecastElement'], typing.List['CapacityForecastElement']],
    ...
    def __getitem__(self, i: int) -> 'CapacityForecastElement':
