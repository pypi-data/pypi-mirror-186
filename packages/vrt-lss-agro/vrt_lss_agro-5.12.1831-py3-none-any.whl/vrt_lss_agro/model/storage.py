...
class Storage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["capacity_forecast"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], typing_extensions.Literal["cost_forecast"], typing_extensions.Literal["attributes"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["capacity_forecast"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], typing_extensions.Literal["cost_forecast"], typing_extensions.Literal["attributes"], ]):
