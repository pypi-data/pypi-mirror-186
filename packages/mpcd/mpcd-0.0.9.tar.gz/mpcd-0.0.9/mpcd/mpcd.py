...
class PointCloud:
    ...
    def draw_pcloud(
        ...
        draw = self.vis.draw_pcloud(self.to_ndarray(['x','y']), color, r, draw_distance_marker, draw_orin_marker,show,auto_rot,save,save_path)
    ...
    def coor_trans_old(self, extr_mat):
        pc_data = self.pc_data.copy()
        assert "x" in self.fields and "y" in self.fields and "z" in self.fields
