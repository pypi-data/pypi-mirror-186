...
from pygenplot.dialogs.inspect_data_dialog import InspectDataDialog
from pygenplot.models.data_tree_model import DataItem, DataTreeModel
...
class DataWidget(QtWidgets.QWidget):
    ...
    def _build(self):
        ...
        self._data_treeview.installEventFilter(self)
        ...
        self._data_treeview.doubleClicked.connect(self.on_show_data)
    ...
    def on_show_data(self,index):
        """Callback called when an item of the data tree is double clicked.
