...
class REaLSampler:
    ...
    def _generate(
        ...
        **generate_kwargs,
        ...
        vocab = self.vocab if self.model_type == ModelType.tabular else self.vocab["decoder"]
...
class TabularSampler(REaLSampler):
    ...
    def sample_tabular(
        ...
        **generate_kwargs,
        ...
        print(f"Generated {self.invalid_gen_samples} invalid samples out of total {self.total_gen_samples} samples generated. Sampling efficiency is: {100 * (1 -  self.invalid_gen_samples / self.total_gen_samples):.4f}%")
