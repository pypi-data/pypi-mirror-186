...
class WebCamModel extends base_1.DOMWidgetModel {
    ...
    constructor(...args) {
        ...
        this.getConstraints = () => {
            ...
            const { videoId } = this.get('video_input_device') || {};
            const { audioId } = this.get('audio_input_device') || {};
            if (audio && audioId) {
        ...
        this.fetchInfoes = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.fetchInfoes();
        this.on('change:video_input_device', () => {
            this.connect(undefined, true, true);
        });
        this.on('change:audio_input_device', () => {
            this.connect(undefined, true, true);
        });
