...
class Container(DDObject):
    ...
    def import_table(self, project_asset_id, imported_table_name, category="input", lineage=None):
        ...
        '''
        return self.client.import_table(self, imported_table_name=imported_table_name, project_asset_id=project_asset_id, category=category, lineage=lineage)

    def export_table(self, table_name, project_asset_name=None, project_asset_id=None, write_mode=None):
    ...
    def import_asset(self, project_asset_id, imported_asset_name, category="input", lineage=None):
        ...
        '''
        return self.client.import_asset(self, imported_asset_name=imported_asset_name, project_asset_id=project_asset_id, category=category, lineage=lineage)
