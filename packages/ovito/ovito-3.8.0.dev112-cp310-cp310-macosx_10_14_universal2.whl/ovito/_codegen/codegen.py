...
from ovito.pipeline import Pipeline, Modifier
...
def generate_object_instantiation(stream: io.StringIO, variable_name: str, ref_obj: RefTarget, obj: RefTarget, include_vis: bool = False, prefer_oneliner: bool = False) -> List[str]:
...
def get_object_modified_properties(stream: io.StringIO, ref_obj: RefTarget, obj: RefTarget, include_vis: bool = False) -> Dict[str, str]:
