# BotCity Telegram Plugin - Python
...
[![First Automation](https://developers.botcity.dev/github/readme/python-plugins/telegram-plugin.png)](https://documentation.botcity.dev/plugins/)
