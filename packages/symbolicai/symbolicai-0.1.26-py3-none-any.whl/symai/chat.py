...
class Chat(Expression):
    _symai_chat: str = """This is a conversation between a chatbot (Symbia:) and a human (User:). It also includes narration Text (Narrator:) describing the next dialog.
"""
