...
from typing import Literal, Tuple, List, AsyncIterator, Iterator, Dict, Optional
...
class LinkMutation(BaseModel):
    ...
    class Meta:
        document = "fragment ListLink on DataLink {\n  relation\n  id\n}\n\nmutation link($relation: String!, $x_type: LinkableModels!, $x_id: ID!, $y_type: LinkableModels!, $y_id: ID!, $experiment: ID) {\n  link(\n    relation: $relation\n    xType: $x_type\n    xId: $x_id\n    yType: $y_type\n    yId: $y_id\n    experiment: $experiment\n  ) {\n    ...ListLink\n  }\n}"
...
class Link_rep_to_repMutation(BaseModel):
    ...
    class Meta:
        document = "fragment ListLink on DataLink {\n  relation\n  id\n}\n\nmutation link_rep_to_rep($relation: String!, $left_rep: ID!, $right_rep: ID!, $experiment: ID) {\n  link(\n    relation: $relation\n    xType: GRUNNLAG_REPRESENTATION\n    xId: $left_rep\n    yType: GRUNNLAG_REPRESENTATION\n    yId: $right_rep\n    experiment: $experiment\n  ) {\n    ...ListLink\n  }\n}"
...
class LinksQueryLinks(BaseModel):
    """DataLink(id, x_content_type, x_id, y_content_type, y_id, relation, experiment, created_at, creator)"""

    typename: Optional[Literal["DataLink"]] = Field(alias="__typename")
    relation: Optional[str]
    "Relation"
    x: RepresentationFragment
    "X"
...
class LinksQuery(BaseModel):
    ...
    class Meta:
        document = "fragment Representation on Representation {\n  sample {\n    id\n    name\n  }\n  shape\n  id\n  store\n  variety\n  name\n  omero {\n    scale\n    physicalSize {\n      x\n      y\n      z\n      t\n      c\n    }\n    position {\n      id\n      x\n      y\n    }\n    channels {\n      name\n      color\n    }\n  }\n  origins {\n    id\n    store\n    variety\n  }\n}\n\nquery Links($x_type: LinkableModels!, $y_type: LinkableModels!, $relation: String!, $experiment: ID, $limit: Int = 10) {\n  links(\n    xType: $x_type\n    yType: $y_type\n    relation: $relation\n    experiment: $experiment\n    limit: $limit\n  ) {\n    relation\n    x {\n      ...Representation\n    }\n    y {\n      ... on Representation {\n        id\n        store\n      }\n    }\n  }\n}"
...
async def alink(
    ...
    """link
     ...
     link: DataLink(id, x_content_type, x_id, y_content_type, y_id, relation, experiment, created_at, creator)
...
async def alinks(
    ...
    """Links
     ...
     links: DataLink(id, x_content_type, x_id, y_content_type, y_id, relation, experiment, created_at, creator)
