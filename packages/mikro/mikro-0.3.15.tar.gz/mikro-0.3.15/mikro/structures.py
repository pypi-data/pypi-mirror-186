...
try:
    ...
    structure_reg.register_as_structure(
        ImageToImageModelFragment,
        identifier="@mikro/imagetoimagemodel",
        expand=aexpand_image_to_image_model,
        default_widget=SearchWidget(
            query=Search_image_to_image_modelsQuery.Meta.document, ward="mikro"
        ),
    )
