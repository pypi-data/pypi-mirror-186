...
from .chargeback_detail import ChargebackDetail
from .chargeback_feedback import ChargebackFeedback
...
class ChargebackFeedback(OrderPurchaseUpdateRequest):
    """@dataclass ChargebackFeedback

    Attributes:
        chargeback_detail(ChargebackDetail):
    """
    chargeback_detail: Optional[ChargebackDetail] = field(default=None, metadata=config(exclude=lambda f: f is None))
