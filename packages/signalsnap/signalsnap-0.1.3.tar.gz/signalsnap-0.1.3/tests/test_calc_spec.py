...
class TestCalcSpec(unittest.TestCase):
    ...
    def test_calc_spec(self):
        ...
        self.assertAlmostEqual(s[2][0], spec_test.s[2][0])
        self.assertAlmostEqual(s[3][0:0], spec_test.s[3][0:0])
        self.assertAlmostEqual(s[4][0:0], spec_test.s[4][0:0])

        self.assertAlmostEqual(serr[2][0], spec_test.serr[2][0])
        self.assertAlmostEqual(serr[3][0:0], spec_test.serr[3][0:0])
        self.assertAlmostEqual(serr[4][0:0], spec_test.serr[4][0:0])
