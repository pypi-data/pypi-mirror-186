...
class ServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getServiceState = channel.unary_unary(
                '/farm_ng.service.proto.Service/getServiceState',
...
def add_ServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'farm_ng.service.proto.Service', rpc_method_handlers)
...
class Service(object):
    ...
    def getServiceState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/farm_ng.service.proto.Service/getServiceState',
