...
class Endpoints:
    ...
    def create_endpoints(self):
        ...
        def connection_test():
            ...
            try:
                output = self.plugin.handle_step(input_message, is_debug=self.debug, is_test=True)
    ...
    def run_action_trigger_task(self, input_message, test=False):
        ...
        try:
            ...
            if isinstance(wrapped_exception, ClientException):
                status_code = 400
            elif isinstance(wrapped_exception, PluginException) and \
                    wrapped_exception.preset is PluginException.Preset.BAD_REQUEST:
                status_code = 400
