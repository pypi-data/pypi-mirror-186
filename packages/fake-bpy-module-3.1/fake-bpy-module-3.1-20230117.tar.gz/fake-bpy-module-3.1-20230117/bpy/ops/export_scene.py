...
def gltf(override_context: typing.Union[typing.
         ...
         *,
         ...
         export_selected: typing.Union[bool, typing.Any] = False,
         use_selection: typing.Union[bool, typing.Any] = False,
         ...
         optimize_animation_size: typing.Union[bool, typing.Any] = True,
         ...
         export_displacement: typing.Union[bool, typing.Any] = False,
    ...
    :type export_selected: typing.Union[bool, typing.Any]
    ...
    :type optimize_animation_size: typing.Union[bool, typing.Any]
    ...
    :type export_displacement: typing.Union[bool, typing.Any]
