...
1. [x] Использовать схемы из новой рисовалки при возможности
2. [ ] Левая таблица названия капсом
3. [x] Тестирование
4. [x] 12 Шрифт
5. [x] Добавить слияние ячеек в таблице, если есть пустые строки
6. [ ] Создать абстрактный класс, который бы мог работать как с упражнениями из событий так и обычными, а может потом будет ещё какая-то новая структура. Надо быть готовым :(
7. [x] Настроить логгер вместо print(..)
8. [x] ~~Устранить утечку памяти где создается поток для объектак. Используя with~~
9. [x] ~~Презентация в широком формате~~
10. [x] ~~Новое форматирование~~
11. [ ] Описание сделал читабельным
12. [x] Размер шрифта
13. [ ] положение в строке
14. [ ] Форматирование в шаблоне двухконтентном
15. [ ] ~~Цвета~~
16. [ ] Cоздать презентацию для каждого упражнения, дабы отловить возможные ошибки
17. [ ] Ошибка, если файл не найдеy в assets, и картинка по умолчанию)
