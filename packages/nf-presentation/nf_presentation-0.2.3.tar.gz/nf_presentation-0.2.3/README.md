...
2. [ ] 12 Шрифт
3. [ ] Добавить слияние ячеек в таблице, если есть пустые строки
...
10. [ ] Размер шрифта, положение в строке
11. [ ] Форматирование в шаблоне двухконтентном
12. [ ] ~~Цвета~~
13. [ ] Cоздать презентацию для каждого упражнения, дабы отловить возможные ошибки
