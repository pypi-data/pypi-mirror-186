# BotCity AWS Secrets Manager Plugin - Python
...
[![First Automation](https://developers.botcity.dev/github/readme/python-plugins/secretsmanager-plugin.png)](https://documentation.botcity.dev/plugins/)
