...
'RecurDyn V9R5 RecurDynCOMTire Type Library'
...
ITireGeometryRim_vtables_ = [
	(( 'RimWidth' , 'ppVal' , ), 4051, (4051, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 176 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameter' , 'ppVal' , ), 4052, (4052, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 184 , (3, 0, None, None) , 0 , )),
	(( 'RimWidthUnitMM' , 'pVal' , ), 4053, (4053, (), [ (5, 1, None, None) , ], 1 , 4 , 4 , 0 , 192 , (3, 0, None, None) , 0 , )),
	(( 'RimWidthUnitMM' , 'pVal' , ), 4053, (4053, (), [ (16389, 10, None, None) , ], 1 , 2 , 4 , 0 , 200 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameterUnitInch' , 'pVal' , ), 4054, (4054, (), [ (5, 1, None, None) , ], 1 , 4 , 4 , 0 , 208 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameterUnitInch' , 'pVal' , ), 4054, (4054, (), [ (16389, 10, None, None) , ], 1 , 2 , 4 , 0 , 216 , (3, 0, None, None) , 0 , )),
]

ITireGeometryRimGeneric_vtables_dispatch_ = 1
ITireGeometryRimGeneric_vtables_ = [
	(( 'NumberOfLeads' , 'pVal' , ), 4101, (4101, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
	(( 'NumberOfLeads' , 'pVal' , ), 4101, (4101, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
	(( 'AngleOfRimHole' , 'ppVal' , ), 4102, (4102, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 240 , (3, 0, None, None) , 0 , )),
	(( 'RimInnerDiameter' , 'ppVal' , ), 4103, (4103, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 248 , (3, 0, None, None) , 0 , )),
	(( 'RimInnerDiameterUnitInch' , 'pVal' , ), 4104, (4104, (), [ (5, 1, None, None) , ], 1 , 4 , 4 , 0 , 256 , (3, 0, None, None) , 0 , )),
	(( 'RimInnerDiameterUnitInch' , 'pVal' , ), 4104, (4104, (), [ (16389, 10, None, None) , ], 1 , 2 , 4 , 0 , 264 , (3, 0, None, None) , 0 , )),
]

ITireGeometryTire_vtables_dispatch_ = 1
ITireGeometryTire_vtables_ = [
	(( 'SectionWidth' , 'ppVal' , ), 4051, (4051, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 176 , (3, 0, None, None) , 0 , )),
	(( 'AspectRatio' , 'ppVal' , ), 4052, (4052, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 184 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameter' , 'ppVal' , ), 4053, (4053, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 192 , (3, 0, None, None) , 0 , )),
	(( 'SectionWidthUnitMM' , 'pVal' , ), 4054, (4054, (), [ (5, 1, None, None) , ], 1 , 4 , 4 , 0 , 200 , (3, 0, None, None) , 0 , )),
	(( 'SectionWidthUnitMM' , 'pVal' , ), 4054, (4054, (), [ (16389, 10, None, None) , ], 1 , 2 , 4 , 0 , 208 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameterUnitInch' , 'pVal' , ), 4055, (4055, (), [ (5, 1, None, None) , ], 1 , 4 , 4 , 0 , 216 , (3, 0, None, None) , 0 , )),
	(( 'RimDiameterUnitInch' , 'pVal' , ), 4055, (4055, (), [ (16389, 10, None, None) , ], 1 , 2 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
	(( 'UpdateTireRadius' , ), 4056, (4056, (), [ ], 1 , 1 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
]
