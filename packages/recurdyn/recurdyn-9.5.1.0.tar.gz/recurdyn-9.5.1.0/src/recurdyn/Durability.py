...
'RecurDyn V9R5 RecurDynCOMDurability Type Library'
...
class IDurabilityFatigueResult(DispatchBaseClass):
	...
	def MeanStressList(self, timeHist):
		...
		:rtype: list[str]
		'''
		return self._ApplyTypes_(8010, 2, (8200, 0), ((8, 1),), 'MeanStressList', None,timeHist
			)
	...
	def StressAmplitudeList(self, timeHist):
		...
		:rtype: list[str]
		'''
		return self._ApplyTypes_(8011, 2, (8200, 0), ((8, 1),), 'StressAmplitudeList', None,timeHist
			)
...
IDurabilityFatigueResult_vtables_ = [
	...
	(( 'MeanStressList' , 'timeHist' , 'ppVal' , ), 8010, (8010, (), [ (8, 1, None, None) , 
			 (24584, 10, None, None) , ], 1 , 2 , 4 , 0 , 128 , (3, 0, None, None) , 0 , )),
	(( 'StressAmplitudeList' , 'timeHist' , 'ppVal' , ), 8011, (8011, (), [ (8, 1, None, None) , 
			 (24584, 10, None, None) , ], 1 , 2 , 4 , 0 , 136 , (3, 0, None, None) , 0 , )),
]
