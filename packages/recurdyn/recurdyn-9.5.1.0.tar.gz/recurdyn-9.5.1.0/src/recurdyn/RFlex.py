...
'RecurDyn V9R5 RecurDynCOMRFlex Type Library'
...
class IRFlexAnimationDataScaling(DispatchBaseClass):
	...
	def GetAnimationScalingModeShapeFactor(self):
		'''
		Get animation scaling mode shape factor
	...
	def SetAnimationScalingModeShapeFactor(self, dFactor):
		'''
		Set animation scaling mode shape factor
...
IRFlexBody_vtables_ = [
	...
	(( 'AnimationDataScaling' , 'pVal' , ), 3029, (3029, (), [ (16393, 10, None, "IID('{E3D7FEE7-8867-4A03-B9EA-A1DD773026CC}')") , ], 1 , 2 , 4 , 0 , 440 , (3, 0, None, None) , 0 , )),
	(( 'Graphic' , 'ppVal' , ), 3030, (3030, (), [ (16393, 10, None, "IID('{4C8B7C23-7D92-4D39-B530-5D93DC97F771}')") , ], 1 , 2 , 4 , 0 , 448 , (3, 0, None, None) , 0 , )),
	(( 'CreateMarkerOnNode' , 'strName' , 'uiNodeID' , 'ppVal' , ), 3031, (3031, (), [ 
			 (8, 1, None, None) , (19, 1, None, None) , (16393, 10, None, "IID('{6B6F192C-B83F-4503-89E8-5CAB8DE726AA}')") , ], 1 , 1 , 4 , 0 , 456 , (3, 0, None, None) , 0 , )),
	(( 'CreateElementSet' , 'strName' , 'arrElementID' , 'ppVal' , ), 3032, (3032, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{312FF880-5EB3-4AE9-A989-940D556064EE}')") , ], 1 , 1 , 4 , 0 , 464 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSet' , 'strName' , 'arrNodeID' , 'ppVal' , ), 3033, (3033, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 472 , (3, 0, None, None) , 0 , )),
	(( 'RFlexElementSetCollection' , 'pVal' , ), 3034, (3034, (), [ (16393, 10, None, "IID('{B1A8C8FA-7869-4CB5-A285-91BCC4C2ADA3}')") , ], 1 , 2 , 4 , 0 , 480 , (3, 0, None, None) , 0 , )),
	(( 'RFlexPatchSetCollection' , 'pVal' , ), 3035, (3035, (), [ (16393, 10, None, "IID('{6A9E16A5-2CCC-4596-BDC0-07B767DB1A39}')") , ], 1 , 2 , 4 , 0 , 488 , (3, 0, None, None) , 0 , )),
	(( 'GetEntity' , 'strName' , 'ppVal' , ), 3036, (3036, (), [ (8, 1, None, None) , 
			 (16393, 10, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , ], 1 , 1 , 4 , 0 , 496 , (3, 0, None, None) , 0 , )),
	(( 'CreateOutput' , 'strName' , 'arrNodeID' , 'ppVal' , ), 3037, (3037, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{5C616B86-29F2-486F-9E0C-D66502222E30}')") , ], 1 , 1 , 4 , 0 , 504 , (3, 0, None, None) , 0 , )),
	(( 'RFlexOutputCollection' , 'pVal' , ), 3038, (3038, (), [ (16393, 10, None, "IID('{D1E612A4-BFE5-4676-B55D-76C41FE47B42}')") , ], 1 , 2 , 4 , 0 , 512 , (3, 0, None, None) , 0 , )),
	(( 'RFlexNodeSetCollection' , 'pVal' , ), 3039, (3039, (), [ (16393, 10, None, "IID('{2AAD6766-1ED5-498D-96BA-F9363B2DF588}')") , ], 1 , 2 , 4 , 0 , 520 , (3, 0, None, None) , 0 , )),
	(( 'CreateNodeSet' , 'strName' , 'arrNodeID' , 'ppVal' , ), 3040, (3040, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{26BFA995-9AE3-41D6-9F5B-B3699DC551A8}')") , ], 1 , 1 , 4 , 0 , 528 , (3, 0, None, None) , 0 , )),
	(( 'OutputFileInfo' , 'ppVal' , ), 3041, (3041, (), [ (16393, 10, None, "IID('{16BD870A-FA04-42F6-8B8D-7F484F5D421E}')") , ], 1 , 2 , 4 , 0 , 536 , (3, 0, None, None) , 0 , )),
	(( 'DisplaySetting' , 'ppVal' , ), 3042, (3042, (), [ (16393, 10, None, "IID('{3FDF0768-0052-4B63-9D84-A644C3152051}')") , ], 1 , 2 , 4 , 0 , 544 , (3, 0, None, None) , 0 , )),
	(( 'ExportShellFormatData' , 'ppVal' , ), 3043, (3043, (), [ (16393, 10, None, "IID('{2EE15E44-AD0C-4D9B-B53A-35BF7F1E1322}')") , ], 1 , 2 , 4 , 0 , 552 , (3, 0, None, None) , 0 , )),
	(( 'OutputFileInfoforRegenerator' , 'ppVal' , ), 3044, (3044, (), [ (16393, 10, None, "IID('{1B06647C-BAD6-464A-8B5E-DD243D535970}')") , ], 1 , 2 , 4 , 0 , 560 , (3, 0, None, None) , 0 , )),
	(( 'CreateLineSet' , 'strName' , 'arrNodeID' , 'ppVal' , ), 3045, (3045, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{7C9E9609-3A15-4847-8B60-6AE1460A7A58}')") , ], 1 , 1 , 4 , 0 , 568 , (3, 0, None, None) , 0 , )),
	(( 'RFlexNodeCollection' , 'pVal' , ), 3046, (3046, (), [ (16393, 10, None, "IID('{EEEA6051-9841-4895-BC92-93F52E98A389}')") , ], 1 , 2 , 4 , 0 , 576 , (3, 0, None, None) , 0 , )),
	(( 'MarkerCollection' , 'ppVal' , ), 3047, (3047, (), [ (16393, 10, None, "IID('{6BEF9B6B-4708-445E-A3B5-0D65BA69F748}')") , ], 1 , 2 , 4 , 0 , 584 , (3, 0, None, None) , 0 , )),
	(( 'MassInvariant' , 'pVal' , ), 3048, (3048, (), [ (3, 1, None, "IID('{5BA4E584-3306-4C81-89A9-A452C0BE259D}')") , ], 1 , 4 , 4 , 0 , 592 , (3, 0, None, None) , 0 , )),
	(( 'MassInvariant' , 'pVal' , ), 3048, (3048, (), [ (16387, 10, None, "IID('{5BA4E584-3306-4C81-89A9-A452C0BE259D}')") , ], 1 , 2 , 4 , 0 , 600 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSetWithBox' , 'strName' , 'pRefFrame' , 'dWidth' , 'dHeight' , 
			 ...
			 (5, 1, None, None) , (5, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 608 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSetWithNodeSet' , 'strName' , 'pNodeSet' , 'ppVal' , ), 3050, (3050, (), [ 
			 (8, 1, None, None) , (9, 1, None, "IID('{26BFA995-9AE3-41D6-9F5B-B3699DC551A8}')") , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 616 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSetWithElementIDsContinuous' , 'strName' , 'arrElementID' , 'dAngle' , 'bCheckReverse' , 
			 ...
			 (11, 1, None, None) , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 624 , (3, 0, None, None) , 0 , )),
	...
	(( 'CreatePatchSetWithPatchIndices' , 'strName' , 'arrPatchesIndices' , 'ppVal' , ), 3053, (3053, (), [ 
			 (8, 1, None, None) , (8195, 1, None, None) , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 640 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSetWithPatchIndicesContinuous' , 'strName' , 'arrPatchesIndices' , 'dAngle' , 'bCheckReverse' , 
			 ...
			 (11, 1, None, None) , (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 648 , (3, 0, None, None) , 0 , )),
	(( 'CreateMarker' , 'strName' , 'pRefFrame' , 'ppVal' , ), 3055, (3055, (), [ 
			 (8, 1, None, None) , (9, 1, None, "IID('{6A3295D9-E76B-473C-9655-23B7B1CBD671}')") , (16393, 10, None, "IID('{6B6F192C-B83F-4503-89E8-5CAB8DE726AA}')") , ], 1 , 1 , 4 , 0 , 656 , (3, 0, None, None) , 0 , )),
	(( 'RFlexElementCollection' , 'pVal' , ), 3056, (3056, (), [ (16393, 10, None, "IID('{0D1751C5-008C-4B1A-9B5D-41CD0E76D87A}')") , ], 1 , 2 , 4 , 0 , 664 , (3, 0, None, None) , 0 , )),
	(( 'GetNodeByID' , 'nID' , 'ppVal' , ), 3057, (3057, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{676058EF-4A4E-4E4E-BBBF-2150FFBE932C}')") , ], 1 , 1 , 4 , 0 , 672 , (3, 0, None, None) , 0 , )),
	(( 'GetElementByID' , 'nID' , 'ppVal' , ), 3058, (3058, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{D4391208-4F5B-4A0C-80B0-8CBF5F198DBB}')") , ], 1 , 1 , 4 , 0 , 680 , (3, 0, None, None) , 0 , )),
	(( 'CreatePatchSetWithCone' , 'strName' , 'pFirstPoint' , 'pSecondPoint' , 'dTopRadius' , 
			 ...
			 (16393, 10, None, "IID('{D81E74E6-91E4-4473-8F75-3E25C1041FE6}')") , ], 1 , 1 , 4 , 0 , 688 , (3, 0, None, None) , 0 , )),
	(( 'LayerNumber' , 'pVal' , ), 3060, (3060, (), [ (19, 1, None, None) , ], 1 , 4 , 4 , 0 , 696 , (3, 0, None, None) , 0 , )),
	(( 'LayerNumber' , 'pVal' , ), 3060, (3060, (), [ (16403, 10, None, None) , ], 1 , 2 , 4 , 0 , 704 , (3, 0, None, None) , 0 , )),
	(( 'ParametricPointCollection' , 'ppVal' , ), 3061, (3061, (), [ (16393, 10, None, "IID('{65267578-7015-4BB5-BB65-F5F81CCEA244}')") , ], 1 , 2 , 4 , 0 , 712 , (3, 0, None, None) , 0 , )),
	(( 'ParametricValueCollection' , 'ppVal' , ), 3062, (3062, (), [ (16393, 10, None, "IID('{65267578-7015-4BB5-BB65-F5F81CCEA245}')") , ], 1 , 2 , 4 , 0 , 720 , (3, 0, None, None) , 0 , )),
	(( 'ImportParametricPoint' , 'strFileName' , ), 3063, (3063, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 728 , (3, 0, None, None) , 0 , )),
	(( 'ExportParametricPoint' , 'strFileName' , ), 3064, (3064, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 736 , (3, 0, None, None) , 0 , )),
	(( 'ImportParametricValue' , 'strFileName' , ), 3065, (3065, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 744 , (3, 0, None, None) , 0 , )),
	(( 'ExportParametricValue' , 'strFileName' , ), 3066, (3066, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 752 , (3, 0, None, None) , 0 , )),
	(( 'CreateParametricPoint' , 'strName' , 'pPoint' , 'pRefMarker' , 'ppVal' , 
			 ), 3067, (3067, (), [ (8, 1, None, None) , (8197, 1, None, None) , (9, 1, None, "IID('{6B6F192C-B83F-4503-89E8-5CAB8DE726AA}')") , (16393, 10, None, "IID('{64B0B5B9-7662-40E8-B27C-9E42C3A158BF}')") , ], 1 , 1 , 4 , 0 , 760 , (3, 0, None, None) , 0 , )),
	(( 'CreateParametricValue' , 'strName' , 'dValue' , 'ppVal' , ), 3068, (3068, (), [ 
			 (8, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{3EEED3CE-62E8-4882-AAE6-4812B49927B5}')") , ], 1 , 1 , 4 , 0 , 768 , (3, 0, None, None) , 0 , )),
	(( 'CreateParametricPointWithText' , 'strName' , 'strText' , 'pRefMarker' , 'ppVal' , 
			 ), 3069, (3069, (), [ (8, 1, None, None) , (8, 1, None, None) , (9, 1, None, "IID('{6B6F192C-B83F-4503-89E8-5CAB8DE726AA}')") , (16393, 10, None, "IID('{64B0B5B9-7662-40E8-B27C-9E42C3A158BF}')") , ], 1 , 1 , 4 , 0 , 776 , (3, 0, None, None) , 0 , )),
	(( 'CreateParametricValueWithText' , 'strName' , 'strText' , 'ppVal' , ), 3070, (3070, (), [ 
			 (8, 1, None, None) , (8, 1, None, None) , (16393, 10, None, "IID('{3EEED3CE-62E8-4882-AAE6-4812B49927B5}')") , ], 1 , 1 , 4 , 0 , 784 , (3, 0, None, None) , 0 , )),
	(( 'RFlexLineSetCollection' , 'pVal' , ), 3071, (3071, (), [ (16393, 10, None, "IID('{05938874-D404-42C9-9757-863978D57DE5}')") , ], 1 , 2 , 4 , 0 , 792 , (3, 0, None, None) , 0 , )),
	(( 'Active' , 'pVal' , ), 3072, (3072, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 800 , (3, 0, None, None) , 0 , )),
	(( 'Active' , 'pVal' , ), 3072, (3072, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 808 , (3, 0, None, None) , 0 , )),
]
