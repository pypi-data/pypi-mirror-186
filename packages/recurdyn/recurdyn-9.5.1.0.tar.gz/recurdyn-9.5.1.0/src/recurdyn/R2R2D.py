...
'RecurDyn V9R5 RecurDynCOMR2R2D Type Library'
...
IR2R2DGeometryRollerCircle_vtables_ = [
	(( 'Radius' , 'ppVal' , ), 10101, (10101, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 176 , (3, 0, None, None) , 0 , )),
	(( 'Depth' , 'ppVal' , ), 10102, (10102, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 184 , (3, 0, None, None) , 0 , )),
]

IR2R2DGeometryRollerGeneral_vtables_dispatch_ = 1
IR2R2DGeometryRollerGeneral_vtables_ = [
	(( 'Depth' , 'ppVal' , ), 10101, (10101, (), [ (16393, 10, None, "IID('{2B5166E3-4B31-4607-B157-BE237A670336}')") , ], 1 , 2 , 4 , 0 , 176 , (3, 0, None, None) , 0 , )),
	(( 'PointCollection' , 'ppVal' , ), 10102, (10102, (), [ (16393, 10, None, "IID('{2C0D70A3-D197-4781-940A-1672F3B420B9}')") , ], 1 , 2 , 4 , 0 , 184 , (3, 0, None, None) , 0 , )),
	(( 'Export' , 'strName' , 'val' , ), 10103, (10103, (), [ (8, 1, None, None) , 
			 (11, 1, None, None) , ], 1 , 1 , 4 , 0 , 192 , (3, 0, None, None) , 0 , )),
	(( 'Import' , 'strName' , ), 10104, (10104, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 200 , (3, 0, None, None) , 0 , )),
]
...
IR2R2DSubSystem_vtables_ = [
	...
	(( 'CreateBodyBeam' , 'strName' , 'pBodyList' , 'pInOutList' , 'uiNumberOfElements' , 
			 ...
			 (8204, 1, None, None) , (19, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , ], 1 , 1 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
	(( 'CreateBodyBeamWithOpenLoop' , 'strName' , 'pBodyList' , 'pInOutList' , 'pStartDir' , 
			 ...
			 (8197, 1, None, None) , (8197, 1, None, None) , (19, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , ], 1 , 1 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
	(( 'CreateBodyBeamWithPreWinding' , 'strName' , 'pBodyList' , 'pInOutList' , 'pStartDir' , 
			 ...
			 (19, 1, None, None) , (19, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , ], 1 , 1 , 4 , 0 , 240 , (3, 0, None, None) , 0 , )),
	(( 'CreateSensorSpeed' , 'strName' , 'pPosition' , 'pDirection' , 'pEntity' , 
			 'dRange' , 'ppVal' , ), 10013, (10013, (), [ (8, 1, None, None) , (8197, 1, None, None) , 
			 (8197, 1, None, None) , (9, 1, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , (5, 1, None, None) , (16393, 10, None, "IID('{CCB7E742-F0DF-4F22-A377-04AA675FD281}')") , ], 1 , 1 , 4 , 0 , 248 , (3, 0, None, None) , 0 , )),
	(( 'CreateSensorDistance' , 'strName' , 'pPosition' , 'pDirection' , 'pEntity' , 
			 'dRange' , 'ppVal' , ), 10014, (10014, (), [ (8, 1, None, None) , (8197, 1, None, None) , 
			 (8197, 1, None, None) , (9, 1, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , (5, 1, None, None) , (16393, 10, None, "IID('{0CC3861B-CC2A-4402-9135-C8BC804EABBD}')") , ], 1 , 1 , 4 , 0 , 256 , (3, 0, None, None) , 0 , )),
	(( 'CreateSensorSlip' , 'strName' , 'pPosition' , 'pSlipEntity' , 'pEntity' , 
			 'dRange' , 'ppVal' , ), 10015, (10015, (), [ (8, 1, None, None) , (8197, 1, None, None) , 
			 (9, 1, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , (9, 1, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , (5, 1, None, None) , (16393, 10, None, "IID('{08675B12-6A90-4082-BAED-E54382FDF107}')") , ], 1 , 1 , 4 , 0 , 264 , (3, 0, None, None) , 0 , )),
	(( 'CreateSensorTension' , 'strName' , 'pPosition' , 'pEntity' , 'dRange' , 
			 ...
			 (5, 1, None, None) , (16393, 10, None, "IID('{55C49622-A503-4651-BF1E-2A84CD9E27AB}')") , ], 1 , 1 , 4 , 0 , 272 , (3, 0, None, None) , 0 , )),
	(( 'CreateContactWorkpieceToWorkpiece' , 'strName' , 'pBaseBeamAssembly' , 'pActionBeamAssembly' , 'ppResult' , 
			 ), 10017, (10017, (), [ (8, 1, None, None) , (9, 1, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , (9, 1, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , (16393, 10, None, "IID('{F40C22AF-8635-4E5D-9CDD-D7E4C4697EFD}')") , ], 1 , 1 , 4 , 0 , 280 , (3, 0, None, None) , 0 , )),
	(( 'CreateForceConcentratedLoadUSUB' , 'strName' , 'pNodeSet' , 'pUsub' , 'ppVal' , 
			 ), 10018, (10018, (), [ (8, 1, None, None) , (9, 1, None, "IID('{27A86788-8B85-40CF-BE7F-BA915103A7DB}')") , (9, 1, None, "IID('{9573C3F4-958E-4EC2-B9E6-C4660433CFA3}')") , (16393, 10, None, "IID('{6643BA23-1926-4BEB-8F25-DA51C7AF1C47}')") , ], 1 , 1 , 4 , 0 , 288 , (3, 0, None, None) , 0 , )),
	(( 'BodyBeamCollection' , 'ppVal' , ), 10030, (10030, (), [ (16393, 10, None, "IID('{D51B4A60-30FE-4A2C-89CE-6DE904CD7771}')") , ], 1 , 2 , 4 , 0 , 296 , (3, 0, None, None) , 0 , )),
	(( 'BodyCollection' , 'ppVal' , ), 10031, (10031, (), [ (16393, 10, None, "IID('{F66AB8D5-E20C-437F-BD61-982CCD09B711}')") , ], 1 , 2 , 4 , 0 , 304 , (3, 0, None, None) , 0 , )),
	(( 'GuideCollection' , 'ppVal' , ), 10032, (10032, (), [ (16393, 10, None, "IID('{2185E9C9-D7B1-4AE5-A0BE-A49CA236280A}')") , ], 1 , 2 , 4 , 0 , 312 , (3, 0, None, None) , 0 , )),
	(( 'ContacttWorkpieceToWorkpieceCollection' , 'ppVal' , ), 10033, (10033, (), [ (16393, 10, None, "IID('{3AC2E0DA-1DEA-4818-B371-A35C8E858CAE}')") , ], 1 , 2 , 4 , 0 , 320 , (3, 0, None, None) , 0 , )),
	(( 'Contour' , 'ppVal' , ), 10034, (10034, (), [ (16393, 10, None, "IID('{BDF4F979-28B7-48D2-BF06-9C59B70D467B}')") , ], 1 , 2 , 4 , 0 , 328 , (3, 0, None, None) , 0 , )),
	(( 'ConcentratedLoadUSUBCollection' , 'ppVal' , ), 10035, (10035, (), [ (16393, 10, None, "IID('{4EEF5BEB-2CCF-4BD9-8159-CF6A337F2581}')") , ], 1 , 2 , 4 , 0 , 336 , (3, 0, None, None) , 0 , )),
	(( 'CreateBodyBeamWithPreWinding2' , 'strName' , 'pBodyList' , 'pInOutList' , 'pStartDir' , 
			 ...
			 (19, 1, None, None) , (5, 1, None, None) , (16393, 10, None, "IID('{FF337086-F852-42E3-BF88-2795D0BBCB31}')") , ], 1 , 1 , 4 , 0 , 344 , (3, 0, None, None) , 0 , )),
]
