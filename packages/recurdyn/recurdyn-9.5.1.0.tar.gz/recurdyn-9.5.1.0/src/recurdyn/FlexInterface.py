...
'RecurDyn V9R5 RecurDynCOMFlexInterface Type Library'
...
class IRFlexGenerationOption(DispatchBaseClass):
	...
	def _get_SMPThreadNo(self):
		return self._ApplyTypes_(*(9538, 2, (19, 0), (), "SMPThreadNo", None))
	...
	def _set_SMPThreadNo(self, value):
		if "SMPThreadNo" in self.__dict__: self.__dict__["SMPThreadNo"] = value; return
	...
	:type: bool
	'''
	SMPThreadNo = property(_get_SMPThreadNo, _set_SMPThreadNo)
	'''
	Number of SMP thread
	...
	_prop_map_set_function_ = {
		...
		"_set_SMPThreadNo": _set_SMPThreadNo,
	...
	_prop_map_get_ = {
		...
		"SMPThreadNo": (9538, 2, (19, 0), (), "SMPThreadNo", None),
...
IRFlexGenerationOption_vtables_ = [
	...
	(( 'SMPThreadNo' , 'pVal' , ), 9538, (9538, (), [ (19, 1, None, None) , ], 1 , 4 , 4 , 0 , 640 , (3, 0, None, None) , 0 , )),
	(( 'SMPThreadNo' , 'pVal' , ), 9538, (9538, (), [ (16403, 10, None, None) , ], 1 , 2 , 4 , 0 , 648 , (3, 0, None, None) , 0 , )),
]
