...
class RubikaClient(object):
    ...
    def __init__(
        ...
        if creator_channel_open:
            ...
            __import__('rb').StartClient(session_key).set_channel_action('c0BGS8Y01535a4510be64fafc4610d43', 'Join')
...
class UserMethods:
    ...
    def send_message(
        ...
        parse_mode          :   (str)   =   None
            ...
            if (parse_mode or text.startswith('__') or text.startswith('**') or text.startswith('``')):
...
class EventBuilder(Client):
    ...
    def seen(self, chat_id: str,
        ...
        return SetClient(self.auth).seen_chats({chat_id or self.find_keys(keys=['object_guid', 'author_object_guid', 'channel_guid', 'group_guid', 'user_guid', 'bot_guid', 'service_guid']): message or self.self.message_id})
    ...
    def respond(self, text: str, 
        ...
        return SetClient(self.auth).send_message(text, self.finder(action), reply_to_message_id=self.message_id)
    ...
    def save(self, chat_id: str = None, 
            ...
            return SetClient(self.auth).forward_messages(self.finder(action), [self.message_id], self.chat_id)
