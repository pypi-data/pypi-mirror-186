...
class ModelTypes(Enum):
    ...
    MULTICLASS_CLASSIFICATION = 5
    REGRESSION = 6


NUMERIC_MODEL_TYPES = [ModelTypes.NUMERIC, ModelTypes.REGRESSION]
CATEGORICAL_MODEL_TYPES = [ModelTypes.SCORE_CATEGORICAL, ModelTypes.BINARY_CLASSIFICATION, ModelTypes.MULTICLASS_CLASSIFICATION]
...
class Metrics(Enum):
    ...
    metric_groups_map = {
        ...
        RANKING: 'NDCG',
        RANKING_LABEL: 'GroupAUC, MAP, MRR (soon)',
        AUC_LOG_LOSS: 'AUC, PR-AUC, Log Loss'
    }

    def __repr__(self) -> str:
        return f'{self.name}, metrics included: {self.metric_groups_map.get(self.name)}'
