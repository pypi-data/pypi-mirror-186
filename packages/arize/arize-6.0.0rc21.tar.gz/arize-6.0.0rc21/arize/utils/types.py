...
CATEGORICAL_MODEL_TYPES = [ModelTypes.SCORE_CATEGORICAL, ModelTypes.BINARY_CLASSIFICATION]
...
class Metrics(DocEnum):
    ...
    CLASSIFICATION = 2, 'Accuracy, Recall, Precision, FPR, FNR, F1, Sensitivity, Specificity'
    RANKING = 3, 'NDCG'
