...
class Service(
    ...
    def put_task_spec(
        ...
        *,
        ...
        :param networks_advanced: networks_advanced block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/docker/r/service#networks_advanced Service#networks_advanced}
...
class ServiceTaskSpecContainerSpec:
    def __init__(
        ...
        *,
        ...
        :param sysctl: Sysctls config (Linux only). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/docker/r/service#sysctl Service#sysctl}
...
class ServiceTaskSpecNetworksAdvanced:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The name/id of the network. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/docker/r/service#name Service#name}
        :param aliases: The network aliases of the container in the specific network. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/docker/r/service#aliases Service#aliases}
        :param driver_opts: An array of driver options for the network, e.g. ``opts1=value``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/docker/r/service#driver_opts Service#driver_opts}
        '''
        if __debug__:
