...
from dropbox_sign import rest
from dropbox_sign.configuration import Configuration
from dropbox_sign.exceptions import ApiTypeError, ApiValueError, ApiException
from dropbox_sign.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.0-beta2301post1/python'
...
class Endpoint(object):
        ...
        for param_name, param_value in kwargs.items():
            ...
            if param_location:
                if param_location == 'body':
                    ...
                    """
                    body = param_value.to_dict()
                    remove_files = []

                    for oas_name in param_value.openapi_types:
                        if hasattr(param_value, oas_name):
                            obj = param_value[oas_name]
                            if isinstance(obj, file_type):
                                params['file'][oas_name] = [obj]
                                remove_files.append(oas_name)
                            elif isinstance(obj, list):
                                i = 0
                                for obj_value in obj:
                                    if isinstance(obj_value, file_type):
                                        key = oas_name + '[' + str(i) + ']'
                                        params['file'][key] = [obj_value]
                                        remove_files.append(oas_name)
                                        i += 1
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.account_create  # this is an instance of the class Endpoint
        api_instance.account_create()  # this invokes api_instance.account_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.account_create.callable or self.callable in this class
