...
class ProductsApi(object):
    ...
    def product_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `product_list`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'start' in local_var_params and local_var_params['start'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `start` when calling `product_list`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def select_by_lidvid(self, identifier, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.select_by_lidvid_with_http_info(identifier, **kwargs)  # noqa: E501

    def select_by_lidvid_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """returns one PDS Product with the identifier selected from all PDS Products, including bundles, collections, data, documentation, context and observational products. See identifier for details on how it determines what is returned.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.select_by_lidvid_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method select_by_lidvid" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and local_var_params.get('identifier') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `select_by_lidvid`")  # noqa: E501
    ...
    def select_by_lidvid_all(self, identifier, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.select_by_lidvid_all_with_http_info(identifier, **kwargs)  # noqa: E501

    def select_by_lidvid_all_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """returns all product versions with the identifier (lid) selected from all PDS Products. See identifier for details on how it determines what is returned.  note: if given a lidvid, it will be translated to a lid   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.select_by_lidvid_all_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method select_by_lidvid_all" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and local_var_params.get('identifier') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `select_by_lidvid_all`")  # noqa: E501

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `select_by_lidvid_all`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'start' in local_var_params and local_var_params['start'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `start` when calling `select_by_lidvid_all`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def select_by_lidvid_latest(self, identifier, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.select_by_lidvid_latest_with_http_info(identifier, **kwargs)  # noqa: E501

    def select_by_lidvid_latest_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """returns one PDS Product with the identifier selected from all PDS Products. See identifier for details on how it determines what is returned.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.select_by_lidvid_latest_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method select_by_lidvid_latest" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and local_var_params.get('identifier') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `select_by_lidvid_latest`")  # noqa: E501
