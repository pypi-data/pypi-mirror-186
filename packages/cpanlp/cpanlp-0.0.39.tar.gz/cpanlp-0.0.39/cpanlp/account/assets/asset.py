...
class Asset:
    ...
    def create_summary(self,assets):
...
class FinancialAsset(Asset):
     ...
     def plot_market_trend(self):
            ...
            plt.xlabel('时间')
            plt.ylabel('价格')
            plt.title(f'{self.account} 市场价格趋势')
            plt.show()
...
if __name__ == '__main__':
    ...
    print(ww)
    a12 = FinancialAsset("shanghai",100,"2022-12-15",[20,30])
    a2 = FinancialAsset("shanghai1",200,"2022-12-15",[20,30])
    c=a12.roi()
    b=generate__asset_report([Asset("黄金",199,"2022-01-12"),Asset("股票",102,"2022-01-11")])
    print(b)
    a1 = Asset("a1",  100,"2022-01-02")
    a2 = Asset("a2",  200,"2023-01-02")
    a3 = Asset("a3",  300,"2024-01-02")
    assets_list = [a1,a2,a3]
    print(a.create_summary(assets_list))
