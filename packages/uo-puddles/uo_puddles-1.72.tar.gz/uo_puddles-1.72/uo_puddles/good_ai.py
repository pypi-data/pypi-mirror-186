...
import builtins
import types
#this won't work situated in puddles. Appears globals() is for this module and not notebook.
#Problem comes when calling user defined function within another user-defined function.
#Will not find user-defined functions in module globals. Only solution I see is moving it
#to top of each notebook.

def up_no_globals_old(f):
  '''
...
#should be able to replace with colab globals
def up_no_globals(g=globals().items()):
