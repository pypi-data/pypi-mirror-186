...
from hestia_earth.validation.gee import MAX_AREA_SIZE, is_enabled, id_to_level, get_region_id
...
def validate_list_dates_after(node: dict, node_key: str, list_key: str, list_key_fields: list[str]):
