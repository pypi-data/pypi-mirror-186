...
class AlastriaAuthView(ViewSet):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter(
                "subject_did",
                openapi.IN_QUERY,
                description="Subject Alastria DID",
    ...
    def auth(self, request):
        subject_did: str = request.GET["subject_did"]
        rs: RequestSession = AlastriaAuthService.get_request_session_serializer(subject_did)
    ...
    def confirm(self, request):
        ...
        api_session: ApiSession = ApiSession.objects.get(request_session_id=request_session_id)
