...
The `QuestionAnswerModel` class is an example class designed to generate questions from an answer. 

### Usage

    model = QuestionAnswerModel()
    lesson = "Greek Philosophy"
    answer = "Socrates"
    examples = [
        "Who said 'The only true wisdom is in knowing you know nothing.'",
        "Who said 'I am the wisest man alive, for I know one thing, and that is that I know nothing.'",
    ]
    model.fit(lesson, answer, examples)
