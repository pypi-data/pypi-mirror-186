...
from aos_prov.utils.common import DISK_IMAGE_DOWNLOAD_URL, AOS_DISK_PATH, DOWNLOADS_PATH, AOS_DISKS_PATH
...
try:
    ...
    DeviceType, AccessMode, NATProtocol, FirmwareType, INATNetwork, NetworkAdapterType, NetworkAttachmentType
except Exception:
    pass
