...
from ._node_run_setting_writer import CommandRunSettingWriter, SparkRunSettingWriter, ParallelRunSettingWriter, \
    SweepRunSettingWriter, PipelineRunSettingWriter, _dump_dict_to_str, _process_data_of_binding_and_primitive
...
class SingleComponentFuncGenerator(BaseGenerator):
    def __init__(self, component_entity, component_func_name, logger, **kwargs):    # pylint: disable=unused-argument
        ...
        node_runsetting_writer_dict = {'command': CommandRunSettingWriter, 'spark': SparkRunSettingWriter,
                                       'parallel': ParallelRunSettingWriter, 'sweep': SweepRunSettingWriter,
    ...
    def _get_params(self):
        ...
        for node_name, node_input in self._node.inputs.items():
            ...
            elif isinstance(node_input, NodeInput):
