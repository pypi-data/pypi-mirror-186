...
class ExecutorBase:
    ...
    SUPPORTED_RETURN_TYPES_PRIMITVE = list(IoConstants.PRIMITIVE_TYPE_2_STR.keys())
    ...
    def finalize(self, run_result_mapping, return_args):
        ...
        control_output_keys = [
            key for key, output in self._return_mapping.items() if output.is_control and not output.early_available
        ]
    ...
    def _check_single_result_with_annotation(self, run_result, annotation, name="output"):
        ...
        if (
            ...
            (annotation in self.SUPPORTED_RETURN_TYPES_PRIMITVE and isinstance(run_result, annotation))
    ...
    @classmethod
    def _update_outputs_to_execution_args(cls, args, param):
    ...
    def _get_standard_output_annotation(cls, annotation, func, output_name=None) -> dict:
        ...
        exception_tail = (
            ...
            f"{list(cls.SUPPORTED_RETURN_TYPES_NON_PRIMITIVE) + cls.SUPPORTED_RETURN_TYPES_PRIMITVE}) "
        ...
        if annotation in cls.SUPPORTED_RETURN_TYPES_PRIMITVE:
    ...
    def _write_control_outputs_to_run_history(cls, control_output_content: str):
        ...
        return _write_properties_to_run_history(
            ...
            operation_name=RunHistoryOperations.WRITE_CONTROL_OUTPUTS,
        )
