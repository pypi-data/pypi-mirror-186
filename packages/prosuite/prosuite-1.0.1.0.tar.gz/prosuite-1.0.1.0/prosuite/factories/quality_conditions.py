...
class Conditions:
    ...
    def qa_min_node_distance_4(cls, feature_class: BaseDataset, near: float, max_z_difference: float) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClass' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'
        """
    ...
    def qa_min_node_distance_5(cls, feature_classes: List[BaseDataset], near: float, max_z_difference: float) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClasses' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'
    ...
    def qa_min_node_distance_6(cls, feature_class: BaseDataset, near: float, tolerance: float, max_z_difference: float) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClass' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'. Pairs closer than 'tolerance' are considered coincident
        """
    ...
    def qa_min_node_distance_7(cls, feature_classes: List[BaseDataset], near: float, tolerance: float, max_z_difference: float) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClasses' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'. Pairs closer than 'tolerance' are considered coincident
        """
    ...
    def qa_min_node_distance_9(cls, feature_class: BaseDataset, near: float, tolerance: float, max_z_difference: float, valid_relation_constraint: str) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClass' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'. Pairs closer than 'tolerance' are considered coincident. No error is reported for point pairs that fulfill a defined constraint.
        """
    ...
    def qa_min_node_distance_10(cls, feature_classes: List[BaseDataset], near: float, tolerance: float, max_z_difference: float, valid_relation_constraint: str) -> Condition:
        """
        Finds all pair of (From\/To-) points of 'featureClasses' closer than 'near' and find all coincidend pairs with z-coordinate difference larger than 'maxZDifference'. Pairs closer than 'tolerance' are considered coincident. No error is reported for point pairs that fulfill a defined constraint.
        """
    ...
    def qa_mp_footprint_holes_0(cls, multi_patch_class: BaseDataset, inner_ring_handling: InnerRingHandling, horizontal_z_tolerance: float = 0, resolution_factor: float = 1, minimum_area: float = -1, report_vertical_patches_not_completely_within_footprint: bool = True) -> Condition:
        """
        Find mutlitpatch features where footprints have inner rings
        """
    ...
    def qa_z_difference_self_3(cls, feature_classes: List[BaseDataset], minimum_z_difference: float, maximum_z_difference: float, z_comparison_method: ZComparisonMethod, z_relation_constraint: str, minimum_z_difference_expression: str = None, maximum_z_difference_expression: str = None) -> Condition:
        """
        Finds features where the Z difference to another feature within a list of feature classesis not between 'minimumZDifference' and 'maximumZDifference'
        """
