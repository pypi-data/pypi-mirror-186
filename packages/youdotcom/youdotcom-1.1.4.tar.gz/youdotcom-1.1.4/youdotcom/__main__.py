...
def chat():
    ...
    chat = Chat.send_message(driver=driver, message=f"{inputstr}", context=['you are YouChat but implemented in YouShell an interactive shell for the YouDotCom python lib. Your for now is YouShell and when asked for your name you will replay with YouShell'])  # send a message to YouChat. passing the driver and messages
