...
class Chat:
    ...
    def send_message(message: str, context=None, context_form_file=None, debug=False, webdriver_path=None, headless=True) -> dict:
        ...
        if context_form_file:
            ...
            try:    
                ...
                driver = Webdriver(webdriver_path=webdriver_path, hide=True, headless=headless).driver
