...
import src.icsr.structure as structure
import src.icsr.utils as utils
import re
...
class EvidenceStrategy(BaseModel):
    ...
    def _icsr_evidence(self, icsr: structure.Icsr, text: str) -> None:
        icsr.subject_evidence = self.get_subject_evidence(icsr.subject, text)
        icsr.drug_evidence = self.get_drug_evidence(icsr.drug, text)
        icsr.reaction_evidence = self.get_reaction_evidence(icsr.reaction, text)
    ...
    def get_subject_evidence(self, string: str) -> list[structure.Evidence]:
        raise NotImplementedError

    def get_drug_evidence(self, string: str) -> list[structure.Evidence]:
        raise NotImplementedError

    def get_reaction_evidence(self, string: str) -> list[structure.Evidence]:
        raise NotImplementedError
...
class ExactEvidence(EvidenceStrategy):
    ...
    def get_subject_evidence(self, string: str, text: str) -> list[structure.Evidence]:
        return self._get_all_evidence(string, text)

    def get_drug_evidence(self, string: str, text: str) -> list[structure.Evidence]:
        return self._get_all_evidence(string, text)

    def get_reaction_evidence(self, string: str, text: str) -> list[structure.Evidence]:
        return self._get_all_evidence(string, text)
