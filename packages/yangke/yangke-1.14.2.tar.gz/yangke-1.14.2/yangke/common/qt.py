...
from PyQt5.QtCore import QRect, QFileInfo, QUrl
...
from yangke.common.QtImporter import QtGui, QMainWindow, QHBoxLayout, QPushButton, QComboBox, QLineEdit, \
    ...
    QPoint, QPointF, QLine, QLineF, QListView, QDockWidget, QToolBar, QAbstractItemView
...
class YkWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.toolbars.update({toolbar.get_name(): toolbar})
        toolbar.apply_action_connect()  # 使工具栏中的工具项事件可以正常触发，必须在addToolBar()之后执行
        # ----------------------------- 设置软件菜单 -------------------------------------
