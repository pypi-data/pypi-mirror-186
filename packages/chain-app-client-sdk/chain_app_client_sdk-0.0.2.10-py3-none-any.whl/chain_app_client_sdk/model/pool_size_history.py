...
class PoolSizeHistory(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "status", ], str]):
