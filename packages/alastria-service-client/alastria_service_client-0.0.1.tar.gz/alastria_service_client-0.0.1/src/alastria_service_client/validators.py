...
from contracts.enums import EidasLevelEnum
from typing import NewType
Transaction = NewType("Transaction", dict)  # TODO: CHECK RETURN TYPE
Address = NewType("Address", str)  # TODO: CHECK RETURN TYPE
