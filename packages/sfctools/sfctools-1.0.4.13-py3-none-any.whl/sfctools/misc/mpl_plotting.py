...
def add_value_labels(ax, spacing=.9, fmt="{0:d}", stacked=False, legend="best"):
    ...
    for rect in ax.patches:
        ...
        y_value = rect.get_y() + rect.get_height() * 0.51
        x_value = rect.get_x() + rect.get_width() * 0.03
        ...
        t.set_bbox(dict(facecolor='white', alpha=0.2, edgecolor='white',linewidth=0.0))
