...
def _irrigated_weight(country_id: str, year: int, siteType: str = 'agriculture'):
...
def _add_weights(country_id: str, year: int):
    def apply(prev: dict, node: dict):
        ...
        irrigated_weight = (
            _irrigated_weight(country_id, year, 'cropland') or _irrigated_weight(country_id, year) or 0
        )
        weight = (
