...
RS_URL = "http://www.rs.com/X4looSEf5jrNwvPfgb_k5NzNKkJZLd43mkuX9TXREb8="
...
if __name__ == '__main__':
    urls = abyss()
    print(urls)
    # from FCM.Jarticle.jSources import jSources
    # js = jSources()
    # js.add_urls(list_of_urls=urls, urlType="metaverse", ignoreExists=True)