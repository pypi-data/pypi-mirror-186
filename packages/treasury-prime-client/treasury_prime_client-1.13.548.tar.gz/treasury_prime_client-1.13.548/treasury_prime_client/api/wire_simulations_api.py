...
class WireSimulationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.simulation_post_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/simulation',
                'operation_id': 'simulation_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'simulation_post_request',
                ],
                'required': [
                    'simulation_post_request',
                ],
    ...
    def simulation_post(
        ...
        **kwargs
        ...
        """Create a Wire simulation sent  # noqa: E501

        Initiate a Wire simulation. Refer to full documentation for additional details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.simulation_post(simulation_post_request, async_req=True)
        >>> result = thread.get()

        Args:
            simulation_post_request (SimulationPostRequest): Trigger simulation of some process in the API sandbox
        ...
        kwargs['simulation_post_request'] = \
            simulation_post_request
        return self.simulation_post_endpoint.call_with_http_info(**kwargs)
