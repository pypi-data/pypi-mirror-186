...
class SettingsApi(object):
    ...
    def get_setting(
        ...
        **kwargs
        ...
        """Retrieve Setting  # noqa: E501

        There is only one setting object per organization and to retrieve just call the setting endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_setting(async_req=True)
        >>> result = thread.get()
