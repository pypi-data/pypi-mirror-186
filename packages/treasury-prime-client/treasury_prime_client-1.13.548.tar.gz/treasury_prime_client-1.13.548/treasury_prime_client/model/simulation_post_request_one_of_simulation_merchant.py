...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOfSimulationMerchantAddress'] = SimulationPostRequestOneOfSimulationMerchantAddress


class SimulationPostRequestOneOfSimulationMerchant(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mid': (str,),  # noqa: E501
            'mcc': (str,),  # noqa: E501
            'address': (SimulationPostRequestOneOfSimulationMerchantAddress,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, mid, mcc, address, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulationMerchant - a model defined in OpenAPI

        Args:
            name (str): Name of the merchant
            mid (str): Merchant ID
            mcc (str): Merchant Category Code
            address (SimulationPostRequestOneOfSimulationMerchantAddress):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, mid, mcc, address, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulationMerchant - a model defined in OpenAPI
