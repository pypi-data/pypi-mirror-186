...
class AdditionalPersonApplication(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'person_application_id': (str,),  # noqa: E501
            'role': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'person_application_id': 'person_application_id',  # noqa: E501
        'role': 'role',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, person_application_id, role, *args, **kwargs):  # noqa: E501
        """AdditionalPersonApplication - a model defined in OpenAPI

        Args:
            account_id (str): Id of the Account to associate the Person Application with
            person_application_id (str): Id of the Person Application to associate with the Account
            role (str): Role to use when associating the Person Application with the Account
        ...
        Keyword Args:
            ...
            status (str): Status of the additional person application. One of `approved`, `error`, `pending`, `processing`, `rejected`, `manual_review`. [optional]  # noqa: E501
        ...
        self.person_application_id = person_application_id
        self.role = role
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, person_application_id, role, *args, **kwargs):  # noqa: E501
        """AdditionalPersonApplication - a model defined in OpenAPI
