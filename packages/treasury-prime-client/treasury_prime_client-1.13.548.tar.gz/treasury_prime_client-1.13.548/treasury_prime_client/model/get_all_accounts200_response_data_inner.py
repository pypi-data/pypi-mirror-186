...
class GetAllAccounts200ResponseDataInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, account_type, created_at, id, routing_number, updated_at, userdata, *args, **kwargs):  # noqa: E501
        """GetAllAccounts200ResponseDataInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, userdata, *args, **kwargs):  # noqa: E501
        """GetAllAccounts200ResponseDataInner - a model defined in OpenAPI
