...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOf5Simulation'] = SimulationPostRequestOneOf5Simulation


class SimulationPostRequestOneOf5(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'ACH.PROCESSING_SENT': "ach.processing_sent",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'simulation': (SimulationPostRequestOneOf5Simulation,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf5 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOf5Simulation):

        Keyword Args:
            type (str): defaults to "ach.processing_sent", must be one of ["ach.processing_sent", ]  # noqa: E501
        ...
        type = kwargs.get('type', "ach.processing_sent")
