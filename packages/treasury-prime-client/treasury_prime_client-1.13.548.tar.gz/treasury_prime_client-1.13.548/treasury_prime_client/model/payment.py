...
class Payment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'deliver_by_date': (date,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'deliver_by_date': 'deliver_by_date',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, billpay_counterparty_id, created_at, id, person_id, updated_at, *args, **kwargs):  # noqa: E501
        """Payment - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account funding the payment
            amount (str): Amount of money to transfer, with two decimal precision. For example, \"10.00\" would indicate $10.00.
            billpay_counterparty_id (str): ID of the Bill Pay Counterparty receiving the transfer
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            person_id (str): ID of the Person initiating the payment. This ID must be in the array of person_ids of the account funding the payment
        ...
        Keyword Args:
            ...
            deliver_by_date (date): Date by which the payment will be delivered, ISO 8601 format (\"YYYY-MM-DD\"). [optional]  # noqa: E501
            error (str, none_type): [optional]  # noqa: E501
            memo (str): Text printed on the memo line of a direct check payment. [optional]  # noqa: E501
            start_date (date): Date the payment will be sent, ISO 8601 format (\"YYYY-MM-DD\"). [optional]  # noqa: E501
            status (str): One of `pending`, `canceled`, `error`, or `sent`. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, billpay_counterparty_id, person_id, *args, **kwargs):  # noqa: E501
        """Payment - a model defined in OpenAPI
