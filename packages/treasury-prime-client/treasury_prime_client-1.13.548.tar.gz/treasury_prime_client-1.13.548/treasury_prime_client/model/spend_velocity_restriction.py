...
class SpendVelocityRestriction(ModelNormal):
    ...
    def _from_openapi_data(cls, type, version, amount, window, *args, **kwargs):  # noqa: E501
        """SpendVelocityRestriction - a model defined in OpenAPI

        Args:
            type (str): Name of this card controls object
            version (int): Version of configuration (currently: 1) 
            amount (str): Total amount of authorizated transactions to allow within the window
