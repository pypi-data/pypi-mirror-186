...
def lazy_import():
    ...
    globals()['CreateDepositRequestOneOfCard'] = CreateDepositRequestOneOfCard


class CreateDepositRequestOneOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'card': (CreateDepositRequestOneOfCard,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOf - a model defined in OpenAPI

        Args:
            card (CreateDepositRequestOneOfCard):
    ...
    @convert_js_args_to_python_args
    def __init__(self, card, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOf - a model defined in OpenAPI
