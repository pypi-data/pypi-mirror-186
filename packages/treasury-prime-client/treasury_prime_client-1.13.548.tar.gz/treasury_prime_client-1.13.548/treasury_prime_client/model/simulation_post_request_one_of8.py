...
class SimulationPostRequestOneOf8(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'WIRE.PROCESSING_SENT': "wire.processing_sent",
        },
    }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf8 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOf8Simulation):

        Keyword Args:
            type (str): defaults to "wire.processing_sent", must be one of ["wire.processing_sent", ]  # noqa: E501
        ...
        type = kwargs.get('type', "wire.processing_sent")
