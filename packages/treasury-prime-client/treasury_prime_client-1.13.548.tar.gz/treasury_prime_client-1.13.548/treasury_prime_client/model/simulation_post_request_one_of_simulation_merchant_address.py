...
class SimulationPostRequestOneOfSimulationMerchantAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, city, state, postal_code, country, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulationMerchantAddress - a model defined in OpenAPI

        Args:
            city (str): Merchant city
            state (str): Two-digit state abbreviation
            postal_code (str): Five-digit postal code
            country (str): Three-digit country abbreviation
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, state, postal_code, country, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulationMerchantAddress - a model defined in OpenAPI
