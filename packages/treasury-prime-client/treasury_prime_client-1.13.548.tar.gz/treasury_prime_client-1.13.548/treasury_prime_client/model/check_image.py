...
class CheckImage(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'back_file_id': (str,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'front_file_id': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'back_file_id': 'back_file_id',  # noqa: E501
        'created_at': 'created_at',  # noqa: E501
        'front_file_id': 'front_file_id',  # noqa: E501
        'id': 'id',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'back_file_id',  # noqa: E501
        'created_at',  # noqa: E501
        'front_file_id',  # noqa: E501
        'id',  # noqa: E501
        'transaction_number',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, back_file_id, created_at, front_file_id, id, transaction_number, updated_at, *args, **kwargs):  # noqa: E501
        """CheckImage - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account associated with the check
            back_file_id (str): ID of the File containing the image of the back of the check.
            created_at (datetime): Time when the object was created
            front_file_id (str): ID of the File containing the image of the front of the check
            id (str): Unique identifier for object
            transaction_number (str): Transaction number associated with check image
        ...
        Keyword Args:
            ...
            check_date (str): Date the check was written.. [optional]  # noqa: E501
        """
