...
class CreateApplePayDigitalWalletTokenByCardIdRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'certificates': ([str],),  # noqa: E501
            'nonce': (str,),  # noqa: E501
            'nonce_signature': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'nonce_signature': 'nonce_signature',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_id, device_type, provisioning_app_version, certificates, nonce, nonce_signature, *args, **kwargs):  # noqa: E501
        """CreateApplePayDigitalWalletTokenByCardIdRequest - a model defined in OpenAPI

        Args:
            card_id (str): The ID of the card being added to the wallet
            device_type (str): The type of device used to add the card to the wallet
            provisioning_app_version (str): The version of the app used to add the card to the wallet
            certificates ([str]):
            nonce (str): The nonce provided by Apple
            nonce_signature (str): The signature of the nonce provided by Apple
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_id, device_type, provisioning_app_version, certificates, nonce, nonce_signature, *args, **kwargs):  # noqa: E501
        """CreateApplePayDigitalWalletTokenByCardIdRequest - a model defined in OpenAPI
