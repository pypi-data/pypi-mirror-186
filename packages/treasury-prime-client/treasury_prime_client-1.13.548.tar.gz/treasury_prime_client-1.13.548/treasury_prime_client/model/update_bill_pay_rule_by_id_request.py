...
class UpdateBillPayRuleByIdRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateBillPayRuleByIdRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Pass the string `canceled` to cancel a rule.. [optional] if omitted the server will use the default value of "canceled"  # noqa: E501
