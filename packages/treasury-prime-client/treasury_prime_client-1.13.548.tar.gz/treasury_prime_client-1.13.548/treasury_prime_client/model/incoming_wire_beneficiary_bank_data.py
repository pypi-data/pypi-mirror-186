...
class IncomingWireBeneficiaryBankData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, account_type, address, bank_name, routing_number, *args, **kwargs):  # noqa: E501
        """IncomingWireBeneficiaryBankData - a model defined in OpenAPI
        ...
        Args:
            ...
            routing_number (str): Valid 9-digit ABA routing transit number associated with this bank
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, account_type, address, bank_name, routing_number, *args, **kwargs):  # noqa: E501
        """IncomingWireBeneficiaryBankData - a model defined in OpenAPI
