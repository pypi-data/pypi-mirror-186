...
class AchDepositAllOfAch(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_type, last4, routing_number, *args, **kwargs):  # noqa: E501
        """AchDepositAllOfAch - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_type, last4, routing_number, *args, **kwargs):  # noqa: E501
        """AchDepositAllOfAch - a model defined in OpenAPI
