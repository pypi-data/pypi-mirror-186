...
def lazy_import():
    ...
    globals()['CreateDepositRequestOneOf1Ach'] = CreateDepositRequestOneOf1Ach


class CreateDepositRequestOneOf1(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ach': (CreateDepositRequestOneOf1Ach,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, ach, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOf1 - a model defined in OpenAPI

        Args:
            ach (CreateDepositRequestOneOf1Ach):
