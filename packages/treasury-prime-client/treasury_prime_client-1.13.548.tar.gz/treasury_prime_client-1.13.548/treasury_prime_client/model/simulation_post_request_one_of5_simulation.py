...
class SimulationPostRequestOneOf5Simulation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ach_id, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf5Simulation - a model defined in OpenAPI

        Args:
            ach_id (str): ID of the ACH to use as the source for simulated transactions
    ...
    @convert_js_args_to_python_args
    def __init__(self, ach_id, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf5Simulation - a model defined in OpenAPI
