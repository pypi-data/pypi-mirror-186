...
class KycEvaluationAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, object_id, object_type, updated_at, *args, **kwargs):  # noqa: E501
        """KycEvaluationAllOf - a model defined in OpenAPI
