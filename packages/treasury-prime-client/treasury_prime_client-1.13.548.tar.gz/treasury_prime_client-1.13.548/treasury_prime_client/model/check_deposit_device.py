...
class CheckDepositDevice(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, os_name, os_version, *args, **kwargs):  # noqa: E501
        """CheckDepositDevice - a model defined in OpenAPI

        Args:
            os_name (str): Name of the operating system the device is running. One of `android`, `blackberry`, `ios`, `windows`, or `unknown`. 
            os_version (str): Major version number of the operating system the device is running (e.g. \"12\", \"7\", etc.), or the string `unknown`.
    ...
    @convert_js_args_to_python_args
    def __init__(self, os_name, os_version, *args, **kwargs):  # noqa: E501
        """CheckDepositDevice - a model defined in OpenAPI
