...
class CreateDepositRequestOneOfCard(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_number, cvc, expiration_month, expiration_year, zip_code, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOfCard - a model defined in OpenAPI
        ...
        Args:
            ...
            zip_code (str): The zip code of the card
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_number, cvc, expiration_month, expiration_year, zip_code, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOfCard - a model defined in OpenAPI
