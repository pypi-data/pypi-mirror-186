...
class CreateDepositRequestOneOf1Ach(ModelNormal):
    ...
    def _from_openapi_data(cls, account_number, account_type, routing_number, *args, **kwargs):  # noqa: E501
        """CreateDepositRequestOneOf1Ach - a model defined in OpenAPI

        Args:
            account_number (str): The bank account number from which the deposit will be withdrawn
            account_type (str): Either `checking` or `savings`
            routing_number (str): The ABA routing transit number associated with the account
