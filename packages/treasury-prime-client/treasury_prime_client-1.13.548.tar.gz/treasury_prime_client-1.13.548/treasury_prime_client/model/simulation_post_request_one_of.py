...
class SimulationPostRequestOneOf(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'CARD_EVENT.AUTH_CAPTURE': "card_event.auth_capture",
        },
    }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOfSimulation):

        Keyword Args:
            type (str): defaults to "card_event.auth_capture", must be one of ["card_event.auth_capture", ]  # noqa: E501
        ...
        type = kwargs.get('type', "card_event.auth_capture")
