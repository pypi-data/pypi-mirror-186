...
def lazy_import():
    ...
    globals()['CheckDepositDevice'] = CheckDepositDevice


class CheckDeposit(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'back_image_file_id': (str,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'device': (CheckDepositDevice,),  # noqa: E501
            'front_image_file_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'back_image_file_id': 'back_image_file_id',  # noqa: E501
        'created_at': 'created_at',  # noqa: E501
        'device': 'device',  # noqa: E501
        'front_image_file_id': 'front_image_file_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, back_image_file_id, created_at, device, front_image_file_id, person_id, updated_at, *args, **kwargs):  # noqa: E501
        """CheckDeposit - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account receiving the deposit. 
            ...
            back_image_file_id (str): ID of the .jpg File representing an image of the back of the check. Currently we only accept JPG file format for images.
            created_at (datetime): Time when the object was created
            device (CheckDepositDevice):
            front_image_file_id (str): ID of the .jpg File representing an image of the front of the check. Currently we only accept JPG file format for images.
            person_id (str): ID of the Person making the deposit. This ID must be in the array of person_ids of the account receiving the deposit
        ...
        Keyword Args:
            ...
            error (str): Error message describing why a check was declined. [optional]  # noqa: E501
            id (str): Unique identifier for object. [optional]  # noqa: E501
            status (str): One of `pending`, `submitted`, `sent`, or `error`. Indicates the deposit's current status in the check workflow . [optional]  # noqa: E501
        ...
        self.amount = amount
        self.back_image_file_id = back_image_file_id
        self.created_at = created_at
        self.device = device
        self.front_image_file_id = front_image_file_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, back_image_file_id, device, front_image_file_id, person_id, *args, **kwargs):  # noqa: E501
        """CheckDeposit - a model defined in OpenAPI
