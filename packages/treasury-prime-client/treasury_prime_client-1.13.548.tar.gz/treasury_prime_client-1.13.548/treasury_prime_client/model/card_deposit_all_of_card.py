...
class CardDepositAllOfCard(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, last4, *args, **kwargs):  # noqa: E501
        """CardDepositAllOfCard - a model defined in OpenAPI

        Args:
            last4 (str): The last four digits of the account number
    ...
    @convert_js_args_to_python_args
    def __init__(self, last4, *args, **kwargs):  # noqa: E501
        """CardDepositAllOfCard - a model defined in OpenAPI
