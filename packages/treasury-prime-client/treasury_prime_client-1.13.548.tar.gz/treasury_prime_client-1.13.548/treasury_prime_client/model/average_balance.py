...
class AverageBalance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, average_balance, month, *args, **kwargs):  # noqa: E501
        """AverageBalance - a model defined in OpenAPI

        Args:
            average_balance (str): Average Account balance for the month.
            month (str): Month for this average, ISO 8601 format (\"YYYY-MM\").
    ...
    @convert_js_args_to_python_args
    def __init__(self, average_balance, month, *args, **kwargs):  # noqa: E501
        """AverageBalance - a model defined in OpenAPI
