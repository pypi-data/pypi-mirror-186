...
def lazy_import():
    ...
    globals()['CheckRecipientAddress'] = CheckRecipientAddress


class CheckRecipient(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'address': (CheckRecipientAddress,),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, address, name, *args, **kwargs):  # noqa: E501
        """CheckRecipient - a model defined in OpenAPI

        Args:
            address (CheckRecipientAddress):
