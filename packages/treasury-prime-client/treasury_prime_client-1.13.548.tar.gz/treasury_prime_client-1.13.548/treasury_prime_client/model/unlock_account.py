...
class UnlockAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, locked, *args, **kwargs):  # noqa: E501
        """UnlockAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, locked, *args, **kwargs):  # noqa: E501
        """UnlockAccount - a model defined in OpenAPI
