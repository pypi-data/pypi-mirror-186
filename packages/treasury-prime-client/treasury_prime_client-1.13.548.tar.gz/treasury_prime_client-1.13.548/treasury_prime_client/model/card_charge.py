...
def lazy_import():
    ...
    globals()['CardChargeCard'] = CardChargeCard


class CardCharge(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, card, created_at, id, last4, status, updated_at, *args, **kwargs):  # noqa: E501
        """CardCharge - a model defined in OpenAPI
        ...
        Args:
            ...
            status (str): One of `pending`, `succeeded`, `failed`, or `error`. Indicates the current status of the operation
        ...
        Keyword Args:
            ...
            error (str): Error message describing why the card charge or subsequent deposit was unsuccessful. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, card, *args, **kwargs):  # noqa: E501
        """CardCharge - a model defined in OpenAPI
