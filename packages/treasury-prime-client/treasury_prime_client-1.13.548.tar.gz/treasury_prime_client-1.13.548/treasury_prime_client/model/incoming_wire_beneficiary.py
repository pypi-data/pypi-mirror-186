...
def lazy_import():
    ...
    globals()['IncomingWireBeneficiaryBankData'] = IncomingWireBeneficiaryBankData


class IncomingWireBeneficiary(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bank_data': (IncomingWireBeneficiaryBankData,),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, bank_data, name, *args, **kwargs):  # noqa: E501
        """IncomingWireBeneficiary - a model defined in OpenAPI

        Args:
            address ([str]): Unparsed bank address data
            bank_data (IncomingWireBeneficiaryBankData):
            name (str): Name of the intermediary bank
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, bank_data, name, *args, **kwargs):  # noqa: E501
        """IncomingWireBeneficiary - a model defined in OpenAPI
