...
def lazy_import():
    ...
    globals()['BaseDeposit'] = BaseDeposit
    globals()['CardDepositAllOf'] = CardDepositAllOf
    globals()['CardDepositAllOfCard'] = CardDepositAllOfCard


class CardDeposit(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CardDeposit - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name_on_account (str): Name of the owner of the account providing the deposit. For example, for a debit card deposit, this is the name printed on the card
