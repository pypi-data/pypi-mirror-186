...
class SimulationPostRequestOneOf4(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'CARD_EVENT.REFUND': "card_event.refund",
        },
    }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf4 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOfSimulation):

        Keyword Args:
            type (str): defaults to "card_event.refund", must be one of ["card_event.refund", ]  # noqa: E501
        ...
        type = kwargs.get('type', "card_event.refund")
