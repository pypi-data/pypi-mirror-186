...
class Wire(ModelNormal):
    ...
    attribute_map = {
        ...
        'intermediary': 'intermediary',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, counterparty_id, created_at, id, status, updated_at, *args, **kwargs):  # noqa: E501
        """Wire - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account originating the transfer. This account must have an available balance larger than the transfer amount
            ...
            status (str): One of `pending`, `canceled`, `error`, or `sent`
        ...
        Keyword Args:
            ...
            error (str): Error message describing why a wire transfer failed to send. [optional]  # noqa: E501
            instructions (str): Optional instructions for the recipient (maximum of 140 characters). [optional]  # noqa: E501
            intermediary (str): Optional intermediary bank information. If the recipient's bank is unable to receive a wire transfer, they will use an intermediary bank to process the wire. See below for definition. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, counterparty_id, status, *args, **kwargs):  # noqa: E501
        """Wire - a model defined in OpenAPI
