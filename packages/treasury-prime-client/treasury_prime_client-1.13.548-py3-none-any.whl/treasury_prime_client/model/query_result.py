...
class QueryResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'related': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, object_id, object_type, related, updated_at, *args, **kwargs):  # noqa: E501
        """QueryResult - a model defined in OpenAPI

        Args:
            created_at (datetime): Time when the object was created
            object_id (str): ID of the object that was found. 
            object_type (str): Type of the object that was found. 
            related ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Related data (dependent on the object_type).
