...
class CardChargeCard(ModelNormal):
    ...
    validations = {
        ...
        ('expiration_month',): {
            ...
            'min_length': 2,
            'regex': {
                'pattern': r'^[0-1]{1}[0-9]{1}$',  # noqa: E501
            },
        },
        ('expiration_year',): {
            'max_length': 4,
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_number, cvc, expiration_month, expiration_year, name_on_account, postal_code, *args, **kwargs):  # noqa: E501
        """CardChargeCard - a model defined in OpenAPI

        Args:
            card_number (str): The card number
            cvc (str): The three or four digit card verification code
            expiration_month (str): The two digit expiration month of the card.
            expiration_year (str): The four digit expiration year of the card.
            name_on_account (str): Name of the cardholder.
            postal_code (str): The five digit zip code associated with the card's billing address.
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_number, cvc, expiration_month, expiration_year, name_on_account, postal_code, *args, **kwargs):  # noqa: E501
        """CardChargeCard - a model defined in OpenAPI
