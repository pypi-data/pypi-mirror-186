...
class BookTransfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'from_account_id': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'to_account_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'from_account_id': 'from_account_id',  # noqa: E501
        'id': 'id',  # noqa: E501
        'status': 'status',  # noqa: E501
        'to_account_id': 'to_account_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, created_at, from_account_id, id, status, to_account_id, updated_at, *args, **kwargs):  # noqa: E501
        """BookTransfer - a model defined in OpenAPI
        ...
        Args:
            ...
            from_account_id (str): ID of the Account originating the transfer 
            id (str): Unique identifier for object
            status (str): One of `pending`, `canceled`, `sent`, or `error` 
            to_account_id (str): ID of the Account receiving the transfer 
        ...
        Keyword Args:
            ...
            description (str): Timestamp of when the object was created. . [optional]  # noqa: E501
            error (str): Error message describing why a book transfer failed to send. . [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, from_account_id, to_account_id, *args, **kwargs):  # noqa: E501
        """BookTransfer - a model defined in OpenAPI
