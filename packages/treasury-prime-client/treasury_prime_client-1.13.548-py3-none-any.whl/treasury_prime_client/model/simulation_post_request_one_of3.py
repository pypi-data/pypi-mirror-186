...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOfSimulation'] = SimulationPostRequestOneOfSimulation


class SimulationPostRequestOneOf3(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'CARD_EVENT.AUTH_REVERSAL': "card_event.auth_reversal",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'simulation': (SimulationPostRequestOneOfSimulation,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf3 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOfSimulation):

        Keyword Args:
            type (str): defaults to "card_event.auth_reversal", must be one of ["card_event.auth_reversal", ]  # noqa: E501
        ...
        type = kwargs.get('type', "card_event.auth_reversal")
