...
class SimulationPostRequestOneOf8Simulation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, wire_id, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf8Simulation - a model defined in OpenAPI

        Args:
            wire_id (str): ID of the wire to use as the source for simulated transactions
    ...
    @convert_js_args_to_python_args
    def __init__(self, wire_id, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf8Simulation - a model defined in OpenAPI
