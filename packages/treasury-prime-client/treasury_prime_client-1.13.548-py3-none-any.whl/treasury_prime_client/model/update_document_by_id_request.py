...
class UpdateDocumentByIdRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateDocumentByIdRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fields ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): This object holds a set of key-value associations representing the data encoded in the Document. [optional]  # noqa: E501
