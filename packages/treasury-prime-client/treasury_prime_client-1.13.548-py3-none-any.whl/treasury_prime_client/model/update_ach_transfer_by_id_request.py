...
class UpdateAchTransferByIdRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateAchTransferByIdRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Pass the string `canceled` to cancel the ACH transfer. This is only effective if the specified ACH has a status of `pending`.. [optional] if omitted the server will use the default value of "canceled"  # noqa: E501
