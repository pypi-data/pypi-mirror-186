...
def lazy_import():
    ...
    globals()['BillPayCounterpartyAddress'] = BillPayCounterpartyAddress


class BillPayCounterparty(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'address': (BillPayCounterpartyAddress,),  # noqa: E501
            'bill_account_number': (str, none_type,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'bill_account_number': 'bill_account_number',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, created_at, id, updated_at, *args, **kwargs):  # noqa: E501
        """BillPayCounterparty - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account funding payments to the counterparty
        ...
        Keyword Args:
            ...
            address (BillPayCounterpartyAddress): [optional]  # noqa: E501
            bill_account_number (str, none_type): Account number as listed on a merchant bill. [optional]  # noqa: E501
            name (str): Name of the entity receiving payments. [optional]  # noqa: E501
