...
class BaseDeposit(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, created_at, id, name_on_account, updated_at, *args, **kwargs):  # noqa: E501
        """BaseDeposit - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, name_on_account, *args, **kwargs):  # noqa: E501
        """BaseDeposit - a model defined in OpenAPI
