...
class Merchant(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category (str): Category the merchant belongs to (e.g., Utilities).. [optional]  # noqa: E501
            merchant_code (str): A unique, opaque string used to convey the merchant's payment instructions. Always null unless an account number and postal code match has been made with the merchant. [optional]  # noqa: E501
            name (str): Name of the merchant. [optional]  # noqa: E501
            note (str): Additional details on the merchant. [optional]  # noqa: E501
        """
