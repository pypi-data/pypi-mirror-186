...
def lazy_import():
    ...
    globals()['MerchantRestriction'] = MerchantRestriction
    globals()['SpendVelocityRestriction'] = SpendVelocityRestriction
    globals()['WithdrawalVelocityRestriction'] = WithdrawalVelocityRestriction


class CardControlsControlsInner(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CardControlsControlsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Name of this card controls object. [optional]  # noqa: E501
            version (int): Version of configuration (currently: 1) . [optional]  # noqa: E501
            restriction (str): Either allow or disallow, for allowing or disallowing the list of mccs. [optional]  # noqa: E501
            mccs ([str]): An array of four digit numeric strings, representing the merchant categories to allow or disallow. [optional]  # noqa: E501
            amount (str): Total amount of ATM transactions to allow within the window. [optional]  # noqa: E501
            interval (str): Type of interval for calculating total amount of transactions. One of: `rolling` . [optional] if omitted the server will use the default value of "rolling"  # noqa: E501
            window (int): Number of hours for calculating rolling window. Required if `interval` is `rolling`. [optional]  # noqa: E501
        """
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              MerchantRestriction,
              SpendVelocityRestriction,
              WithdrawalVelocityRestriction,
          ],
        }
