...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOf2Simulation'] = SimulationPostRequestOneOf2Simulation


class SimulationPostRequestOneOf2(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'CARD_EVENT.AUTH_REQUEST': "card_event.auth_request",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'simulation': (SimulationPostRequestOneOf2Simulation,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf2 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOf2Simulation):

        Keyword Args:
            type (str): defaults to "card_event.auth_request", must be one of ["card_event.auth_request", ]  # noqa: E501
        ...
        type = kwargs.get('type', "card_event.auth_request")
