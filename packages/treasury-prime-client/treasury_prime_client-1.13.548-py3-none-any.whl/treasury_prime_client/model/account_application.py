...
def lazy_import():
    ...
    globals()['AccountApplicationAllOf'] = AccountApplicationAllOf


class AccountApplication(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'primary_person_application_id': (str,),  # noqa: E501
            'account_id': (str,),  # noqa: E501
            'account_number_reservation_id': (str,),  # noqa: E501
            ...
            'person_applications': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'primary_person_application_id': 'primary_person_application_id',  # noqa: E501
        'account_id': 'account_id',  # noqa: E501
        'account_number_reservation_id': 'account_number_reservation_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AccountApplication - a model defined in OpenAPI

        Keyword Args:
            account_product_id (str): ID of an Account Product object that determines what kind of account is created
            business_application_id (str): ID of the Business Application object for the business applying for the account. Only needed for business accounts
            primary_person_application_id (str): ID of the Person Application object representing the primary person applying for the account
            ...
            account_id (str): ID of the Account object that is created as a result of a successful application. [optional]  # noqa: E501
            account_number_reservation_id (str): Optional ID of an Account Reservation object that allocates an account number. By default the bank generates the account number when a new account is created. [optional]  # noqa: E501
            ...
            deposit_id (str): ID of the Deposit object that defines the initial funding deposit for the new account. [optional]  # noqa: E501
            id (str): Unique identifier for object. [optional]  # noqa: E501
            status (str): stringOne of `unsubmitted`, `submitted`, `processing`, `manual_review`, `rejected`, or `approved`. Indicates the current status of the application as it is evaluated by the bank. [optional]  # noqa: E501
            ...
            person_applications ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Array of Person sub-objects describing persons associated with this account application, including the primary person. Always [] for business accounts.. [optional]  # noqa: E501
        """
