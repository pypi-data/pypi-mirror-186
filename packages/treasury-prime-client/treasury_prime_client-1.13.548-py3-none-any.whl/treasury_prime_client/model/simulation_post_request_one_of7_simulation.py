...
class SimulationPostRequestOneOf7Simulation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'company_description': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'company_description': 'company_description',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, account_type, direction, sec_code, account_number, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf7Simulation - a model defined in OpenAPI

        Args:
            amount (str): Amount of money in dollars to transfer, as a string with two-decimal precision
            account_type (str): The type of the account to send money to, as a string. Should be either `checking` or `savings`
            direction (str): Either `credit` or `debit`
            sec_code (str): One of `ccd`, `ppd`, or `web`
            account_number (str): Bank account number for ACH use (maximum of 17 characters)
        ...
        Keyword Args:
            ...
            company_name (str): The name of the company that originated this ACH. [optional]  # noqa: E501
            company_description (str): Description of the company that originated this ACH. [optional]  # noqa: E501
            company_id (str): 10 digit unique identifier used to identify the originator collecting payments for a debit ACH. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, account_type, direction, sec_code, account_number, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf7Simulation - a model defined in OpenAPI
