...
def lazy_import():
    ...
    globals()['KycEvaluationAllOf'] = KycEvaluationAllOf


class KycEvaluation(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'kyc_product_id': (str,),  # noqa: E501
            'alloy': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'alloy_full': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'middesk': (str,),  # noqa: E501
            'middesk_full': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'kyc_product_id': 'kyc_product_id',  # noqa: E501
        'alloy': 'alloy',  # noqa: E501
        'alloy_full': 'alloy_full',  # noqa: E501
        'middesk': 'middesk',  # noqa: E501
        'middesk_full': 'middesk_full',  # noqa: E501
    }
    ...
    read_only_vars = {
        ...
        'alloy',  # noqa: E501
        'alloy_full',  # noqa: E501
        'middesk',  # noqa: E501
        'middesk_full',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KycEvaluation - a model defined in OpenAPI

        Keyword Args:
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            object_id (str): ID of the object (a person application or business application) for the KYC evaluation
            object_type (str): One of the following: person, business 
            ...
            kyc_product_id (str): ID of the KYC product used to evaluate the object. [optional]  # noqa: E501
            alloy ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Object containing a summary of the Alloy KYC evaluation (if enabled). [optional]  # noqa: E501
            alloy_full ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Object containing the full response from Alloy (if enabled). [optional]  # noqa: E501
            middesk (str): Object containing a summary of the Middesk KYC evaluation (if enabled). [optional]  # noqa: E501
            middesk_full (str): Object containing the full response from Middesk (if enabled). [optional]  # noqa: E501
        """
