...
class CreateGooglePayDigitalWalletTokenByCardIdRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'wallet_account_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'wallet_account_id': 'wallet_account_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_id, device_type, provisioning_app_version, wallet_account_id, device_id, *args, **kwargs):  # noqa: E501
        """CreateGooglePayDigitalWalletTokenByCardIdRequest - a model defined in OpenAPI
        ...
        Args:
            ...
            wallet_account_id (str): The user’s Google wallet account ID
            device_id (str): The user’s Android device ID; the device’s unique identifier
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_id, device_type, provisioning_app_version, wallet_account_id, device_id, *args, **kwargs):  # noqa: E501
        """CreateGooglePayDigitalWalletTokenByCardIdRequest - a model defined in OpenAPI
