...
def lazy_import():
    ...
    globals()['CardControlsControlsInner'] = CardControlsControlsInner


class CardControls(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'controls': ([CardControlsControlsInner],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, controls, *args, **kwargs):  # noqa: E501
        """CardControls - a model defined in OpenAPI

        Args:
            name (str): Name for the card controls
            controls ([CardControlsControlsInner]): An array of control configurations, as outlined below
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, controls, *args, **kwargs):  # noqa: E501
        """CardControls - a model defined in OpenAPI
