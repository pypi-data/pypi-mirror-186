...
class MerchantRestriction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, version, restriction, mccs, *args, **kwargs):  # noqa: E501
        """MerchantRestriction - a model defined in OpenAPI

        Args:
            type (str): Name of this card controls object
            version (int): Version of configuration (currently: 1) 
            restriction (str): Either allow or disallow, for allowing or disallowing the list of mccs
            mccs ([str]): An array of four digit numeric strings, representing the merchant categories to allow or disallow
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, version, restriction, mccs, *args, **kwargs):  # noqa: E501
        """MerchantRestriction - a model defined in OpenAPI
