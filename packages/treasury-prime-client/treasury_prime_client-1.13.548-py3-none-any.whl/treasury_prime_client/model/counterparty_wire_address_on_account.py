...
class CounterpartyWireAddressOnAccount(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (str,),  # noqa: E501
            'street_line_1': (str,),  # noqa: E501
            'street_line_2': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'street_line_1': 'street_line_1',  # noqa: E501
        'street_line_2': 'street_line_2',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, city, postal_code, state, street_line_1, *args, **kwargs):  # noqa: E501
        """CounterpartyWireAddressOnAccount - a model defined in OpenAPI

        Args:
            city (str): City
            postal_code (str): Postal code (5-digit or 5+4 Zip Code for U.S. addresses)
            state (str): U.S. State (two letter abbreviation)
            street_line_1 (str): Street address (first line)
        ...
        Keyword Args:
            ...
            street_line_2 (bool, date, datetime, dict, float, int, list, str, none_type): Street address (second line, if applicable). [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, postal_code, state, street_line_1, *args, **kwargs):  # noqa: E501
        """CounterpartyWireAddressOnAccount - a model defined in OpenAPI
