...
class UpdateBillPayPaymentByIdRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateBillPayPaymentByIdRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Pass the string `canceled` to cancel the Payment. This is only effective if the specified Payment has a status of `pending`.. [optional] if omitted the server will use the default value of "canceled"  # noqa: E501
