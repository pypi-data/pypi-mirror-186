...
class SimulationPostRequestOneOfSimulation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_id, amount, external_id, merchant, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulation - a model defined in OpenAPI
        ...
        Args:
            ...
            external_id (str): The trace_id for the auth request simulation you want to clear, reverse, or refund. This can also be found under the transaction endpoint as the trace_id for thehold transaction related to the auth request or as the trace_id on the card event for the auth request 
            merchant (SimulationPostRequestOneOfSimulationMerchant):
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_id, amount, external_id, merchant, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOfSimulation - a model defined in OpenAPI
