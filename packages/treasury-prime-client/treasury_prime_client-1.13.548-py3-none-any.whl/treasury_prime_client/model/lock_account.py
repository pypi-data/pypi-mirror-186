...
class LockAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, locked, lock, *args, **kwargs):  # noqa: E501
        """LockAccount - a model defined in OpenAPI

        Args:
            locked (bool):
            lock (LockAccountLock):
    ...
    @convert_js_args_to_python_args
    def __init__(self, locked, lock, *args, **kwargs):  # noqa: E501
        """LockAccount - a model defined in OpenAPI
