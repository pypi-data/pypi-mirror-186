...
class KycProduct(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, name, object_type, updated_at, *args, **kwargs):  # noqa: E501
        """KycProduct - a model defined in OpenAPI

        Args:
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            name (str): Name of the KYC product
            object_type (str): The type of application upon which the KYC product can be run. One of the following: `person`, `business` 
