...
def lazy_import():
    ...
    globals()['IncomingWireOriginatorBankData'] = IncomingWireOriginatorBankData


class IncomingWireOriginator(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bank_data': (IncomingWireOriginatorBankData,),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, address, bank_data, name, *args, **kwargs):  # noqa: E501
        """IncomingWireOriginator - a model defined in OpenAPI

        Args:
            address ([str]): Unparsed originator bank address data
            bank_data (IncomingWireOriginatorBankData):
            name (str): Name of the originator
