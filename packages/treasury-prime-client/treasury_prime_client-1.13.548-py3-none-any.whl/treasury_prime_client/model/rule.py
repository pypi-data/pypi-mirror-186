...
class Rule(ModelNormal):
    ...
    allowed_values = {
        ('interval',): {
            ...
            'TWICE_EVERY_MONTH': "twice_every_month",
    ...
    def openapi_types():
        ...
        return {
            ...
            'billpay_counterparty_id': (str,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'interval': (str,),  # noqa: E501
            'person_id': (str,),  # noqa: E501
            'updated_at': (datetime,),  # noqa: E501
            'ends_on': (date,),  # noqa: E501
            'starts_on': (date,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'billpay_counterparty_id': 'billpay_counterparty_id',  # noqa: E501
        'created_at': 'created_at',  # noqa: E501
        'id': 'id',  # noqa: E501
        'interval': 'interval',  # noqa: E501
        'person_id': 'person_id',  # noqa: E501
        'updated_at': 'updated_at',  # noqa: E501
        'ends_on': 'ends_on',  # noqa: E501
        'starts_on': 'starts_on',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, billpay_counterparty_id, created_at, id, interval, person_id, updated_at, *args, **kwargs):  # noqa: E501
        """Rule - a model defined in OpenAPI

        Args:
            account_id (str): ID of the Account funding payments generated by this rule
            amount (str): Amount of money to transfer in each payment, with two decimal precision. For example, \"10.00\" would indicate $10.00
            billpay_counterparty_id (str): ID of the Bill Pay Counterparty receiving payments generated by this rule
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            interval (str): How often Bill Pay Payments are generated. One of `once`, `every_week`, `every_two_weeks`, `every_four_weeks`, `every_month`, `twice_every_month`, `every_two_months`, `every_three_months`, `every_six_months`, or `every_year`
            person_id (str): ID of the Person initiating this rule. This ID must be in the array of person_ids of the account funding the payments
        ...
        Keyword Args:
            ...
            ends_on (date): Date after which Bill Pay Payments are not generated, ISO 8601 format (\"YYYY-MM-DD\").. [optional]  # noqa: E501
            starts_on (date): Date the first generated Bill Pay Payment is scheduled, ISO 8601 format (\"YYYY-MM-DD\"). Default to today's date. [optional]  # noqa: E501
            status (str): Either `active` or `canceled`. [optional]  # noqa: E501
        ...
        self.amount = amount
        self.billpay_counterparty_id = billpay_counterparty_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, billpay_counterparty_id, interval, person_id, *args, **kwargs):  # noqa: E501
        """Rule - a model defined in OpenAPI
