...
class UpdateWireByIdRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateWireByIdRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Pass the string `canceled` to cancel the wire transfer. This is only effective if the specified wire has a status of `pending`.. [optional] if omitted the server will use the default value of "canceled"  # noqa: E501
