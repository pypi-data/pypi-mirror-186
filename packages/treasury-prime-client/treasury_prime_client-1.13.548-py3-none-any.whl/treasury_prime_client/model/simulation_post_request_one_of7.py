...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOf7Simulation'] = SimulationPostRequestOneOf7Simulation


class SimulationPostRequestOneOf7(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'ACH.INCOMING_ACH': "ach.incoming_ach",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'simulation': (SimulationPostRequestOneOf7Simulation,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf7 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOf7Simulation):

        Keyword Args:
            type (str): defaults to "ach.incoming_ach", must be one of ["ach.incoming_ach", ]  # noqa: E501
        ...
        type = kwargs.get('type', "ach.incoming_ach")
