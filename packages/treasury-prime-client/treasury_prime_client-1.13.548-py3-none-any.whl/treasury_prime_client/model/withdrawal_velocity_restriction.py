...
class WithdrawalVelocityRestriction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, version, amount, window, *args, **kwargs):  # noqa: E501
        """WithdrawalVelocityRestriction - a model defined in OpenAPI

        Args:
            type (str): Name of this card controls object
            version (int): Version of configuration (currently: 1) 
            amount (str): Total amount of ATM transactions to allow within the window
            window (int): Number of hours for calculating rolling window. Required if `interval` is `rolling`

        Keyword Args:
            interval (str): Type of interval for calculating total amount of transactions. One of: `rolling` . defaults to "rolling", must be one of ["rolling", ]  # noqa: E501
        ...
        interval = kwargs.get('interval', "rolling")
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, version, amount, window, *args, **kwargs):  # noqa: E501
        """WithdrawalVelocityRestriction - a model defined in OpenAPI
