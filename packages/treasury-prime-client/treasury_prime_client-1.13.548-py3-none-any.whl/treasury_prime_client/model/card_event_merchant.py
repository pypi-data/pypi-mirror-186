...
def lazy_import():
    ...
    globals()['CardEventMerchantAddress'] = CardEventMerchantAddress


class CardEventMerchant(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'address': (CardEventMerchantAddress,),  # noqa: E501
            'mcc': (str,),  # noqa: E501
            'mid': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, mcc, mid, name, *args, **kwargs):  # noqa: E501
        """CardEventMerchant - a model defined in OpenAPI

        Args:
            address (CardEventMerchantAddress):
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, mcc, mid, name, *args, **kwargs):  # noqa: E501
        """CardEventMerchant - a model defined in OpenAPI
