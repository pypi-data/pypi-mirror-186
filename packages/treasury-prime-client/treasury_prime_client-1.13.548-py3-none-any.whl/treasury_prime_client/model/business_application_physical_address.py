...
class BusinessApplicationPhysicalAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, city, postal_code, state, *args, **kwargs):  # noqa: E501
        """BusinessApplicationPhysicalAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            country (str): Two letter ISO country code. [optional]  # noqa: E501
            street_line_1 (str): Street address (first line). [optional]  # noqa: E501
            street_line_2 (str): Street address (second line, if applicable). [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, postal_code, state, *args, **kwargs):  # noqa: E501
        """BusinessApplicationPhysicalAddress - a model defined in OpenAPI
