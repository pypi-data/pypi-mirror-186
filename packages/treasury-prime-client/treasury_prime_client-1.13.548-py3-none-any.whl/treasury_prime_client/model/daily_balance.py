...
class DailyBalance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, date, *args, **kwargs):  # noqa: E501
        """DailyBalance - a model defined in OpenAPI

        Args:
            balance (str):
            date (date): Date for this balance, ISO 8601 format (\"YYYY-MM-DD\"). 
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, date, *args, **kwargs):  # noqa: E501
        """DailyBalance - a model defined in OpenAPI
