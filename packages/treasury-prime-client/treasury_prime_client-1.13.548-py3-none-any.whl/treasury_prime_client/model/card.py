...
def lazy_import():
    ...
    globals()['CardControls'] = CardControls
    globals()['CardFulfillment'] = CardFulfillment
...
class Card(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'card_controls': (CardControls,),  # noqa: E501
            'cvv': (str,),  # noqa: E501
            'expiration': (str,),  # noqa: E501
            'fulfillment': (CardFulfillment,),  # noqa: E501
            'last4': (str,),  # noqa: E501
            'pan': (str,),  # noqa: E501
            'pin': (str,),  # noqa: E501
            'pin_is_set': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'card_controls': 'card_controls',  # noqa: E501
        'cvv': 'cvv',  # noqa: E501
        'expiration': 'expiration',  # noqa: E501
        'fulfillment': 'fulfillment',  # noqa: E501
        'last4': 'last4',  # noqa: E501
        'pan': 'pan',  # noqa: E501
        'pin': 'pin',  # noqa: E501
        'pin_is_set': 'pin_is_set',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, card_product_id, created_at, id, person_id, updated_at, *args, **kwargs):  # noqa: E501
        """Card - a model defined in OpenAPI

        Args:
            account_id (str): The ID of the account that the card should be issued against
            card_product_id (str): The ID of the card product that this card should be issued from
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            person_id (str): The ID of the person representing the cardholder that this card will be issued to
        ...
        Keyword Args:
            ...
            card_controls (CardControls): [optional]  # noqa: E501
            cvv (str): The 3-digit card verification code. Note this field will return null unless the show_cvv parameter is set. [optional]  # noqa: E501
            expiration (str): The card expiration year and month, in MMYY format. [optional]  # noqa: E501
            fulfillment (CardFulfillment): [optional]  # noqa: E501
            last4 (str): [optional]  # noqa: E501
            pan (str): The primary 16-digit card number. Note this field will return null unless the show_pan parameter is set. [optional]  # noqa: E501
            pin (str): This is a write-only field representing the card PIN. Patch this field to set a PIN on behalf of the user. (4 digit number). [optional]  # noqa: E501
            pin_is_set (bool): Reflects whether the user has set a PIN on the card; initially false. [optional]  # noqa: E501
            status (str): One of: `unactivated`, `active`, `suspended`, `terminated`. Patch this field to control the active or inactive state of the card. . [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, card_product_id, person_id, *args, **kwargs):  # noqa: E501
        """Card - a model defined in OpenAPI
