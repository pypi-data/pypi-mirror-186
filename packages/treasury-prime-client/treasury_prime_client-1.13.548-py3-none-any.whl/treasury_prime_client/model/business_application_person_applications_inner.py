...
class BusinessApplicationPersonApplicationsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BusinessApplicationPersonApplicationsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): ID of a Person Application object for a person associated with this business. [optional]  # noqa: E501
            ownership_percentage (int): The person's ownership interest in the business, represented as an integer from 0 to 100. [optional]  # noqa: E501
            roles ([str]): List of applicant's special roles, if any. Valid roles are `signer` and `control_person`.. [optional]  # noqa: E501
            title (str): Title of the person within the business (e.g. \"Owner\", \"CEO\", \"Treasurer\"). [optional]  # noqa: E501
        """
