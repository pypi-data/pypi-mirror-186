...
class AccountProduct(ModelNormal):
    ...
    attribute_map = {
        ...
        'person_kyc_product_id': 'person_kyc_product_id',  # noqa: E501
    }
    ...
    read_only_vars = {
        ...
        'person_kyc_product_id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_type, created_at, id, name, ownership, updated_at, userdata, *args, **kwargs):  # noqa: E501
        """AccountProduct - a model defined in OpenAPI

        Args:
            account_type (str): The type of account, such as `checking` or `savings`
            created_at (datetime): Time when the object was created
            id (str): Unique identifier for object
            name (str): Descriptive name of the Account Product
            ownership (str): Either `business` or `personal`
            updated_at (datetime): Time when the object was last updated
            userdata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}):
        ...
        Keyword Args:
            ...
            person_kyc_product_id (str): ID of the KYC Product used to evaluate person applications. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ownership, userdata, *args, **kwargs):  # noqa: E501
        """AccountProduct - a model defined in OpenAPI
