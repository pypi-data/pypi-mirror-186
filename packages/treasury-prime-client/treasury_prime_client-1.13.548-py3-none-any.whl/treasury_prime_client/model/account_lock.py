...
class AccountLock(ModelNormal):
    ...
    allowed_values = {
        ('reason',): {
            'TRANSACTIONS_BEING_INVESTIGATED_WIRE': "transactions_being_investigated_wire",
            'TRANSACTIONS_BEING_INVESTIGATED_ACH': "transactions_being_investigated_ACH",
            'TRANSACTIONS_BEING_INVESTIGATED_CARD': "transactions_being_investigated_card",
            'TRANSACTIONS_BEING_INVESTIGATED_CHECK_ISSUED': "transactions_being_investigated_check_issued",
            'TRANSACTIONS_BEING_INVESTIGATED_CHECK_DEPOSIT': "transactions_being_investigated_check_deposit",
            'IDENTITY_OF_CUSTOMER_BEING_INVESTIGATED': "identity_of_customer_being_investigated",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'additional_context': (str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, reason, *args, **kwargs):  # noqa: E501
        """AccountLock - a model defined in OpenAPI

        Args:
            reason (str): This should be used as a high level classification as to why the account was locked. When unlocking an account, a reason is not required.
        ...
        Keyword Args:
            ...
            additional_context (str, none_type): Optional text to include additional details for the reason to lock the account. It is recommend to include the payment id such as the ACH id that is under investigation or the application id for the customer. This additional context will be provided to your bank.. [optional]  # noqa: E501
        """
