...
def lazy_import():
    ...
    globals()['SimulationPostRequestOneOf1Simulation'] = SimulationPostRequestOneOf1Simulation


class SimulationPostRequestOneOf1(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'CARD_EVENT.AUTH_CLEAR_REQUEST': "card_event.auth_clear_request",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'simulation': (SimulationPostRequestOneOf1Simulation,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf1 - a model defined in OpenAPI

        Args:
            simulation (SimulationPostRequestOneOf1Simulation):

        Keyword Args:
            type (str): defaults to "card_event.auth_clear_request", must be one of ["card_event.auth_clear_request", ]  # noqa: E501
        ...
        type = kwargs.get('type', "card_event.auth_clear_request")
    ...
    @convert_js_args_to_python_args
    def __init__(self, simulation, *args, **kwargs):  # noqa: E501
        """SimulationPostRequestOneOf1 - a model defined in OpenAPI
