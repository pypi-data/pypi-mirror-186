...
def lazy_import():
    ...
    globals()['GooglePayTokenPushTokenizeRequestData'] = GooglePayTokenPushTokenizeRequestData


class GooglePayToken(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'provisioning_app_version': (str,),  # noqa: E501
            'push_tokenize_request_data': (GooglePayTokenPushTokenizeRequestData,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'provisioning_app_version': 'provisioning_app_version',  # noqa: E501
        'push_tokenize_request_data': 'push_tokenize_request_data',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_id, device_type, provisioning_app_version, push_tokenize_request_data, *args, **kwargs):  # noqa: E501
        """GooglePayToken - a model defined in OpenAPI

        Args:
            card_id (str): The ID of the card associated with this Google Pay token
            device_type (str): The type of device that generated this token
            provisioning_app_version (str): Version of the application making the provisioning request
            push_tokenize_request_data (GooglePayTokenPushTokenizeRequestData):
        ...
        self.provisioning_app_version = provisioning_app_version
        self.push_tokenize_request_data = push_tokenize_request_data
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_id, device_type, provisioning_app_version, push_tokenize_request_data, *args, **kwargs):  # noqa: E501
        """GooglePayToken - a model defined in OpenAPI
