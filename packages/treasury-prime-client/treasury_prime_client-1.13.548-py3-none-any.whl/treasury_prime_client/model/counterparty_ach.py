...
class CounterpartyAch(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, account_type, routing_number, *args, **kwargs):  # noqa: E501
        """CounterpartyAch - a model defined in OpenAPI

        Args:
            account_number (str): Bank account number for ACH use (maximum of 17 characters)
            account_type (str): Either checking orsavings. 
            routing_number (str): Valid 9-digit ABA routing transit number associated with the account. See the Routing Number endpoint for additional information
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, account_type, routing_number, *args, **kwargs):  # noqa: E501
        """CounterpartyAch - a model defined in OpenAPI
