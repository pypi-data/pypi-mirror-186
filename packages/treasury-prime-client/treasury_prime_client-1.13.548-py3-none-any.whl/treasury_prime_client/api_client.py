...
from treasury_prime_client import rest
from treasury_prime_client.configuration import Configuration
from treasury_prime_client.exceptions import ApiTypeError, ApiValueError, ApiException
from treasury_prime_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ACHApi()
        api_instance.create_ach_transfer  # this is an instance of the class Endpoint
        api_instance.create_ach_transfer()  # this invokes api_instance.create_ach_transfer.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_ach_transfer.callable or self.callable in this class
