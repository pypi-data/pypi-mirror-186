...
class RoutingNumberApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_routing_number_endpoint = _Endpoint(
            settings={
                'response_type': (RoutingNumber,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/routing_number/{routing_number}',
                'operation_id': 'get_routing_number',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_routing_number(
        ...
        **kwargs
        ...
        """Retrieve a Routing Number  # noqa: E501

        Retrieves the details of a routing number.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_routing_number(routing_number, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['routing_number'] = \
            routing_number
        return self.get_routing_number_endpoint.call_with_http_info(**kwargs)
