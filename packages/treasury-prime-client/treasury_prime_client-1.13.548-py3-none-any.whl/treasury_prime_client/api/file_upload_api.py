...
class FileUploadApi(object):
    ...
    def create_file(
        ...
        **kwargs
        ...
        Creates and uploads new File.  # noqa: E501
    ...
    def get_file_by_id(
        ...
        **kwargs
        ...
        Retrieves an uploaded file by id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_file_by_id(file_id, async_req=True)
        >>> result = thread.get()
