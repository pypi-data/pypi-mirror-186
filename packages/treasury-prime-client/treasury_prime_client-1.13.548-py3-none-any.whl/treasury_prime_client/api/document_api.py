...
class DocumentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_documents_endpoint = _Endpoint(
            settings={
                'response_type': (GetAllDocuments200Response,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/document',
        ...
        self.get_document_by_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/document/{document_id}',
        ...
        self.update_document_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (Document,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/document/{document_id}',
                'operation_id': 'update_document_by_id',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'document_id': 'path',
                    'update_document_by_id_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_document(
        ...
        **kwargs
        ...
        To create a Document that includes a File, first use the /file endpoint to create a File and upload the contents. Then create the Document using the ID of the File you wish to attach.  # noqa: E501
    ...
    def get_all_documents(
        ...
        **kwargs
        ...
        Returns a list of all existing Documents that have been created, or an empty list if none are available.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_documents(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_all_documents_endpoint.call_with_http_info(**kwargs)
    ...
    def get_document_by_id(
        ...
        **kwargs
        ...
        Retrieves the details of an existing document. Pass a unique ID from a Document creation request, or the Document list.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_document_by_id(document_id, async_req=True)
        >>> result = thread.get()
    ...
    def update_document_by_id(
        ...
        **kwargs
        ...
        Updates the specified Document by setting the values of the passed parameters. Any parameters not provided will be left unchanged.  The file_id parameter is not allowed to be changed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_document_by_id(document_id, update_document_by_id_request, async_req=True)
        >>> result = thread.get()

        Args:
            document_id (str):
            update_document_by_id_request (UpdateDocumentByIdRequest):
        ...
        kwargs['document_id'] = \
            document_id
        kwargs['update_document_by_id_request'] = \
            update_document_by_id_request
        return self.update_document_by_id_endpoint.call_with_http_info(**kwargs)
