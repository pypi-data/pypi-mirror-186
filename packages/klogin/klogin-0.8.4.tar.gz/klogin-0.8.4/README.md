...
`cp dist/klogin /usr/local/bin/`


```
cd existing_repo
git remote add origin https://gitlab.com/wuxi-nextcode/klogin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/wuxi-nextcode/klogin/-/settings/integrations)
