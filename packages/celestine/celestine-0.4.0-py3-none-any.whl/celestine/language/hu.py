...
ARGUMENT_APPLICATION_DESCRIPTION = "A program értékei itt vannak. Yay."
ARGUMENT_APPLICATION_HELP = "Válassza ki a futtatni kívánt alkalmazást."
...
ARGUMENT_HELP_HELP = "Ez a súgóképernyő jelenik meg."
ARGUMENT_INFORMATION_DESCRIPTION = "\
Ezek bevonásával befejeződik a program az információk megjelenítéséhez."
...
DEMO_ONE_PAST = "Ugrás az oldal főoldalára."
DEMO_ONE_TITLE = "Első oldal."
DEMO_TWO_NEXT = "Ugrás az oldal főoldalára."
...
TRANSLATOR_SESSION_REGION = "Az a régió, \
ahol az erőforrást létrehozták."
