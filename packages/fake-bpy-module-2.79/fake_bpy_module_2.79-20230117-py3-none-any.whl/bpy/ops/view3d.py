...
def enable_manipulator(override_context: typing.
                       ...
                       undo: typing.Optional[bool] = None,
                       *,
                       translate: typing.Union[bool, typing.Any] = False,
                       rotate: typing.Union[bool, typing.Any] = False,
    ...
    :type translate: typing.Union[bool, typing.Any]
...
def layers(override_context: typing.Union[typing.
           ...
           *,
           ...
           toggle: typing.Union[bool, typing.Any] = True):
...
def manipulator(
        ...
        *,
        constraint_axis: typing.Union[typing.List[bool], typing.Any] = (False,
                                                                        False,
                                                                        False),
        constraint_orientation: typing.Union[str, int, typing.Any] = 'GLOBAL',
        release_confirm: typing.Union[bool, typing.Any] = False,
        use_accurate: typing.Union[bool, typing.Any] = False,
        use_planar_constraint: typing.Union[bool, typing.Any] = False):
    ...
    :type constraint_orientation: typing.Union[str, int, typing.Any]
    ...
    :type use_planar_constraint: typing.Union[bool, typing.Any]
    '''
...
def render_border(override_context: typing.
                  ...
                  *,
                  ...
                  ymin: typing.Optional[typing.Any] = 0,
                  ymax: typing.Optional[typing.Any] = 0,
                  camera_only: typing.Union[bool, typing.Any] = False):
    ...
    :type camera_only: typing.Union[bool, typing.Any]
    '''
