...
def area_join(override_context: typing.Union[typing.
              ...
              undo: typing.Optional[bool] = None,
              *,
              min_x: typing.Optional[typing.Any] = -100,
              min_y: typing.Optional[typing.Any] = -100,
              max_x: typing.Optional[typing.Any] = -100,
              max_y: typing.Optional[typing.Any] = -100):
    ...
    :type undo: typing.Optional[bool]
    :param min_x: X 1
    :type min_x: typing.Optional[typing.Any]
    :param min_y: Y 1
    :type min_y: typing.Optional[typing.Any]
    :param max_x: X 2
    :type max_x: typing.Optional[typing.Any]
    :param max_y: Y 2
    :type max_y: typing.Optional[typing.Any]
    '''
...
def area_split(override_context: typing.
               ...
               *,
               ...
               mouse_x: typing.Optional[typing.Any] = -100,
               mouse_y: typing.Optional[typing.Any] = -100):
...
def screencast(override_context: typing.
               ...
               *,
               ...
               full: typing.Union[bool, typing.Any] = True):
    ...
    :type full: typing.Union[bool, typing.Any]
    '''
