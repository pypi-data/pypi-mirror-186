...
class EmbedVideo:
    ...
    def __repr__(self) -> str:
        return f'EmbedVideo{self.site_name}(title={self.title}, time={self.time}, url={self.url}, thumbnail={self.thumbnail}, time_published={self.time_published},len_videos_sugestions={self.len_videos_sugestions} , videos_sugestions={self.videos_sugestions})'
