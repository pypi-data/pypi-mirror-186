...
class DataCloudflareZone(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/zone#account_id DataCloudflareZone#account_id}
        ...
        :param name: Must provide only one of ``zone_id``, ``name``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/zone#name DataCloudflareZone#name}
        :param zone_id: The zone identifier to target for the resource. Must provide only one of ``zone_id``, ``name``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/zone#zone_id DataCloudflareZone#zone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
