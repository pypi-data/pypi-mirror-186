...
class TfServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TransferTransformStamped = channel.unary_unary(
                '/seerep.TfService/TransferTransformStamped',
        ...
        self.GetFrames = channel.unary_unary(
                ...
                response_deserializer=frame__infos__pb2.FrameInfos.FromString,
                )
...
def add_TfServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFrames': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=frame__infos__pb2.FrameInfos.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'seerep.TfService', rpc_method_handlers)
...
class TfService(object):
    ...
    def TransferTransformStamped(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/seerep.TfService/TransferTransformStamped',
    ...
    def GetFrames(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/seerep.TfService/GetFrames',
            frame__query__pb2.FrameQuery.SerializeToString,
            frame__infos__pb2.FrameInfos.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTransformStamped(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/seerep.TfService/GetTransformStamped',
