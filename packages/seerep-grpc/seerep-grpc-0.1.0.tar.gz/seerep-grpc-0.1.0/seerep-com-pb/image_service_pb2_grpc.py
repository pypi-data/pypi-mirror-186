...
class ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TransferImage = channel.unary_unary(
                '/seerep.ImageService/TransferImage',
...
def add_ImageServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'seerep.ImageService', rpc_method_handlers)
...
class ImageService(object):
    ...
    def GetImage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/seerep.ImageService/GetImage',
    ...
    def TransferImage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/seerep.ImageService/TransferImage',
