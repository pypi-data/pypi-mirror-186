# perllib module for pythonizer, generated by makelib.py on Wed Jan 18 07:24:56 2023
#
...
LIST_SEPARATOR = ' '
TRACEBACK = 0
_PYTHONIZER_KEYWORDS = {'hash','yield','classmethod','functools','stat','frozenset','format','input','anext','if','codecs','tm_py','enumerate','id','else','itertools','random','finally','global','calendar','float','staticmethod','None','setattr','builtins','except','rfind','oct','memoryview','complex','set','filter','lambda','bytearray','io','True','atexit','upper','from','is','get','tempfile','locals','types','min','bytes','len','in','def','getattr','find','Array','globals','max','try','dir','insert','return','struct','getopt','warnings','divmod','range','fileinput','perllib','issubclass','list','glob','extend','map','while','copy','elif','rstrip','help','subprocess','iter','signal','raise','eval','ArrayHash','pop','dict','dataclasses','next','as','tuple','casefold','collections.abc','for','type','vars','hex','delattr','breakpoint','bool','async','object','fcntl','ord','abs','re','aiter','pass','keys','assert','pow','open','await','chr','sum','values','sorted','import','hasattr','Hash','del','isinstance','any','os','continue','exec','compile','with','pdb','print','wantarray','update','not','math','nonlocal','repr','zip','argparse','reversed','break','property','slice','or','all','inspect','int','and','super','False','callable','sys','str','class','traceback','close','lower','ascii','bin','round'}
OUTPUT_RECORD_SEPARATOR = ''
OUTPUT_AUTOFLUSH = 0
INPUT_LAYERS = ''
_DUP_MAP = dict(STDIN=0, STDOUT=1, STDERR=2)
_TIE_MAP = {'DESTROY': '__del__','UNTIE': '__untie__','CLEAR': 'clear','SCALAR': '__len__','EXISTS': '__contains__','FETCH': '__getitem__','DELETE': '__delitem__','PUSH': 'append','FETCHSIZE': '__len__','STORE': '__setitem__'}
INPUT_LINE_NUMBER = 0
OUTPUT_LAYERS = ''
