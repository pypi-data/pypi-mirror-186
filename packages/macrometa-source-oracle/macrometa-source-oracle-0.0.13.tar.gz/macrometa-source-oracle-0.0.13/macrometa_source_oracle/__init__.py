...
class OracleSourceConnector(C8Connector):
    ...
    def logo(self) -> str:
        ...
        return "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAHgAAAAQCAMAAADqHUvXAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXN" \
               "SR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAACBUExURQAAADBAQEBAQDg4QDg4SDU1RTU6RTg4RDg4SDg8RDY5QzY5RjY9QzY9Rjk5" \
               "Rjk9Rjg7Rjg6RTc5RTc5RDk5Rzk7RDk7Rzg6Rjg6Rjg8Rjc7Rzk7Rjk6RTk8RTg7RTg7Rzg7Rjc6Rjc8Rjg7RTc7Rjk7Rjg6Rjg7R" \
               "jc7Rjk7Rjg7Rq/as6EAAAAqdFJOUwAQECAgMDBAQEBQUFBQUFBfYG9wcHBwf4CAj4+QkJ+foK+vv8/P39/v71ZfJ6cAAAIESURBVD" \
               "jLhZXJltowEEWfbTXECQlRkx6Y2k0UbPn+/wdmIQtLMglvZdVR1RU1IUnS+ugSHRtJ0pPLZJXozbkmOWb+l7py7qBS2Z3vkqT6QqG" \
               "ulrQujMOMegaGOp7qY3bvVQZcgW1cFirYeoD+Jj9FXYOfrSTBGg/wHrm5/1V3wE1PGq2VJHXAuU5utT04aQ3dbDQ9tNN3Bw5Y3U5+" \
               "n/rfAfdwbcvcA/vC5qAtwNrBKXxZGMw5Bl/PT/gn2MK1LovewbW0GU9Xgm/Hpgerqodfk3/57gXYgVl0mwe7MDqGEtxNIHVwkdTC2" \
               "Ej6swy6AMP4keotGGkX4HcI4Kd10I8jE+Br/HAhPIx6ADbl1LTTL/62AJ8YA9j08/V97OF9rAdbycMjcFVOa8z/aQHucVOqb2T/Gl" \
               "ZHnELpBcY6NOKDVHvGJlEdszo2hecz2Fjj6gL8tptwuwHMeX78Qe/LbbEAn2J/ZHnw2VKSpJ8wmLm59sDbPJBnVUn+28rDR/1/sPH" \
               "3yBuAbmejdg7YpgtkDxxuiTbSaurOCwz1BhiOdtbKwGBT1S+A2yWWWKtC3irbXBa4NiHRthjQg6zPd7opu3gIb6foU8l85lhnlIO1" \
               "6mFo5PLRllqgLfxtVgqm6TOXxZ+EJNXtZs7UVLDK2i9zlay128paWyyLTbiU+G8lmU2a6O2CYaS/Qc18LkTDh5gAAAAASUVORK5CY" \
               "II="
    ...
    def validate(self, integration: dict) -> None:
        ...
        """
        config, filter_schemas = self.get_config(integration)
        do_discovery(config, filter_schemas)

    def schemas(self, integration: dict) -> list[C8Schema]:
        """Get supported schemas using the given configurations."""
        config, filter_schemas = self.get_config(integration)
        catalog = do_discovery(config, filter_schemas)
        results = []
    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty('pdb_name', 'Pluggable Database Name', ConfigAttributeType.STRING, True, False,
            ...
            ConfigProperty('scn_window_size', 'SCN Window Size', ConfigAttributeType.INT, False, False,
                           description='Oracle SCN window size for logminer replication.',
    ...
    def get_config(integration: dict):
        try:
            config = {
                ...
                'pdb_name': integration['pdb_name'],
                'multitenant': integration['multitenant'],
            }

            filter_schemas_prop = integration['filter_schemas']
            filter_schemas = []
            if filter_schemas_prop:
                filter_schemas = filter_schemas_prop.split(',')
            return config, filter_schemas
