...
class Trace:
    ...
    def increasing(self):
        ...
        A strictly increase trace is suitable to use as the domain of a
        dataset.
    ...
    def __abs__(self):
        ...
        return Trace(abs(x) for x in self)
    ...
    def __trunc__(self):
        ...
        return Trace(map(mth.trunc, self))
    ...
    def __floor__(self):
        ...
        return Trace(map(mth.floor, self))
    ...
    def __ceil__(self):
        ...
        return Trace(map(mth.ceil, self))
    ...
    @staticmethod
    def div(a, b, inf = float('inf'), nan = float('nan')):
        if b == 0:
            if a > 0:
                return inf
            elif a < 0:
