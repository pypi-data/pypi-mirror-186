...
class SwerveDrivetrain(Subsystem):
    ...
    def set_robot_centric(self, vel: (meters_per_second, meters_per_second), angular_vel: radians_per_second):
        ...
        self.odometry.update(Rotation2d(self.gyro.get_robot_heading()), *self.swerve_positions)
        self.odometry_estimator.update(Rotation2d(self.gyro.get_robot_heading()), *self.swerve_positions)
