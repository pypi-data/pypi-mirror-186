...
API_MODELS = Union[
    AWS, Azure, CheckPointApiKey, CheckPointUserAuth, CiscoAPIC, CiscoFMC, ForcePoint, JuniperMist, Merakiv1, NSXT,
    Prisma, RuckusVirtualSmartZone, SilverPeak, Versa, Viptela
]
