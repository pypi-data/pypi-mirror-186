...
__all__ = ( 'EKOX', 'EKON', 'STACK', 'EKO', 'TYPE', 'EKOI', 'EKOT', 'EKOH', 'EKOF', 'test', 'Bool', 'ntimes', 'LINE', 'resizeImage', 'count_parameters', 'parse_args', 'Counter', 'ENV', 'print_nothing', 'print_everything', 'noeko', 'NS')
...
def print1(x, color=False, noeko=False) :
    ...
    if doeko  and not noeko and fn not in noeko_modules:
