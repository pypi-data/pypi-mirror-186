...
def interactive_add(override_context: typing.
                    ...
                    *,
                    ...
                    plane_axis: typing.Optional[typing.Any] = 'Z',
                    plane_depth: typing.Optional[typing.Any] = 'SURFACE',
                    plane_origin: typing.Optional[typing.Any] = 'BASE',
    ...
    :type plane_axis: typing.Optional[typing.Any]
    ...
    :type plane_origin: typing.Optional[typing.Any]
