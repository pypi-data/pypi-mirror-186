...
_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_metadata', full_name='tensorboard.Event.source_metadata', index=9,
...
_SOURCEMETADATA = _descriptor.Descriptor(
  name='SourceMetadata',
  full_name='tensorboard.SourceMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='writer', full_name='tensorboard.SourceMetadata.writer', index=0,
