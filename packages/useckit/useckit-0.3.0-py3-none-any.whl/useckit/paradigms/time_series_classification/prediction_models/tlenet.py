...
# Adopted by Jonathan Liebers for 'useckit'.
# Please cite:
"""
...
class dl4tsc_tlenet(TSCBasePredictionModel):
    ...
    def __init__(self, verbose, nb_epochs=None, output_dir: str = "TLENET_model_out"):
    ...
    def fit(self, dataset: Dataset, *args, **kwargs):
        ...
        model.save(os.path.join(self.output_dir, 'last_model.hdf5'))

        model = keras.models.load_model(os.path.join(self.output_dir, 'best_model.hdf5'))
    ...
    def predict(self, x_test, y_true, x_train, y_train, y_test, return_df_metrics=True):
        ...
        model_path = os.path.join(self.output_dir, 'best_model.hdf5')
