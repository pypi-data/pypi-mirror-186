...
class RdsApi:
    ...
    def copy_db_snapshot(
        ...
        CAZ.
        :param copy_option_group: A value that indicates whether to copy the DB option group associated
        with the source DB snapshot to the target Amazon Web Services account
        and associate with the target DB snapshot.
        :param source_region: The ID of the region that contains the snapshot to be copied.
    ...
    def create_db_cluster(
        ...
        :param manage_master_user_password: A value that indicates whether to manage the master user password with
    ...
    def create_db_instance(
        ...
        automatically generated and managed in Amazon Web Services Secrets
        Manager.
        :param ca_certificate_identifier: Specifies the CA certificate identifier to use for the DB instance’s
        server certificate.
    ...
    def modify_db_cluster(
        ...
        :param manage_master_user_password: A value that indicates whether to manage the master user password with
        Amazon Web Services Secrets Manager.
        :param rotate_master_user_password: A value that indicates whether to rotate the secret managed by Amazon
