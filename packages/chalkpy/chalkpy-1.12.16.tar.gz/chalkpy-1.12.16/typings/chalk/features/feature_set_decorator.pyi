...
from tests.client.test_client_protocol import User as __stubgen_tests_client_test__client__protocol_User
...
class PlaidAccountMetaclass(FeaturesMeta):
    ...
    @property
    def user(self) -> Type[__stubgen_tests_client_test__client__protocol_User]: ...
...
class PlaidAccount(Features, metaclass=PlaidAccountMetaclass):
    def __init__(
        self,
        user_id: str = ...,
        user: __stubgen_tests_client_test__client__protocol_User = ...,
        bank_name: str = ...,
        __chalk_observed_at__: __stubgen_datetime_datetime = ...,
    ):
        self.user_id: str
        self.user: __stubgen_tests_client_test__client__protocol_User
        self.bank_name: str
        self.__chalk_observed_at__: __stubgen_datetime_datetime
