...
class Repository(
    ...
    def __init__(
        ...
        *,
        ...
        :param allow_update_branch: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/repository#allow_update_branch Repository#allow_update_branch}.
        ...
        :param has_discussions: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/repository#has_discussions Repository#has_discussions}.
    ...
    def put_security_and_analysis(
        self,
        *,
        advanced_security: typing.Union["RepositorySecurityAndAnalysisAdvancedSecurity", typing.Dict[builtins.str, typing.Any]],
        secret_scanning: typing.Union["RepositorySecurityAndAnalysisSecretScanning", typing.Dict[builtins.str, typing.Any]],
        secret_scanning_push_protection: typing.Union["RepositorySecurityAndAnalysisSecretScanningPushProtection", typing.Dict[builtins.str, typing.Any]],
    ) -> None:
        '''
    ...
    def put_template(
        ...
        *,
        ...
        :param include_all_branches: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/repository#include_all_branches Repository#include_all_branches}.
        '''
...
class RepositorySecurityAndAnalysis:
    ...
    @builtins.property
    def advanced_security(self) -> "RepositorySecurityAndAnalysisAdvancedSecurity":
        ...
        assert result is not None, "Required property 'advanced_security' is missing"
        return typing.cast("RepositorySecurityAndAnalysisAdvancedSecurity", result)

    @builtins.property
    def secret_scanning(self) -> "RepositorySecurityAndAnalysisSecretScanning":
        ...
        assert result is not None, "Required property 'secret_scanning' is missing"
        return typing.cast("RepositorySecurityAndAnalysisSecretScanning", result)
    ...
    def secret_scanning_push_protection(
        ...
        assert result is not None, "Required property 'secret_scanning_push_protection' is missing"
        return typing.cast("RepositorySecurityAndAnalysisSecretScanningPushProtection", result)
...
class RepositorySecurityAndAnalysisAdvancedSecurity:
    def __init__(self, *, status: builtins.str) -> None:
        '''
        :param status: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/repository#status Repository#status}.
        '''
        if __debug__:
