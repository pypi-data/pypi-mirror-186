...
class RequestInfo:
    def __init__(self, param_dict):
        # In V2 Testing land: this probably means you forgot to send the mandatory fields in your request body.
        # Even get()'s and Deletes can require some fields.
        if not hasattr(param_dict, "get"):
            raise AttributeError("Attempted to initialize RequestInfo with non-mappable type.")
