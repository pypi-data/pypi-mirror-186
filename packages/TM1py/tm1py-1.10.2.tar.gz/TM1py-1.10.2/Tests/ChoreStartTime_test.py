...
class TestChoreStartTime(unittest.TestCase):
    ...
    def test_start_time_string_with_positive_tz(self):
        ...
        self.assertEqual(chore_start_time.start_time_string, "2020-11-26T10:01:01+02:00")
    ...
    def test_start_time_string_with_negative_tz(self):
        ...
        self.assertEqual(chore_start_time.start_time_string, "2020-11-26T10:01:01-01:00")
