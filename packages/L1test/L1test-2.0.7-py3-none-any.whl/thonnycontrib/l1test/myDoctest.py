    ...
    def _check_prompt_blank(self, lines, indent, name, lineno):
        ...
        for i, line in enumerate(lines):
            if len(line) >= indent+4 and line[indent+3] != ' ':
                ...
                raise ManqueUnEspace(line[indent:])
...
class ManqueUnEspace(ValueError):
    def __init__(self, invite_sans_blanc):
        super().__init__('Il manque un caractère espace\n après l\'invite : ' + invite_sans_blanc)
