...
class Issue(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error_details': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def __init__(self, error_description, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (object): [optional]  # noqa: E501
            ...
            error_details ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
