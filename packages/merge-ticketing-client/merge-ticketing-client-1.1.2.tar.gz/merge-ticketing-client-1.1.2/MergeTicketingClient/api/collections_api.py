...
class CollectionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.collections_list = _Endpoint(
            settings={
                'response_type': (PaginatedCollectionList,),
                'auth': [
                    'tokenAuth'
                ],
            ...
            callable=__collections_list
        )

        def __collections_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.collections_retrieve = _Endpoint(
            settings={
                'response_type': (Collection,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/collections/{id}',
            ...
            api_client=api_client,
            callable=__collections_retrieve
        )
