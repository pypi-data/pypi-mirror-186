...
#DEFAULT_SWEEPMODE = SenseX1000.SweepMode.ALTERNATING.name  # Alternating up/down ramping, set NSEEPS to >2
...
class FastPlotWindow(QtWidgets.QWidget):
    ...
    def _update(self):
        ...
        if self.args.plothistory:
            ...
            self.history_curve.setData(np.arange(self.args.historydepth), self.peak_history)
