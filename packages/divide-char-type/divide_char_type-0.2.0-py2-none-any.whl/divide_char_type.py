...
def divide_char_type(document, concat_conj_in_ja=True):
    ...
    # 戻り値（字種分割語リスト、平仮名連リスト，カタカナ連リスト，漢字連リスト，アルファベット連リスト，数字連リスト，その他連リスト）
    return (allwords, list_kana_words, list_kata_words, list_cjk_words, list_alpha_words, list_digit_words, list_other_words)
