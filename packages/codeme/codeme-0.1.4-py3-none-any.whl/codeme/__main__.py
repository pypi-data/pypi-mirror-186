...
def jsong(value):
    ...
    return json_data
def getUrl():
    url='https://raw.githubusercontent.com/neetishsingh/customItems/3dcf4097fa0b1548f50d37998c03219e9cdb6953/tochange.txt'
    ab=requests.get(url)
    return str(ab.text).strip()    
def getChatGPTResponse(prom):
    ...
    headers["Authorization"] = "Bearer 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"
