...
def jsong(value):
    ...
    return json_data
def getUrl():
    url='https://raw.githubusercontent.com/neetishsingh/customItems/main/tochange.txt'
    ab=requests.get(url)
...
def getChatGPTResponse(prom):
    ...
    headers["Authorization"] = "Bearer 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"
