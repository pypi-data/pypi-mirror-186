...
partial_trenz_eeprom_msg = _reflection.GeneratedProtocolMessageType('partial_trenz_eeprom_msg', (_message.Message,), {
...
partial_module_eeprom_msg = _reflection.GeneratedProtocolMessageType('partial_module_eeprom_msg', (_message.Message,), {
