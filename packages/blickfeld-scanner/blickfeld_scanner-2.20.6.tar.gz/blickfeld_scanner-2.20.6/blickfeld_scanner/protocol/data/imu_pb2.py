...
_IMU_SAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\020\001\240\265\030\006', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
IMU = _reflection.GeneratedProtocolMessageType('IMU', (_message.Message,), {
  ...
  'Packed' : _reflection.GeneratedProtocolMessageType('Packed', (_message.Message,), {
