...
_ERROR_UNKNOWN = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035HThe server threw an unknown generic error. Description: {description:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NOTIMPLEMENTED = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=b"No detailed reason available.".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  ...
  serialized_options=b'\202\246\035\254\001The request is not implemented on the server side. Check the versions of the client or firmware software. The changelog might provide more information.\n\tReason: {reason:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_EMPTY = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035!The server sent an empty message.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_SERVERIMPLEMENTATION = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035?The implementation on the server failed to process the request.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_INVALIDREQUEST = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035CThe sent request did not pass the validation: {validation_error:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_CONNECTIONCLOSED = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035(The connection was closed by the server.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_OUTDATEDSERVERPROTOCOL = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035YThe protocol of the client is too new. Please update the device to {required_version:%u}.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_OUTDATEDCLIENTPROTOCOL = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035bThe protocol of the server is too new. Please update the client software to {required_version:%u}.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_SCANNERBUSY = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035MThe device is currently busy with another operation. Cancel it and try again.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_WRONGOPERATIONMODE = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035jThe device is set to a different operation mode.Perhaps it is currently being used by another application.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NOTALLOWED = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\'The requested operation is not allowed.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_HARDWAREERROR = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\224\001The device is in an error state and cannot be operated. Attempt to power cycle the device or use diagnostic software to read-out the hardware state.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_SYSTEMSTOP = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\233\001The device stopped unexpectedly and can no longer be operated. Attempt to power cycle the device or use diagnostic software to read-out the hardware state.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NOTFOUND = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035IThe requested data is not available. Please check the request parameters.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_TIMESYNCFAILED = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035dThe time synchronization failed. The NTP daemon failed or timed out. Log output:\n{ntp_daemon_log:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NODEVICEDISCOVERED = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\253\001No device has been discovered. Check the network connection and power supply of the device. The \'discover\' requests may have been blocked by a local or a network firewall.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_UNKNOWNERRORCODE = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035#Unknown Error Code: {error_code:%u}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NOTINRANGE = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\261\001The requested {parameter:%s} ({requested:%.2f}{unit:%s}) is not within the valid range. The {parameter:%s} has to be in the interval of {minimum:%.2f} < {maximum:%.2f}{unit:%s}.',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_NOTSUPPORTED = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\243\001The action is not supported by the current client or server API. Check the versions of the client or firmware software and read the changelog.\n\tReason: {reason:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR_CONNECTIONABORT = _descriptor.Descriptor(
  name='ConnectionAbort',
  full_name='blickfeld.protocol.Error.ConnectionAbort',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='details', full_name='blickfeld.protocol.Error.ConnectionAbort.details', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  serialized_options=b'\202\246\035\215\001During reading, the connection to the device got aborted. Check the network connectivity or power state of the device.\n\tDetails: {details:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_ERROR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connection_abort', full_name='blickfeld.protocol.Error.connection_abort', index=19,
...
_ERROR_CONNECTIONABORT.containing_type = _ERROR
...
_ERROR.fields_by_name['connection_abort'].message_type = _ERROR_CONNECTIONABORT
...
_ERROR.oneofs_by_name['error'].fields.append(
  _ERROR.fields_by_name['connection_abort'])
_ERROR.fields_by_name['connection_abort'].containing_oneof = _ERROR.oneofs_by_name['error']
...
Error = _reflection.GeneratedProtocolMessageType('Error', (_message.Message,), {
  ...
  'ServerImplementation' : _reflection.GeneratedProtocolMessageType('ServerImplementation', (_message.Message,), {
  ...
  'InvalidRequest' : _reflection.GeneratedProtocolMessageType('InvalidRequest', (_message.Message,), {
  ...
  'OutdatedServerProtocol' : _reflection.GeneratedProtocolMessageType('OutdatedServerProtocol', (_message.Message,), {
  ...
  'OutdatedClientProtocol' : _reflection.GeneratedProtocolMessageType('OutdatedClientProtocol', (_message.Message,), {
  ...
  'ScannerBusy' : _reflection.GeneratedProtocolMessageType('ScannerBusy', (_message.Message,), {
  ...
  'WrongOperationMode' : _reflection.GeneratedProtocolMessageType('WrongOperationMode', (_message.Message,), {
  ...
  'SystemStop' : _reflection.GeneratedProtocolMessageType('SystemStop', (_message.Message,), {
  ...
  'TimeSyncFailed' : _reflection.GeneratedProtocolMessageType('TimeSyncFailed', (_message.Message,), {
  ...
  'NoDeviceDiscovered' : _reflection.GeneratedProtocolMessageType('NoDeviceDiscovered', (_message.Message,), {
  ...
  'UnknownErrorCode' : _reflection.GeneratedProtocolMessageType('UnknownErrorCode', (_message.Message,), {
  ...
  'NotInRange' : _reflection.GeneratedProtocolMessageType('NotInRange', (_message.Message,), {
  ...
  'NotSupported' : _reflection.GeneratedProtocolMessageType('NotSupported', (_message.Message,), {
  ...
  'ConnectionAbort' : _reflection.GeneratedProtocolMessageType('ConnectionAbort', (_message.Message,), {
    'DESCRIPTOR' : _ERROR_CONNECTIONABORT,
    '__module__' : 'blickfeld.error_pb2'
...
_sym_db.RegisterMessage(Error.ConnectionAbort)
...
_ERROR_CONNECTIONABORT._options = None
