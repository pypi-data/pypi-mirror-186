...
class Overlay(object):
    ...
    def __init__(self, id=None, label=None, max_lat=None, max_lon=None, min_lat=None, min_lon=None, path=None, project_id=None, uuid=None, _configuration=None):  # noqa: E501
