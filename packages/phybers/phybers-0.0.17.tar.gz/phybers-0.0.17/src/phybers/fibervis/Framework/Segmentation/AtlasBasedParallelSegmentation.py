...
class AtlasBasedParallelSegmentation(SegmentationHandler):
	...
	def segmentMethod(self):
		...
		FiberVis_core.AtlasBasedSegmentation(
	...
	def exportBundleFile(self, outfile):
		...
		FiberVis_core.AtlasBasedSegmentationExportbundlesdata(
					outfile+'data',
	...
	def createProgram():
		...
		vertexGLSL = ['shaders/atlasbasedsegmentation.vs']
		fragmentGLSL = ['shaders/standardFragmentShader.fs']
		geometryGLSL = ['shaders/atlasbasedsegmentation.gs']
