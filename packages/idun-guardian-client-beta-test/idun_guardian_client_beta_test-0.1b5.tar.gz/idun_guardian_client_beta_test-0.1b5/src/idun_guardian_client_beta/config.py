...
class Settings(BaseSettings):
    ...
    WS_IDENTIFIER: str = "wss://3x9x8ar79l.execute-api.eu-central-1.amazonaws.com/v1"
    # REST API Gateway # TODO: Point to develop environment
    REST_API_LOGIN: str = "https://kuajk4q03g.execute-api.eu-central-1.amazonaws.com/"
    REST_API_URL_GET: str = "https://kuajk4q03g.execute-api.eu-central-1.amazonaws.com/"
