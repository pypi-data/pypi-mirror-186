...
def cylinder_project(direction: str = 'VIEW_ON_EQUATOR', align: str = 'POLAR_ZX', pole: str = 'PINCH', radius: float = 1.0, correct_aspect: bool = True, clip_to_bounds: bool = False, scale_to_bounds: bool = False) -> None:
...
def sphere_project(direction: str = 'VIEW_ON_EQUATOR', align: str = 'POLAR_ZX', pole: str = 'PINCH', correct_aspect: bool = True, clip_to_bounds: bool = False, scale_to_bounds: bool = False) -> None:
