    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', related_name='risk_tag', to='extras.Tag')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=500)),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', related_name='risk_relation_tag', to='extras.Tag')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='risk_assignments_content_type', to='contenttypes.contenttype')),
