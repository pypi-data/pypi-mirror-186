    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('risk_tag', taggit.managers.TaggableManager(through='extras.TaggedItem', related_name='risk_tag', to='extras.Tag')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=500)),
                ('risk_relation_tag', taggit.managers.TaggableManager(through='extras.TaggedItem', related_name='risk_relation_tag', to='extras.Tag')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('risk_assignments_content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='risk_assignments_content_type', to='contenttypes.contenttype')),
