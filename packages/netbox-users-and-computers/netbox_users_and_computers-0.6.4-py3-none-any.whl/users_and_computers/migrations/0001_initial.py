    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='aduser_assignments', to='users_and_computers.riskrelation')),
                ('risk', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='aduser_assignments', to='users_and_computers.risk')),
            ],
            options={
                'ordering': ['risk'],
