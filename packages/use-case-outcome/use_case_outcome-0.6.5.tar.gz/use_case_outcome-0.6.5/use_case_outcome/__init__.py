...
class UseCaseOutcome:
    ...
    def log(self, level: str, **kwargs):
        ...
        self.logs.append({**kwargs, "level": level, **self.default_fields, "app_name": self.app_name, "integration_name": self.integration_name, "timestamp": pendulum.now().to_iso8601_string()})
