...
class UseCaseOutcome:
    ...
    def submit(
        ...
        p_load: Dict[str, Any] = {
            ...
            **self.arbitrary_record_fields,
            ...
            "raw_fields_changed": json.dumps([field_changed for field_changed in self.fields_changed if "timestamp" in field_changed]),
    ...
    def log(self, level: str, **kwargs):
        ...
        self.logs.append({**kwargs, "level": level, **self.default_fields, "timestamp": pendulum.now().to_iso8601_string()})
