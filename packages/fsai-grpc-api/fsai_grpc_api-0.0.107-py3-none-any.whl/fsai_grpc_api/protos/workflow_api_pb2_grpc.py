...
class WorkflowApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMissionScan = channel.unary_unary(
                '/WorkflowApi/GetMissionScan',
                request_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanRequest.SerializeToString,
                response_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanResponse.FromString,
                )
...
class WorkflowApiServicer(object):
    ...
    def GetMissionScan(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_WorkflowApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMissionScan': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMissionScan,
                    request_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanRequest.FromString,
                    response_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanResponse.SerializeToString,
            ),
    }
...
class WorkflowApi(object):
    ...
    def GetMissionScan(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/WorkflowApi/GetMissionScan',
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanRequest.SerializeToString,
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.GetMissionScanResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
