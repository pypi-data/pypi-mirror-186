...
_GETNEXTIMAGEREQUEST = _descriptor.Descriptor(
  name='GetNextImageRequest',
  full_name='GetNextImageRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='workflow_id', full_name='GetNextImageRequest.workflow_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETNEXTIMAGERESPONSE = _descriptor.Descriptor(
  name='GetNextImageResponse',
  full_name='GetNextImageResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_id', full_name='GetNextImageResponse.image_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['GetNextImageRequest'] = _GETNEXTIMAGEREQUEST
DESCRIPTOR.message_types_by_name['GetNextImageResponse'] = _GETNEXTIMAGERESPONSE
...
GetNextImageRequest = _reflection.GeneratedProtocolMessageType('GetNextImageRequest', (_message.Message,), {
  'DESCRIPTOR' : _GETNEXTIMAGEREQUEST,
  '__module__' : 'fsai_grpc_api.protos.image_api_pb2'
  # @@protoc_insertion_point(class_scope:GetNextImageRequest)
  })
_sym_db.RegisterMessage(GetNextImageRequest)

GetNextImageResponse = _reflection.GeneratedProtocolMessageType('GetNextImageResponse', (_message.Message,), {
  'DESCRIPTOR' : _GETNEXTIMAGERESPONSE,
  '__module__' : 'fsai_grpc_api.protos.image_api_pb2'
  # @@protoc_insertion_point(class_scope:GetNextImageResponse)
  })
_sym_db.RegisterMessage(GetNextImageResponse)
...
_IMAGEAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetNextImage',
    full_name='ImageApi.GetNextImage',
    index=3,
    containing_service=None,
    input_type=_GETNEXTIMAGEREQUEST,
    output_type=_GETNEXTIMAGERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
