...
from mojadata.error.attributenotfounderror import AttributeNotFoundError
...
class VectorLayer(Layer):
    ...
    def _rasterize(self, srs, min_pixel_size, block_extent, requested_pixel_size=None,
        ...
        self._data_type = data_type or self._data_type \
            or self._get_native_data_type() if self._raw \
