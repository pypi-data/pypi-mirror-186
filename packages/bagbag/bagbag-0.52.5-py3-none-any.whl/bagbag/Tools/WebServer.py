...
class Response():
    def Make(self, body:str, statusCode:int=200, contentType:str=None, headers:dict=None) -> flask.Response:
        resp = flask.Response(body, status=statusCode, content_type=contentType)
        if headers != None:
            for k in headers:
