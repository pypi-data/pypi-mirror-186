...
print("Motor de Calidad Version Release 1.6.1")
...
def validateRules(object:DataFrame,rules:dict,registerAmount:int, entity: str, project:str,country: str,domain: str,subDomain: str,segment: str,area: str,error,dataDate:str):
    ...
    return validationData.select(
        ...
        CountryId.value(when(lit(country).isNull(),upper(dbutils.widgets.get('country'))).otherwise(country)),
        Country.value(when(lit(country).isNull(),upper(dbutils.widgets.get('country'))).otherwise(country)),
