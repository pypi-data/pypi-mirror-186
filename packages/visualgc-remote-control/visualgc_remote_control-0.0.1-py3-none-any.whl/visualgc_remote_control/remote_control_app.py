...
from enterprise import RemoteControlException
from remote_commands import RemoteCommand
...
class RemoteControlApp:
    ...
    def run():
        ...
        app.add_url_rule('/linux_test', view_func=RemoteControlApp.test_script_folder, methods=['GET'])
