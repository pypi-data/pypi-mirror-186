...
def about_display():
    ...
    console.print(
        "\n[red]RegScale does not conduct any form of security scanning for data imported by the customer. "
        ...
        + "customer that fails to meet such requirements.[red]\n"
    )
...
def init(domain: str, username: str, password: str, skip_prompts: bool):
    ...
    if domain or domain_prompt[0].lower() == "y":
        # make sure --domain wasn't used and they said yes to change their domain
