...
# Query params
DataFlowTypeSchema = FlowType


class DataFlowStageSchema(
    schemas.Int32Schema
):
    ...
    class MetaOapg:
        ...
        inclusive_maximum = 3
        inclusive_minimum = 0
DataFlowConvertSchema = FlowConvert
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'data_flow_type': typing.Union[DataFlowTypeSchema, ],
        'data_flow_stage': typing.Union[DataFlowStageSchema, decimal.Decimal, int, ],
        'data_flow_convert': typing.Union[DataFlowConvertSchema, ],
    },
    total=False
)
...
request_query_data_flow_type = api_client.QueryParameter(
    name="data_flow_type",
    style=api_client.ParameterStyle.FORM,
    schema=DataFlowTypeSchema,
    explode=True,
)
request_query_data_flow_stage = api_client.QueryParameter(
    name="data_flow_stage",
    style=api_client.ParameterStyle.FORM,
    schema=DataFlowStageSchema,
    explode=True,
)
request_query_data_flow_convert = api_client.QueryParameter(
    name="data_flow_convert",
    style=api_client.ParameterStyle.FORM,
    schema=DataFlowConvertSchema,
    explode=True,
)
# Path params
TracecodeSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tracecode': typing.Union[TracecodeSchema, str, uuid.UUID, ],
    }
)
...
request_path_tracecode = api_client.PathParameter(
    name="tracecode",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TracecodeSchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
class BaseApi(api_client.Api):
    ...
    def _read_data_oapg(
        ...
        for parameter in (
            request_query_data_flow_type,
            request_query_data_flow_stage,
            request_query_data_flow_convert,
        ):
