...
SchemaFor200ResponseBodyApplicationJson = UserStatistics
...
class GenerateStatistics(BaseApi):
    ...
    def generate_statistics(
        ...
        return self._generate_statistics_oapg(
