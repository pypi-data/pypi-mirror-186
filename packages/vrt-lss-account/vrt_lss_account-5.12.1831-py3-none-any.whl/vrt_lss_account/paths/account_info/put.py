...
# body param
SchemaForRequestBodyApplicationJson = AccountInfo


request_body_account_info = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_info_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_info.serialize(body, content_type)
