...
SchemaFor200ResponseBodyApplicationJson = TokenValidationResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_token_validation_oapg(
        self,
...
class RunTokenValidation(BaseApi):
    ...
    def run_token_validation(
        ...
        return self._run_token_validation_oapg(
            body=body,
