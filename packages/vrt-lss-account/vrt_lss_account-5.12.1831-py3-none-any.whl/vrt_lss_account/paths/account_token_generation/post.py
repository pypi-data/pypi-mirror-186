...
# body param
SchemaForRequestBodyApplicationJson = TokenRequest


request_body_token_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_token_generation_oapg(
        self,
    ...
    def _run_token_generation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_token_request.serialize(body, content_type)
...
class RunTokenGeneration(BaseApi):
    ...
    def run_token_generation(
        ...
        return self._run_token_generation_oapg(
            body=body,
