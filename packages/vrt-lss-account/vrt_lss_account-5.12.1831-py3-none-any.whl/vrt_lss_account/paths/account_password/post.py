...
# body param
SchemaForRequestBodyApplicationJson = PasswordRequest


request_body_password_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _change_password_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_password_request.serialize(body, content_type)
