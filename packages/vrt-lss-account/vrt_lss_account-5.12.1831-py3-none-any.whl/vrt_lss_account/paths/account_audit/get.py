...
ServiceNameSchema = ServiceName
OperationIdSchema = OperationId
MethodGroupSchema = MethodGroup
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'service_name': typing.Union[ServiceNameSchema, ],
        'operation_id': typing.Union[OperationIdSchema, ],
        'method_group': typing.Union[MethodGroupSchema, ],
    },
    total=False
)
...
request_query_method_group = api_client.QueryParameter(
    name="method_group",
    style=api_client.ParameterStyle.FORM,
    schema=MethodGroupSchema,
    explode=True,
)
_auth = [
    'ApiKeyAuth',
]
SchemaFor200ResponseBodyApplicationJson = AccountAuditResult
