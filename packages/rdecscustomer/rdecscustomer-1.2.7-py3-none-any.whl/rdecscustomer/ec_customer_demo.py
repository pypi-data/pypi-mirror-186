...
import re
from Customer.rdecscustomer import ec_DatabaseOperations as db
from k3cloud_webapi_sdk.main import K3CloudApiSdk
from Customer.rdecscustomer import ec_Metadata as mt
from Customer.rdecscustomer import ec_Utility as ut
import time
...
def FCREATEDATE_get_ECS(FData):
    ...
    data = ECS_post_info(url, 1, 1000, "like", "v_customer_info", FData, "UPDATE_TIME")

    for i,d in data.iterrows():

        if data.loc[i]['FCustomerType']=="成交客户":
            ...
            try:
                ...
                result=combination(d,data_address.loc[i],data_contact.loc[i])
...
if __name__ == '__main__':
    FCREATEDATE_get_ECS("2023-01-10")
