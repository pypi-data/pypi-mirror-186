    ...
    def __init__(
        ...
        def handle_redirect() -> str:
            ...
            if (
                ...
                logger.warning("received request without state or mismatching state: " f"{parsed_qs.get('state')}")
                ...
                logger.error("no auth code found in redirect - authentication error occurred" f"{request.url=}")
