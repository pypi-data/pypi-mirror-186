...
class SaxoOpenAPIClient:
    ...
    def openapi_request(
        ...
        logger.debug(f"performing request: {method} {_path}, {params=}, {data=}")
        ...
        logger.debug(
            f"response received with status: {response.status_code}, time taken: {response.elapsed}, X-Correlation: "
