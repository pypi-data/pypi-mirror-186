    ...
    for dataset_name in dataset_names:
        for classifier_name in classifier_names:
            ...
            if classifier_name == 'fcn':
                ...
                fit(fcn.Classifier_CNN, trainloader, valloader, input_shape, nb_classes, dataset_name, classifier_name, epochs)
                ...
                fit(mlp.Classifier_CNN, trainloader, valloader, input_shape, nb_classes, dataset_name, classifier_name, epochs)

            elif classifier_name == 'resnet':
                from test_tscai_1.models import resnet
                print('Everything is ok and now RESNET is calling')
                fit(resnet.Classifier_CNN, trainloader, valloader, input_shape, nb_classes, dataset_name, classifier_name, epochs)
                ...
                fit(inception.Classifier_CNN, trainloader, valloader, input_shape, nb_classes, dataset_name, classifier_name, epochs)
