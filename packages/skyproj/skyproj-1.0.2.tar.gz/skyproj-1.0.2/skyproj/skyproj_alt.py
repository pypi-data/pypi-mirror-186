...
class _Skyproj():
    ...
    **kwargs : `dict`, optional
    ...
    def __init__(self, ax=None, projection_name='cyl', lon_0=0, gridlines=True, celestial=True,
                 extent=None, longitude_ticks='positive', autorescale=True, autoreproject=True, **kwargs):
        ...
        self._autoreproject = autoreproject
    ...
    @property
    def _lon_0(self):
        return self.projection.proj4_params['lon_0']
