...
experiment:
  ...
  mlflow:
    ...
    # Set the tracking URI. "{wd}" is set to the working directory.
    # tracking_uri: file://{wd}/mlruns

    # Set the artifact URI. If not set, it defaults to the tracking URI.
    # artifact_uri: file://{wd}/mlruns

    # Set the registry URI. If not set, it defaults to the tracking URI.
    # registry_uri: file://{wd}/mlruns
''')
