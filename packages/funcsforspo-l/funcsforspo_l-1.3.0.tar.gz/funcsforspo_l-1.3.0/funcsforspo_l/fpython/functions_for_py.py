...
def arquivo_com_caminho_abs(dir:str, filename:str|list|tuple) -> str|tuple:
    """Usa join para unir os caminhos enviados por ti para que funcionem em qualquer sistema operacional
    ele recupera o caminho absoluto do diretorio enviado e concatena com o arquivo enviado

    Args:
        dir (str): diretório para unir com o filename
        filename (str | list | tuple): filename para unir com o diretório

    Returns:
        str|tuple: retorna o arquivo com o seu caminho ou vários arquivos em uma tupla
    """
    if isinstance(filename, (tuple, list)):
        return tuple([os.path.join(os.path.abspath(dir), i) for i in filename])
    else:
