...
from fastdup.utils import download_from_s3, check_latest_version, shorten_path, list_subfolders_from_file, \
    check_if_folder_list, save_as_csv_file_list, expand_list_to_files, load_stats
...
if not os.path.exists(model_path_full):
    ...
    printf("Failed to find ort model on init " + __file__)
    sys.exit(1)
