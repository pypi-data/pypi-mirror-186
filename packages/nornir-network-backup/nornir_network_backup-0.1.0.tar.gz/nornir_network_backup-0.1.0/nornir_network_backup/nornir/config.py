...
def set_textfsm_envvar(templates_folder: str) -> None:
    """sets the NET_TEXTFSM environment var, which is needed by Netmiko
    for using the TEXTFSM templates
    """
    os.environ["NET_TEXTFSM"] = templates_folder
