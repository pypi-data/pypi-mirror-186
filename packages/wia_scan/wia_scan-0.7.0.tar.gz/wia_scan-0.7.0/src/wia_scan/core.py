...
def connect_device(device_manager, device_identifier,
...
def scan_side(device, scan_profile, return_wia_image=False,
              print_function=DEFAULT_PRINT_FUNCTION, verbose=False, quiet=False):
    """
    ...
    # then reading the ARGB data from wia_image, as long as we do not want to
    # add numba or sth as a dependency
...
def scan_many_documents_flatbed(print_function=DEFAULT_PRINT_FUNCTION,
    ...
    while True:
        ...
        number_of_sides = ask_for_an_int(
            'Input number of sides of this document (0 to stop)', default=1, valid_range=(1, 10000))
