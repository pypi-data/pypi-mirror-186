...
def switchUnits(verbose: bool = False):
    '''Function to switch between unit systems'''
    global englishUnits
    englishUnits = not englishUnits
    if verbose:
        _print_units(englishUnits)

def useEnglish(verbose: bool = False):
...
def _print_units(is_english: bool):
    """
    Prints unit system to std out

    Args:
        is_english (bool): english units boolean
    """
    print(f"Using {'English' if is_english else 'SI'} units")
