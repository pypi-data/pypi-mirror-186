...
class Data(torch.utils.data.Dataset):
  def __init__(self, name: str, arg: str, feats: str, feats_is_url: bool, labels: str, \
               labels_is_url: bool):
    self.name = name
    self.arg = arg
    self.data = feats
...
class NeuralFact:
  def __init__(self, name: str, inp: str, path: str, is_url: bool, body: str):
    pass

class NeuralAD:
  def __init__(self, name: str, inp: str, vals: str, path: str, is_url: bool, body: str):
    pass
