...
class Button(GunaBase):
    def __init__(self, *args, width=100, height=30, text="GunaUI2.Control", **kwargs):
...
class CheckBox(Button):
    ...
    def checked_change(self, func):
        self._widget.CheckedChanged = func
...
if __name__ == '__main__':
    ...
    tb1.font("Sego UI", 9)
    tb1.animated = True
    tb1.pack(fill="x", ipadx=5, ipady=5, padx=5, pady=5)

    def func2(_1, _2):
        print(tbar1.value)

    tbar1 = TrackBar()
    tbar1.font("Sego UI", 9)
    tbar1.animated = True
    ...
    cb1.animated = True
    cb1.check = True
    cb1.pack(fill="x", ipadx=5, ipady=5, padx=5, pady=5)

    cb2 = CustomCheckBox()
    cb2.font("Sego UI", 9)
    cb2.animated = True
    cb2.check = True
    cb2.pack(fill="x", ipadx=5, ipady=5, padx=5, pady=5)
