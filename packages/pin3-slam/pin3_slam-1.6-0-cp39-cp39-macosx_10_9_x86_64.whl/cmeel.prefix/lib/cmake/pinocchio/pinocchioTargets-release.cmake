...
set_target_properties(pinocchio::pinocchio_pywrap_default PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/pinocchio/pinocchio_pywrap_default.2.9.1.cpython-39-darwin.so"
  IMPORTED_SONAME_RELEASE "@rpath/pinocchio_pywrap_default.2.9.1.cpython-39-darwin.so"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_default )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_default "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/pinocchio/pinocchio_pywrap_default.2.9.1.cpython-39-darwin.so" )
...
set_target_properties(pinocchio::pinocchio_pywrap_casadi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/pinocchio/pinocchio_pywrap_casadi.2.9.1.cpython-39-darwin.so"
  IMPORTED_SONAME_RELEASE "@rpath/pinocchio_pywrap_casadi.2.9.1.cpython-39-darwin.so"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_casadi )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_casadi "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/pinocchio/pinocchio_pywrap_casadi.2.9.1.cpython-39-darwin.so" )
