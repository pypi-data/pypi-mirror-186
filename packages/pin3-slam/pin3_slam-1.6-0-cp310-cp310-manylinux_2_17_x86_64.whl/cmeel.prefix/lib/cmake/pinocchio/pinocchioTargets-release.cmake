...
set_target_properties(pinocchio::pinocchio_pywrap_default PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_default.cpython-310-x86_64-linux-gnu.so.2.9.1"
  IMPORTED_SONAME_RELEASE "pinocchio_pywrap_default.cpython-310-x86_64-linux-gnu.so.2.9.1"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_default )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_default "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_default.cpython-310-x86_64-linux-gnu.so.2.9.1" )
...
set_target_properties(pinocchio::pinocchio_pywrap_casadi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_casadi.cpython-310-x86_64-linux-gnu.so.2.9.1"
  IMPORTED_SONAME_RELEASE "pinocchio_pywrap_casadi.cpython-310-x86_64-linux-gnu.so.2.9.1"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_casadi )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_casadi "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_casadi.cpython-310-x86_64-linux-gnu.so.2.9.1" )
