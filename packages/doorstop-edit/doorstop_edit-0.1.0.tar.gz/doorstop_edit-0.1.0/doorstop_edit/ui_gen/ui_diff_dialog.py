...
class Ui_diff_dialog(object):
    def setupUi(self, diff_dialog):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/arrow-left", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/arrow-right", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.horizontalSpacer_4 = QSpacerItem(2, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.horizontalSpacer_5 = QSpacerItem(2, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
