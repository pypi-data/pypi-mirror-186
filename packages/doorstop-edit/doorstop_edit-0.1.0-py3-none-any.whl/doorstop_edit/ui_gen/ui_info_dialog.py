...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy2.setHeightForWidth(self.buttons.sizePolicy().hasHeightForWidth())
        self.buttons.setSizePolicy(sizePolicy2)
        self.buttons.setOrientation(Qt.Horizontal)
        self.buttons.setStandardButtons(QDialogButtonBox.Apply|QDialogButtonBox.Close)
