from hrthy_core.security.scopes import (
    ...
    SCOPE_LICENSE_POOL_MY_LIST, SCOPE_LICENSE_POOL_UPDATE, SCOPE_MANAGER_PIPELINE_MY_CREATE,
...
HIERARCHY_SCOPES = {
    ...
    SCOPE_PIPELINE_CANDIDATE_MY_LIST: {
        'type': ScopeType.GLOBAL, 'includes': [],
        'depends': {
            ConditionType.OR: [{ConditionType.AND: [SCOPE_PIPELINE_MY_LIST, SCOPE_CANDIDATE_MY_LIST]},
