...
DESCRIPTIONS_SCOPES = {
    ...
    SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_LIST: 'Manager can list all the candidates in a pipeline assigned to him/her',
    SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_CREATE: 'Manager can assign a candidate in a pipeline assigned to him/her',
    SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_DELETE: 'Manager can unassign a candidate from a pipeline assigned to him/her',
    # endregion
