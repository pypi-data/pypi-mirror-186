...
SCOPE_MANAGER_PIPELINE_MY_CREATE = 'man.pip.my.c'  # Manager
...
# Permissions to assign, unassign candidates to a pipeline by a manager
SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_LIST = 'man.pip.can.my.l'  # Manager
SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_CREATE = 'man.pip.can.my.c'  # Manager
SCOPE_MANAGER_PIPELINE_CANDIDATE_MY_DELETE = 'man.pip.can.my.d'  # Manager
# endregion
