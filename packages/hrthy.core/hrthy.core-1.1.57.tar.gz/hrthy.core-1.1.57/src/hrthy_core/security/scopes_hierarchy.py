...
HIERARCHY_SCOPES = {
    ...
    SCOPE_PIPELINE_MYSELF_GET: {'type': ScopeType.PERSONAL, 'includes': [], 'depends': [], 'visible': False},
    # endregion
    ...
    SCOPE_PIPELINE_CANDIDATE_CREATE: {
        ...
        'depends': [SCOPE_PIPELINE_CANDIDATE_LIST],
        'visible': [SCOPE_ROLE_MY_ASSIGN_GLOBAL]
    },
    ...
    SCOPE_PIPELINE_CANDIDATE_MY_CREATE: {
        'type': ScopeType.COMPANY, 'includes': [],
        'depends': [SCOPE_PIPELINE_CANDIDATE_MY_LIST],
        'visible': True
    },
