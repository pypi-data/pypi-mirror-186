from hrthy_core.security.scopes import (
    ...
    SCOPE_LICENSE_POOL_UPDATE, SCOPE_MANAGER_PIPELINE_MY_CREATE, SCOPE_MANAGER_PIPELINE_MY_DELETE,
    ...
    SCOPE_PIPELINE_DELETE, SCOPE_PIPELINE_LIST, SCOPE_PIPELINE_MANAGER_ASSIGN, SCOPE_PIPELINE_MANAGER_MY_ASSIGN,
    SCOPE_PIPELINE_MANAGER_MY_UNASSIGN, SCOPE_PIPELINE_MANAGER_UNASSIGN,
