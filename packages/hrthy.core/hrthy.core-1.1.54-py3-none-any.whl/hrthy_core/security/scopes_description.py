from hrthy_core.security.scopes import (
    ...
    SCOPE_ROLE_MY_CREATE, SCOPE_ROLE_MY_DELETE, SCOPE_ROLE_MY_LIST, SCOPE_ROLE_MY_UPDATE,
    SCOPE_ROLE_UPDATE, SCOPE_USER_CREATE, SCOPE_USER_DELETE, SCOPE_USER_LIST, SCOPE_USER_MYSELF_DELETE,
    SCOPE_USER_MYSELF_GET, SCOPE_USER_MYSELF_UPDATE, SCOPE_USER_MY_CREATE,
...
DESCRIPTIONS_SCOPES = {
    ...
    SCOPE_PIPELINE_MANAGER_ASSIGN: 'User can assign a manager to a pipeline in other companies',
    SCOPE_PIPELINE_MANAGER_UNASSIGN: 'User can unassign a manager from a pipeline in other companies',
    SCOPE_PIPELINE_MANAGER_MY_ASSIGN: 'User can assign a manager to a pipeline in its company',
    SCOPE_PIPELINE_MANAGER_MY_UNASSIGN: 'User can unassign a manager from a pipeline in its company',
    # endregion

    # region MANAGER - PIPELINE
    SCOPE_MANAGER_PIPELINE_MY_LIST: 'Manager can list all the pipelines assigned to him/her',
    SCOPE_MANAGER_PIPELINE_MY_CREATE: 'Manager can create a new pipeline and assign it to him/her',
