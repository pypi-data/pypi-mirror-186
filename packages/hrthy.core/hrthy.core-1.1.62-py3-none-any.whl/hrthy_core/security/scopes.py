...
SCOPE_PIPELINE_CANDIDATE_LIST = 'pip.can.l'  # Superuser
SCOPE_PIPELINE_CANDIDATE_CREATE = 'pip.can.c'  # Superuser
SCOPE_PIPELINE_CANDIDATE_DELETE = 'pip.can.d'  # Superuser
...
SCOPE_PIPELINE_MANAGER_LIST = 'pip.man.l'  # Superuser
SCOPE_PIPELINE_MANAGER_CREATE = 'pip.man.c'  # Superuser
SCOPE_PIPELINE_MANAGER_DELETE = 'pip.man.d'  # Superuser
