    ...
    def train_epoch(self, dataloader, epoch):
        ...
        for batch_index, batch in enumerate(dataloader):
            ...
            if math.isnan(loss):
                ...
                if self._nan_loss_cnt > N_LOSS_NAN_TOLERANCE:  # there is a bug where loss occasionally becomes nan, and grad clip recovers it
                    raise RuntimeError(f'Training has diverged and failed: loss stuck in NaN for more than {N_LOSS_NAN_TOLERANCE} epochs.')
            self._nan_loss_cnt = 0
