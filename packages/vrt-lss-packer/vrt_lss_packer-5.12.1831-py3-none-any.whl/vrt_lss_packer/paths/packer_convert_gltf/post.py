...
# body param
SchemaForRequestBodyApplicationJson = RenderTask


request_body_render_task = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _run_convert_to_gltf_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_render_task.serialize(body, content_type)
...
class RunConvertToGltf(BaseApi):
    ...
    def run_convert_to_gltf(
        ...
        return self._run_convert_to_gltf_oapg(
            body=body,
