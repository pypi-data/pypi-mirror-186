...
from vrt_lss_packer import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = PackTask


request_body_pack_task = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CalculationAsyncResult
...
class SchemaFor400ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tracedata"], typing_extensions.Literal["message"], typing_extensions.Literal["schema_errors"], typing_extensions.Literal["logical_errors"], typing_extensions.Literal["validations"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tracedata"], typing_extensions.Literal["message"], typing_extensions.Literal["schema_errors"], typing_extensions.Literal["logical_errors"], typing_extensions.Literal["validations"], ]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_pack_calculation_async_oapg(
        self,
    ...
    def _run_pack_calculation_async_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pack_task.serialize(body, content_type)
...
class RunPackCalculationAsync(BaseApi):
    ...
    def run_pack_calculation_async(
        ...
        return self._run_pack_calculation_async_oapg(
            body=body,
