...
SchemaFor200ResponseBodyApplicationJson = CalculationState
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_pack_calculation_state_oapg(
        self,
...
class ReadPackCalculationState(BaseApi):
    ...
    def read_pack_calculation_state(
        ...
        return self._read_pack_calculation_state_oapg(
