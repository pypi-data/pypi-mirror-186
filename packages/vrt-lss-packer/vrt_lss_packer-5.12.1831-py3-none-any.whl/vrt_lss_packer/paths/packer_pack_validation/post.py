...
SchemaFor200ResponseBodyApplicationJson = ValidateResult
...
class RunPackValidation(BaseApi):
    ...
    def run_pack_validation(
        ...
        return self._run_pack_validation_oapg(
            body=body,
