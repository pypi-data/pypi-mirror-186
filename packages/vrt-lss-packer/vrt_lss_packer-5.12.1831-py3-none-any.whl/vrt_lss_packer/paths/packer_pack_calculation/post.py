...
SchemaFor200ResponseBodyApplicationJson = PackResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_pack_calculation_oapg(
        self,
...
class RunPackCalculation(BaseApi):
    ...
    def run_pack_calculation(
        ...
        return self._run_pack_calculation_oapg(
            body=body,
