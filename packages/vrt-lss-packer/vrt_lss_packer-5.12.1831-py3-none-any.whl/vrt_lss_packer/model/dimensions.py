...
class Dimensions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mass"], typing_extensions.Literal["length"], typing_extensions.Literal["width"], typing_extensions.Literal["height"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mass"], typing_extensions.Literal["length"], typing_extensions.Literal["width"], typing_extensions.Literal["height"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        mass: typing.Union[MetaOapg.properties.mass, decimal.Decimal, int, ],
