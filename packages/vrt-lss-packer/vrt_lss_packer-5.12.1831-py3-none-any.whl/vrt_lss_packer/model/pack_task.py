...
class PackTask(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pack_settings() -> typing.Type['PackSettings']:
                return PackSettings
            __annotations__ = {
                "products": products,
                "packages": packages,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pack_settings"]) -> 'PackSettings': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["packages"], typing_extensions.Literal["products"], typing_extensions.Literal["pack_settings"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pack_settings"]) -> typing.Union['PackSettings', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["packages"], typing_extensions.Literal["products"], typing_extensions.Literal["pack_settings"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pack_settings: typing.Union['PackSettings', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PackTask':
        return super().__new__(
            cls,
