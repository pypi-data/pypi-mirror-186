...
class EntityErrorType(
  ...
  * `INVALID_PRODUCT_COUNT` - at least one valid product must be present
    ...
    @schemas.classproperty
    def INVALID_SLOTS_COUNT(cls):
        return cls("INVALID_SLOTS_COUNT")
    
    @schemas.classproperty
    def INVALID_SLOT_CONTAINER(cls):
        return cls("INVALID_SLOT_CONTAINER")
    
    @schemas.classproperty
    def INVALID_SLOT_BODY(cls):
        return cls("INVALID_SLOT_BODY")
    
    @schemas.classproperty
    def INVALID_PALLETS_COUNT(cls):
        return cls("INVALID_PALLETS_COUNT")
    
    @schemas.classproperty
    def INVALID_PALLET_CONTAINER_DIMENSIONS(cls):
        return cls("INVALID_PALLET_CONTAINER_DIMENSIONS")
    
    @schemas.classproperty
    def INVALID_PALLET_CONTAINER(cls):
        return cls("INVALID_PALLET_CONTAINER")
    
    @schemas.classproperty
    def INVALID_MIXBOX_CONTAINER(cls):
        return cls("INVALID_MIXBOX_CONTAINER")
    
    @schemas.classproperty
    def INVALID_MIXBOX_COUNT(cls):
        return cls("INVALID_MIXBOX_COUNT")
    
    @schemas.classproperty
    def INVALID_PRODUCT_DIMENSIONS(cls):
        return cls("INVALID_PRODUCT_DIMENSIONS")
    
    @schemas.classproperty
    def INVALID_PRODUCT_COUNT(cls):
        return cls("INVALID_PRODUCT_COUNT")
