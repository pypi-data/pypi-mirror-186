...
class ProductLayout(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["product_key"], typing_extensions.Literal["coordinates"], typing_extensions.Literal["dimensions"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["product_key"], typing_extensions.Literal["coordinates"], typing_extensions.Literal["dimensions"], ]):
