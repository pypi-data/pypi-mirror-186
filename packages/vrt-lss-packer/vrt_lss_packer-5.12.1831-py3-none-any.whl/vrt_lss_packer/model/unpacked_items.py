...
class UnpackedItems(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["product_keys"]) -> MetaOapg.properties.product_keys: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["package_keys"]) -> MetaOapg.properties.package_keys: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["product_keys"], typing_extensions.Literal["package_keys"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["product_keys"]) -> typing.Union[MetaOapg.properties.product_keys, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["package_keys"]) -> typing.Union[MetaOapg.properties.package_keys, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["product_keys"], typing_extensions.Literal["package_keys"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        product_keys: typing.Union[MetaOapg.properties.product_keys, list, tuple, schemas.Unset] = schemas.unset,
        package_keys: typing.Union[MetaOapg.properties.package_keys, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'UnpackedItems':
        return super().__new__(
            cls,
