...
class Coordinates(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x"], typing_extensions.Literal["y"], typing_extensions.Literal["z"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x"], typing_extensions.Literal["y"], typing_extensions.Literal["z"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        z: typing.Union[MetaOapg.properties.z, decimal.Decimal, int, ],
