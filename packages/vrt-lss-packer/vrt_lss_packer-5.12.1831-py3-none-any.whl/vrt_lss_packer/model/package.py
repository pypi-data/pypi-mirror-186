...
class Package(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['PackageType']:
                return PackageType
        
            @staticmethod
            def body_dimensions() -> typing.Type['Dimensions']:
                return Dimensions
        
            @staticmethod
            def container_dimensions() -> typing.Type['Dimensions']:
                return Dimensions
        
            @staticmethod
            def container_coordinates() -> typing.Type['Coordinates']:
                return Coordinates
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["body_dimensions"]) -> 'Dimensions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["container_dimensions"]) -> 'Dimensions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["container_coordinates"]) -> 'Coordinates': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'PackageType': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["body_dimensions"], typing_extensions.Literal["container_dimensions"], typing_extensions.Literal["container_coordinates"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], typing_extensions.Literal["attributes"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["body_dimensions"]) -> 'Dimensions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["container_dimensions"]) -> 'Dimensions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["container_coordinates"]) -> 'Coordinates': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'PackageType': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["body_dimensions"], typing_extensions.Literal["container_dimensions"], typing_extensions.Literal["container_coordinates"], typing_extensions.Literal["type"], typing_extensions.Literal["key"], typing_extensions.Literal["attributes"], ]):
