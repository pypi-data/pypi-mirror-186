...
class EntityErrorList(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EntityError']:
            return EntityError

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['EntityError'], typing.List['EntityError']],
    ...
    def __getitem__(self, i: int) -> 'EntityError':
