...
class PackSettings(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["calculation_settings"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["calculation_settings"], ]):
