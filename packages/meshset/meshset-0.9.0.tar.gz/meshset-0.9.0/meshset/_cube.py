...
def cube_hexa(x_range: np.typing.ArrayLike, y_range: np.typing.ArrayLike, z_range: np.typing.ArrayLike):
...
def cube_tetra(x_range: np.typing.ArrayLike, y_range: np.typing.ArrayLike, z_range: np.typing.ArrayLike):
    x_range = np.asarray(x_range)
    y_range = np.asarray(y_range)
    z_range = np.asarray(z_range)
