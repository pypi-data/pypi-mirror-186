...
def test_uv_sphere(num_points_per_circle=20, num_circles=10):
    points, cells = meshset.uv_sphere(num_points_per_circle, num_circles)
...
def test_geo_sphere(num_points_per_circle=20, num_circles=10):
    points, tri, quad = meshset.geo_sphere(num_points_per_circle, num_circles)
    # import meshio
...
def test_tetra_sphere(n=16):
    points, cells = meshset.tetra_sphere(n)
    # import meshio
...
def test_octa_sphere(n=16):
    points, cells = meshset.octa_sphere(n)
...
def test_icosa_sphere(n=16):
    points, cells = meshset.icosa_sphere(n)
    # import meshio
    # meshio.write_points_cells("out.vtk", points, {"triangle": cells})
