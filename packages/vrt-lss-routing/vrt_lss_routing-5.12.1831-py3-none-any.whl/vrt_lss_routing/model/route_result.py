...
class RouteResult(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["route"]) -> 'Route': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tracedata"]) -> 'Tracedata': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["route"], typing_extensions.Literal["tracedata"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["route"]) -> 'Route': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tracedata"]) -> 'Tracedata': ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["route"], typing_extensions.Literal["tracedata"], ]):
