...
# body param
SchemaForRequestBodyApplicationJson = RouteTask


request_body_route_task = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RouteResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_route_calculation_oapg(
        self,
    ...
    def _run_route_calculation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_route_task.serialize(body, content_type)
...
class RunRouteCalculation(BaseApi):
    ...
    def run_route_calculation(
        ...
        return self._run_route_calculation_oapg(
            body=body,
