...
from vrt_lss_routing import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = MatrixTask


request_body_matrix_task = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MatrixResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_matrix_calculation_oapg(
        self,
    ...
    def _run_matrix_calculation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_matrix_task.serialize(body, content_type)
...
class RunMatrixCalculation(BaseApi):
    ...
    def run_matrix_calculation(
        ...
        return self._run_matrix_calculation_oapg(
            body=body,
