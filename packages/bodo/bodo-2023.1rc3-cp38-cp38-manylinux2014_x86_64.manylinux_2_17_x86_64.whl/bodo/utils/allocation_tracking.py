...
def get_allocation_stats():
    ycobn__hbawm = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa(
        ), get_allocation_stats_hstr()
    jhex__kkym, wfc__qqb, rssc__wfu, rdl__lsymb = 0, 0, 0, 0
    for bjgyp__end in ycobn__hbawm:
        jhex__kkym += bjgyp__end[0]
        wfc__qqb += bjgyp__end[1]
        rssc__wfu += bjgyp__end[2]
        rdl__lsymb += bjgyp__end[3]
    return jhex__kkym, wfc__qqb, rssc__wfu, rdl__lsymb
