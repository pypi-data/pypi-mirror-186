...
from synctera_client.exceptions import ApiTypeError, ApiValueError, ApiException
from synctera_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ACHApi()
        api_instance.add_transaction_out  # this is an instance of the class Endpoint
        api_instance.add_transaction_out()  # this invokes api_instance.add_transaction_out.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_transaction_out.callable or self.callable in this class
