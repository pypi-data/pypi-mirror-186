...
class CreateCardImageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_product_id, customer_id, *args, **kwargs):  # noqa: E501
        """CreateCardImageRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_product_id, customer_id, *args, **kwargs):  # noqa: E501
        """CreateCardImageRequest - a model defined in OpenAPI
