...
class TransferResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, country_code, created_time, currency, customer_id, id, last_modified_time, merchant, status, type, *args, **kwargs):  # noqa: E501
        """TransferResponse - a model defined in OpenAPI
        ...
        Args:
            ...
            customer_id (str): The ID of the customer for which card is being activated
        ...
        Keyword Args:
            ...
            transaction_id (str): The transaction ID. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, country_code, created_time, currency, customer_id, id, last_modified_time, merchant, status, type, *args, **kwargs):  # noqa: E501
        """TransferResponse - a model defined in OpenAPI
