...
def lazy_import():
    ...
    globals()['CardProgram'] = CardProgram


class CardProgramResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CardProgramResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            creation_time (datetime): The timestamp representing when the program was created
            end_date (datetime): The time when program became inactive
            id (str): Program ID
            last_modified_time (datetime): The timestamp representing when the program was last modified
            name (str): Program name
            partner_id (int): The ID of the partner program belongs to
            start_date (datetime): The time when program becomes active
