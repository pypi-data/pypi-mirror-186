...
class Merchant(ModelNormal):
    ...
    def _from_openapi_data(cls, address, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            email (str): Merchant's email. [optional]  # noqa: E501
            phone_number (str): Merchant's phone number with country code in E.164 format. Must have a valid country code. Area code and local phone number are not validated.. [optional]  # noqa: E501
        """
