...
class Disclosure1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type, timestamp, type, version, *args, **kwargs):  # noqa: E501
        """Disclosure1 - a model defined in OpenAPI

        Args:
            event_type (str):
            timestamp (datetime): Date of disclosure
            type (str): Disclosure Type
            version (str): Disclosure Version
        ...
        Keyword Args:
            ...
            id (str): Disclosure ID. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type, timestamp, type, version, *args, **kwargs):  # noqa: E501
        """Disclosure1 - a model defined in OpenAPI
