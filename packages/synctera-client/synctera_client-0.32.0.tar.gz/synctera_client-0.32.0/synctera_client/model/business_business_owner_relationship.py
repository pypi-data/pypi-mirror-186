...
class BusinessBusinessOwnerRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BusinessBusinessOwnerRelationship - a model defined in OpenAPI

        Keyword Args:
            additional_data (AdditionalOwnerData):
            from_business_id (str): Unique ID for the subject business. 
            ...
            to_business_id (str): Unique ID for the related business. 
