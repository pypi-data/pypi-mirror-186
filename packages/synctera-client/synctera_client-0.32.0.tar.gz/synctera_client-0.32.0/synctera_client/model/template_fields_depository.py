...
def lazy_import():
    ...
    globals()['BaseTemplateFields'] = BaseTemplateFields
    globals()['SpendControlIds'] = SpendControlIds
    globals()['SpendingLimits'] = SpendingLimits
    globals()['TemplateFieldsDepositoryAllOf'] = TemplateFieldsDepositoryAllOf


class TemplateFieldsDepository(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateFieldsDepository - a model defined in OpenAPI

        Keyword Args:
            account_type (AccountType):
            bank_country (str): Bank country of the account. ISO 3166-1 Alpha-2 or Alpha-3 country code.
            ...
            interest_product_id (str): An interest account product that the current account associates with. The account product must have its calculation_method set to COMPOUNDED_MONTHLY. . [optional]  # noqa: E501
