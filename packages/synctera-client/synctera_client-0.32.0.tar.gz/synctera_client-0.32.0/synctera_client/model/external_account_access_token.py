...
class ExternalAccountAccessToken(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vendor_public_token': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'vendor_public_token': 'vendor_public_token',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vendor_institution_id, vendor_public_token, *args, **kwargs):  # noqa: E501
        """ExternalAccountAccessToken - a model defined in OpenAPI

        Args:
            vendor_institution_id (str): The ID of the institution the access token is requested for 
            vendor_public_token (str): The user's public token obtained from successful link login. 
        ...
        Keyword Args:
            ...
            vendor_customer_id (str): An alias for `customer_id` (deprecated).. [optional]  # noqa: E501
        """
        ...
        self.vendor_institution_id = vendor_institution_id
        self.vendor_public_token = vendor_public_token
    ...
    @convert_js_args_to_python_args
    def __init__(self, vendor_institution_id, vendor_public_token, *args, **kwargs):  # noqa: E501
        """ExternalAccountAccessToken - a model defined in OpenAPI
