...
def lazy_import():
    ...
    globals()['BaseDisclosure'] = BaseDisclosure
    globals()['DisclosureType'] = DisclosureType
    globals()['Version'] = Version


class Disclosure(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Disclosure - a model defined in OpenAPI

        Keyword Args:
            disclosure_date (datetime): Date and time the disclosure was made.
