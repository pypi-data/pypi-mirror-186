...
def lazy_import():
    ...
    globals()['MinimumPaymentFull'] = MinimumPaymentFull
    globals()['SpendControlIds'] = SpendControlIds
    globals()['SpendingLimits'] = SpendingLimits
    globals()['TemplateFieldsChargeSecured'] = TemplateFieldsChargeSecured
    globals()['TemplateFieldsDepository'] = TemplateFieldsDepository
    globals()['TemplateFieldsLineOfCredit'] = TemplateFieldsLineOfCredit


class TemplateFields(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bank_country': (str,),  # noqa: E501
            'currency': (str,),  # noqa: E501
            'interest_product_id': (str,),  # noqa: E501
            'minimum_payment': (MinimumPaymentFull,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'bank_country': 'bank_country',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateFields - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_ach_enabled (bool): Enable ACH transaction.. [optional] if omitted the server will use the default value of False  # noqa: E501
            is_card_enabled (bool): Enable card transaction.. [optional] if omitted the server will use the default value of False  # noqa: E501
            is_p2p_enabled (bool): Enable P2P transaction.. [optional] if omitted the server will use the default value of False  # noqa: E501
            is_wire_enabled (bool): Enable wire transaction.. [optional] if omitted the server will use the default value of False  # noqa: E501
            overdraft_limit (int): Account's overdraft limit. Default is 0. Unit in cents.. [optional]  # noqa: E501
            ...
            grace_period (int): The number of days past the billing period to allow for payment before it is considered due. This directly infers the due date for a payment. . [optional] if omitted the server will use the default value of 30  # noqa: E501
            bank_country (str): Bank country of the account. ISO 3166-1 Alpha-2 or Alpha-3 country code.. [optional]  # noqa: E501
            currency (str): Account currency. ISO 4217 alphabetic currency code. [optional]  # noqa: E501
            interest_product_id (str): An interest account product that the current account associates with. The account product must have its calculation_method set to COMPOUNDED_DAILY, and its rates set to 0%. . [optional]  # noqa: E501
            minimum_payment (MinimumPaymentFull): [optional]  # noqa: E501
        """
