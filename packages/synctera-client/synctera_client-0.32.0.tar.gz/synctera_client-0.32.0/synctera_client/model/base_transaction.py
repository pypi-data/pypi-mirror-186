...
class BaseTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, creation_time, currency, dc_sign, effective_date, force_post, group_id, id, last_updated_time, partial_hold, pending_amount, posted_amount, status, transaction_time, type, *args, **kwargs):  # noqa: E501
        """BaseTransaction - a model defined in OpenAPI
        ...
        self.partial_hold = partial_hold
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, creation_time, currency, dc_sign, effective_date, force_post, group_id, id, last_updated_time, partial_hold, pending_amount, posted_amount, status, transaction_time, type, *args, **kwargs):  # noqa: E501
        """BaseTransaction - a model defined in OpenAPI
