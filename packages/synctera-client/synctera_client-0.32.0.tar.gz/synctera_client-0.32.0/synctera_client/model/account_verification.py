...
def lazy_import():
    ...
    globals()['FinicityAccountVerification'] = FinicityAccountVerification
    globals()['ManualAccountVerification'] = ManualAccountVerification
    globals()['PlaidAccountVerification'] = PlaidAccountVerification


class AccountVerification(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AccountVerification - a model defined in OpenAPI

        Keyword Args:
            vendor (str): The vendor used for verifying the account
            ...
            creation_time (datetime): The time at which verification was first completed.. [optional]  # noqa: E501
            last_updated_time (datetime): The time at which verification was last updated.. [optional]  # noqa: E501
            status (str): The status of verification. [optional]  # noqa: E501
        """
