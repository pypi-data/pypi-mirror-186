...
class CardWebhookSimulationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.simulate_card_fulfillment_event_endpoint = _Endpoint(
            settings={
                'response_type': (SimulateCardFulfillment,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/cards/{card_id}/webhook_simulations/fulfillment',
                'operation_id': 'simulate_card_fulfillment_event',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'card_id': 'path',
                    'simulate_card_fulfillment': 'body',
                },
    ...
    def simulate_card_fulfillment_event(
        self,
        card_id,
        simulate_card_fulfillment,
        **kwargs
        ...
        Args:
            card_id (str):
            simulate_card_fulfillment (SimulateCardFulfillment): Desired simulated fulfillment status change value
        ...
        kwargs['card_id'] = \
            card_id
        kwargs['simulate_card_fulfillment'] = \
            simulate_card_fulfillment
        return self.simulate_card_fulfillment_event_endpoint.call_with_http_info(**kwargs)
