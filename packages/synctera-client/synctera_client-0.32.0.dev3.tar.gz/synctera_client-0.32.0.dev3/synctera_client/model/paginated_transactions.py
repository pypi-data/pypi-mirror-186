...
class PaginatedTransactions(
        ...
        class properties:
            ...
            class transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Transaction1']:
                        return Transaction1
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Transaction1'], typing.List['Transaction1']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'transactions':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Transaction1':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_page_token", "transactions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_page_token", "transactions", ], str]):
