...
class TransactionUpdateMetaRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["external_data", "user_data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["external_data", "user_data", ], str]):
