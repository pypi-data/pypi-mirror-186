...
class WireRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "currency", "customer_id", "originating_account_id", "receiving_account_id", "bank_message", "metadata", "recipient_message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "currency", "customer_id", "originating_account_id", "receiving_account_id", "bank_message", "metadata", "recipient_message", ], str]):
