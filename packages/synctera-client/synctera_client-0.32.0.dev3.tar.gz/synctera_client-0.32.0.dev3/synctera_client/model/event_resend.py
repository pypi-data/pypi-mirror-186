...
class EventResend(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["event_id", "event_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["event_id", "event_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        event_id: typing.Union[MetaOapg.properties.event_id, str, uuid.UUID, ],
        event_type: 'EventType',
