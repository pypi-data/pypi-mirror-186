...
class HoldPostingRequest(
    ...
    hold_amount: MetaOapg.properties.hold_amount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hold_amount"]) -> MetaOapg.properties.hold_amount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_no", "amount", "effective_date", "hold_amount", "subtype", "external_data", "risk_info", "user_data", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hold_amount"]) -> MetaOapg.properties.hold_amount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_no", "amount", "effective_date", "hold_amount", "subtype", "external_data", "risk_info", "user_data", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        hold_amount: typing.Union[MetaOapg.properties.hold_amount, decimal.Decimal, int, ],
