...
class BaseStatementAllOf(BaseModel):
    ...
    __properties = ["account_summary", "authorized_signer", "disclosure", "joint_account_holders", "primary_account_holder_business", "primary_account_holder_personal", "transactions"]
