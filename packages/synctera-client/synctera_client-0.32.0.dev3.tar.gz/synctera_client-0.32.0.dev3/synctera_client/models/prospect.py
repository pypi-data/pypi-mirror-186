...
class Prospect(BaseModel):
    ...
    __properties = ["dob", "first_name", "last_name", "status", "ban_status", "creation_time", "email", "id", "kyc_exempt", "kyc_last_run", "kyc_status", "last_updated_time", "legal_address", "metadata", "middle_name", "phone_number", "related_customers", "shipping_address", "ssn", "ssn_source", "tenant"]
