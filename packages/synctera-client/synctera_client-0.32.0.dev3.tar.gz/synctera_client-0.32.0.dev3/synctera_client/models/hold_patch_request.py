...
class HoldPatchRequest(BaseModel):
    ...
    __properties = ["auto_post_at", "enhanced_transaction", "expires_at", "external_data", "reference_id", "risk_info", "user_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HoldPatchRequest:
        """Create an instance of HoldPatchRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HoldPatchRequest:
        """Create an instance of HoldPatchRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HoldPatchRequest.parse_obj(obj)

        _obj = HoldPatchRequest.parse_obj({
