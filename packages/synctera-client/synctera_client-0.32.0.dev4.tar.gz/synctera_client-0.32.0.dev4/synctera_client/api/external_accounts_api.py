...
class ExternalAccountsApi(object):
    ...
    @validate_arguments
    def list_external_accounts(self, customer_id : Annotated[Optional[List[StrictStr]], Field(description="A list of customer unique identifiers, with a comma separating any values.")] = None, business_id : Annotated[Optional[List[StrictStr]], Field(description="A list of business unique identifiers, with a comma separating any values.")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, include_history : Annotated[Optional[StrictBool], Field(description="If true, include old (inactive) records as well.")] = None, **kwargs) -> ExternalAccountsList:  # noqa: E501
        ...
        >>> thread = api.list_external_accounts(customer_id, business_id, limit, page_token, include_history, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_external_accounts_with_http_info(customer_id, business_id, limit, page_token, include_history, **kwargs)  # noqa: E501

    @validate_arguments
    def list_external_accounts_with_http_info(self, customer_id : Annotated[Optional[List[StrictStr]], Field(description="A list of customer unique identifiers, with a comma separating any values.")] = None, business_id : Annotated[Optional[List[StrictStr]], Field(description="A list of business unique identifiers, with a comma separating any values.")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, include_history : Annotated[Optional[StrictBool], Field(description="If true, include old (inactive) records as well.")] = None, **kwargs):  # noqa: E501
        """List external accounts  # noqa: E501
        ...
        >>> thread = api.list_external_accounts_with_http_info(customer_id, business_id, limit, page_token, include_history, async_req=True)
        >>> result = thread.get()
