...
class Statement(BaseModel):
    ...
    __properties = ["account_id", "due_date", "end_date", "id", "issue_date", "start_date", "account_summary", "authorized_signer", "disclosure", "joint_account_holders", "primary_account_holder_business", "primary_account_holder_personal", "transactions", "savings_summary"]
