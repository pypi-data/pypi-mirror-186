...
class Bin(BaseModel):
    ...
    creation_time: Optional[datetime] = Field(None, description="The timestamp representing when the bin was created")
    ...
    id: Optional[StrictStr] = Field(None, description="Bin ID")
    is_tokenization_enabled: Optional[StrictBool] = Field(False, description="Controls whether bin allows tokenization")
    last_modified_time: Optional[datetime] = Field(None, description="The timestamp representing when the bin was last modified")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Bin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Bin:
        """Create an instance of Bin from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Bin.parse_obj(obj)
