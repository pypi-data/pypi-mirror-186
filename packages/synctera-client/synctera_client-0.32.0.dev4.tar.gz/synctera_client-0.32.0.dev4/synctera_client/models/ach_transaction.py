...
class AchTransaction(BaseModel):
    ...
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "system_description", "transaction_time", "type", "ach_transaction", "subtype"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AchTransaction:
        """Create an instance of AchTransaction from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of ach_transaction
        if self.ach_transaction:
            _dict['ach_transaction'] = self.ach_transaction.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AchTransaction:
        """Create an instance of AchTransaction from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AchTransaction.parse_obj(obj)

        _obj = AchTransaction.parse_obj({
            ...
            "type": obj.get("type"),
            "ach_transaction": AchTransactionData.from_dict(obj.get("ach_transaction")) if obj.get("ach_transaction") is not None else None,
