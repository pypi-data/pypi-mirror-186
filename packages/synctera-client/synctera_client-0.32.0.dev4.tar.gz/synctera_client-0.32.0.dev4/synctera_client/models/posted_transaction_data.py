...
class PostedTransactionData(BaseModel):
    ...
    lines: List[TransactionLine1] = Field(..., description="The set of accounting entries associated with this transaction. For example, a debit to a customer account will have a corresponding credit in a general ledger account.")
