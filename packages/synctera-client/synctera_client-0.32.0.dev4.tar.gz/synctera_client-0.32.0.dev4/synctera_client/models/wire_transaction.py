...
class WireTransaction(BaseModel):
    ...
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "system_description", "transaction_time", "type", "subtype", "wire_transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WireTransaction:
        """Create an instance of WireTransaction from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of wire_transaction
        if self.wire_transaction:
            _dict['wire_transaction'] = self.wire_transaction.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> WireTransaction:
        """Create an instance of WireTransaction from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return WireTransaction.parse_obj(obj)

        _obj = WireTransaction.parse_obj({
            ...
            "wire_transaction": WireTransactionData.from_dict(obj.get("wire_transaction")) if obj.get("wire_transaction") is not None else None
        })
        return _obj
