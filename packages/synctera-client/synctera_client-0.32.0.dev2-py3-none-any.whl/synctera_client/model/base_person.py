...
class BasePerson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ban_status", "creation_time", "email", "id", "kyc_exempt", "kyc_last_run", "kyc_status", "last_updated_time", "legal_address", "metadata", "middle_name", "phone_number", "related_customers", "shipping_address", "ssn", "ssn_source", "tenant", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ban_status", "creation_time", "email", "id", "kyc_exempt", "kyc_last_run", "kyc_status", "last_updated_time", "legal_address", "metadata", "middle_name", "phone_number", "related_customers", "shipping_address", "ssn", "ssn_source", "tenant", ], str]):
