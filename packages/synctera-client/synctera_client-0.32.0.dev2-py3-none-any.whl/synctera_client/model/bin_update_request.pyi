...
class BinUpdateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bin_status"], typing_extensions.Literal["card_brand"], typing_extensions.Literal["card_category"], typing_extensions.Literal["card_product_type"], typing_extensions.Literal["end_date"], typing_extensions.Literal["is_tokenization_enabled"], typing_extensions.Literal["physical_card_format"], typing_extensions.Literal["start_date"], ]):
