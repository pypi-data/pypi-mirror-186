...
class PatchAccountsRequestRoutingIdentifiers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ach_routing_number", "bank_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ach_routing_number", "bank_name", ], str]):
