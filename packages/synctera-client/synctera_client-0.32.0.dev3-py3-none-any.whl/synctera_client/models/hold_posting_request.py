...
class HoldPostingRequest(BaseModel):
    ...
    hold_amount: conint(strict=True, ge=0) = Field(..., description="The amount of the hold.")
    ...
    __properties = ["account_no", "amount", "effective_date", "external_data", "hold_amount", "risk_info", "subtype", "user_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HoldPostingRequest:
        """Create an instance of HoldPostingRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HoldPostingRequest:
        """Create an instance of HoldPostingRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HoldPostingRequest.parse_obj(obj)

        _obj = HoldPostingRequest.parse_obj({
            "account_no": obj.get("account_no"),
            "amount": obj.get("amount"),
            "effective_date": obj.get("effective_date"),
            "external_data": obj.get("external_data"),
            "hold_amount": obj.get("hold_amount"),
