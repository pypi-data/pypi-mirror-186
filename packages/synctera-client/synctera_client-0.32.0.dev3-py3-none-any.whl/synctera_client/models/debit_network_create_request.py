...
class DebitNetworkCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitNetworkCreateRequest:
        """Create an instance of DebitNetworkCreateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitNetworkCreateRequest:
        """Create an instance of DebitNetworkCreateRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DebitNetworkCreateRequest.parse_obj(obj)

        _obj = DebitNetworkCreateRequest.parse_obj({
