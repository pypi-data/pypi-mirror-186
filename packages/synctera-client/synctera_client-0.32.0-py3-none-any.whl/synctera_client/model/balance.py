...
def lazy_import():
    ...
    globals()['BalanceType'] = BalanceType
...
class Balance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, type, *args, **kwargs):  # noqa: E501
        """Balance - a model defined in OpenAPI

        Args:
            balance (int): balance in ISO 4217 minor currency units. Unit in cents.
            type (BalanceType):
