...
class TransferReversalRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, currency, *args, **kwargs):  # noqa: E501
        """TransferReversalRequest - a model defined in OpenAPI

        Args:
            amount (int): Amount of the refund in cents (Amount can be up to the original amount)
