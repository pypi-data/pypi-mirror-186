...
def lazy_import():
    ...
    globals()['ExternalAccountTransaction'] = ExternalAccountTransaction


class ExternalAccountsTransactionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'transactions': ([ExternalAccountTransaction],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, transactions, *args, **kwargs):  # noqa: E501
        """ExternalAccountsTransactionList - a model defined in OpenAPI

        Args:
            transactions ([ExternalAccountTransaction]): Array of transactions of a given external account
