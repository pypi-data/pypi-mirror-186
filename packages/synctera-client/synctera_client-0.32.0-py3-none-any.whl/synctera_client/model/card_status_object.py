...
class CardStatusObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_status, *args, **kwargs):  # noqa: E501
        """CardStatusObject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_status, *args, **kwargs):  # noqa: E501
        """CardStatusObject - a model defined in OpenAPI
