...
class PersonBusinessOwnerRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PersonBusinessOwnerRelationship - a model defined in OpenAPI

        Keyword Args:
            additional_data (AdditionalOwnerData):
            from_person_id (str): Unique ID for the subject person. 
