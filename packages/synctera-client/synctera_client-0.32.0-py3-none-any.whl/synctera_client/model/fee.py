...
class Fee(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, currency, fee_type, product_type, *args, **kwargs):  # noqa: E501
        """Fee - a model defined in OpenAPI

        Args:
            amount (int): Fee amount
            currency (str): Fee currency code in ISO 4217
            fee_type (str): Fee type
            product_type (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, currency, fee_type, product_type, *args, **kwargs):  # noqa: E501
        """Fee - a model defined in OpenAPI
