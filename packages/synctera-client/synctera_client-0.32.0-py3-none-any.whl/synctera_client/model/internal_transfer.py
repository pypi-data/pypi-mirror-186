...
class InternalTransfer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, currency, type, *args, **kwargs):  # noqa: E501
        """InternalTransfer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, currency, type, *args, **kwargs):  # noqa: E501
        """InternalTransfer - a model defined in OpenAPI
