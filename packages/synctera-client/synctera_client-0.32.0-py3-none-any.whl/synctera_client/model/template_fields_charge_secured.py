...
def lazy_import():
    ...
    globals()['TemplateFieldsChargeSecuredAllOf'] = TemplateFieldsChargeSecuredAllOf


class TemplateFieldsChargeSecured(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateFieldsChargeSecured - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            interest_product_id (str): An interest account product that the current account associates with. The account product must have its calculation_method set to COMPOUNDED_DAILY, and its rates set to 0%. 
