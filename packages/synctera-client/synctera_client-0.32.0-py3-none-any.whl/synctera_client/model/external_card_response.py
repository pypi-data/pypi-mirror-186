...
def lazy_import():
    ...
    globals()['ExternalCardVerifications'] = ExternalCardVerifications


class ExternalCardResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'verifications': (ExternalCardVerifications,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, customer_id, expiration_month, expiration_year, id, last_four, name, *args, **kwargs):  # noqa: E501
        """ExternalCardResponse - a model defined in OpenAPI
        ...
        Args:
            ...
            expiration_year (str):
            id (str): External card ID
            last_four (str): The last 4 digits of the card PAN
        ...
        Keyword Args:
            ...
            verifications (ExternalCardVerifications): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, customer_id, id, name, *args, **kwargs):  # noqa: E501
        """ExternalCardResponse - a model defined in OpenAPI
