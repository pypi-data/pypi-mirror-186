...
def lazy_import():
    ...
    globals()['BasePerson1'] = BasePerson1
    globals()['SsnSource'] = SsnSource
    globals()['Status1'] = Status1
    globals()['VerificationStatus'] = VerificationStatus


class Person(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status': (Status1,),  # noqa: E501
            'ban_status': (BanStatus,),  # noqa: E501
            'chosen_name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'chosen_name': 'chosen_name',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            is_customer (bool): True for personal and business customers with a direct relationship with the fintech or bank. Set this to true for any customer related to an account. 
            status (Status1):
            ...
            chosen_name (str): Person's chosen name.. [optional]  # noqa: E501
            creation_time (datetime): The date and time the resource was created.. [optional]  # noqa: E501
            dob (date): Person's date of birth in RFC 3339 full-date format (YYYY-MM-DD).. [optional]  # noqa: E501
            email (str): Person's email.. [optional]  # noqa: E501
            first_name (str): Person's first name.. [optional]  # noqa: E501
            id (str): Person's unique identifier.. [optional]  # noqa: E501
            last_name (str): Person's last name.. [optional]  # noqa: E501
            ...
            middle_name (str): Person's middle name.. [optional]  # noqa: E501
            phone_number (str): Person's mobile phone number with country code in E.164 format. Must have a valid country code. Area code and local phone number are not validated. [optional]  # noqa: E501
            shipping_address (Address): [optional]  # noqa: E501
            ssn (str): Person's full tax ID eg SSN formatted with hyphens. The response contains the last 4 digits only (e.g. 6789).. [optional]  # noqa: E501
            ssn_source (SsnSource): [optional]  # noqa: E501
            tenant (str): The id of the tenant containing the resource. . [optional]  # noqa: E501
            verification_last_run (datetime): Date and time KYC verification was last run on the person.. [optional]  # noqa: E501
