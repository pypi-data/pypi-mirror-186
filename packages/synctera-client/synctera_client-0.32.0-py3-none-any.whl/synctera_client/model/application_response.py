...
class ApplicationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_time, enabled, id, last_modified_time, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            external_id (str): The id of the application from processor. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_time, enabled, id, last_modified_time, *args, **kwargs):  # noqa: E501
        """ApplicationResponse - a model defined in OpenAPI
