...
def lazy_import():
    ...
    globals()['DisclosureType'] = DisclosureType
    globals()['Version'] = Version


class BaseDisclosure(ModelNormal):
    ...
    attribute_map = {
        ...
        'disclosure_date': 'disclosure_date',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BaseDisclosure - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            disclosure_date (datetime): Date and time the disclosure was made.. [optional]  # noqa: E501
            event_type (str): Describes how the disclosure was shown and what the user did as a result. One of the following: * `DISPLAYED` —     The document was made visible to the user,     but they did not interact with it. * `VIEWED` —     The document was made visible to the user,     and they interacted enough to see the whole document (e.g. scrolled to the bottom). * `ACKNOWLEDGED` —     The document was made visible to the user,     and they took positive action to confirm that they have read and accepted the document. . [optional]  # noqa: E501
            ...
            type (DisclosureType): [optional]  # noqa: E501
