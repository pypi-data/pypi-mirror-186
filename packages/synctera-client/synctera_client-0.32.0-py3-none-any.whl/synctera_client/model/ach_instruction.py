...
def lazy_import():
    ...
    globals()['OutgoingAchRequest'] = OutgoingAchRequest


class AchInstruction(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'request': (OutgoingAchRequest,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request, *args, **kwargs):  # noqa: E501
        """AchInstruction - a model defined in OpenAPI

        Args:
            request (OutgoingAchRequest):

        Keyword Args:
            type (str): defaults to "ACH", must be one of ["ACH", ]  # noqa: E501
