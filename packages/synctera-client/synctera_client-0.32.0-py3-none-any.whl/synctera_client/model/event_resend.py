...
class EventResend(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_id, event_type, *args, **kwargs):  # noqa: E501
        """EventResend - a model defined in OpenAPI

        Args:
            event_id (str): id of the event notification you want to resend
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_id, event_type, *args, **kwargs):  # noqa: E501
        """EventResend - a model defined in OpenAPI
