...
def lazy_import():
    ...
    globals()['TemplateFieldsGenericResponse'] = TemplateFieldsGenericResponse


class AccountTemplateResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'template': (TemplateFieldsGenericResponse,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_enabled, name, template, *args, **kwargs):  # noqa: E501
        """AccountTemplateResponse - a model defined in OpenAPI

        Args:
            is_enabled (bool): Whether this template can be used for account creation
            name (str): Unique account template name
        ...
        Keyword Args:
            ...
            description (str): Account template description. [optional]  # noqa: E501
            id (str): Generated ID for the template. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_enabled, name, template, *args, **kwargs):  # noqa: E501
        """AccountTemplateResponse - a model defined in OpenAPI
