...
class DisclosuresApi(object):
    ...
    @validate_arguments
    def list_disclosures_with_http_info(self, id : Annotated[Optional[List[StrictStr]], Field(description="Unique resource identifier")] = None, person_id : Annotated[Optional[List[StrictStr]], Field(description="Unique identifier for the person. Multiple IDs can be provided as a comma-separated list. ")] = None, business_id : Annotated[Optional[List[StrictStr]], Field(description="Unique identifier for the business. Multiple IDs can be provided as a comma-separated list. ")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """List disclosures  # noqa: E501
