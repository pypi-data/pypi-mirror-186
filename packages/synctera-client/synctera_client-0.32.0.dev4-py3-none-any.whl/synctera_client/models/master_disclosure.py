...
class MasterDisclosure(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MasterDisclosure:
        """Create an instance of MasterDisclosure from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MasterDisclosure:
        """Create an instance of MasterDisclosure from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MasterDisclosure.parse_obj(obj)

        _obj = MasterDisclosure.parse_obj({
