...
class HoldModifyRequest(BaseModel):
    ...
    __properties = ["account_no", "allow_partial", "amount", "effective_date", "expires_at", "external_data", "force_post", "risk_info", "subtype", "user_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HoldModifyRequest:
        """Create an instance of HoldModifyRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HoldModifyRequest:
        """Create an instance of HoldModifyRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HoldModifyRequest.parse_obj(obj)

        _obj = HoldModifyRequest.parse_obj({
