...
class PatchInterest(BaseModel):
    ...
    rates: Optional[List[RateDetails]] = Field(None, description="A list of interest rate. Date intervals between valid_from and valid_to expect to have no overlap. ")
