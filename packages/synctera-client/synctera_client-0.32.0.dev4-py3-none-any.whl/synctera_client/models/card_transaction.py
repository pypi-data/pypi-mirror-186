...
class CardTransaction(BaseModel):
    ...
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "system_description", "transaction_time", "type", "card_transaction", "subtype"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardTransaction:
        """Create an instance of CardTransaction from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of card_transaction
        if self.card_transaction:
            _dict['card_transaction'] = self.card_transaction.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CardTransaction:
        """Create an instance of CardTransaction from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CardTransaction.parse_obj(obj)

        _obj = CardTransaction.parse_obj({
            ...
            "type": obj.get("type"),
            "card_transaction": CardTransactionData.from_dict(obj.get("card_transaction")) if obj.get("card_transaction") is not None else None,
