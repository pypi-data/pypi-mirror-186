...
class DebitNetwork(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitNetwork:
        """Create an instance of DebitNetwork from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitNetwork:
        """Create an instance of DebitNetwork from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DebitNetwork.parse_obj(obj)

        _obj = DebitNetwork.parse_obj({
