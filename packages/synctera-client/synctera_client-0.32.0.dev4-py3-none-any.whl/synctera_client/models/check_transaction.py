...
class CheckTransaction(BaseModel):
    ...
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "system_description", "transaction_time", "type", "check_transaction", "subtype"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CheckTransaction:
        """Create an instance of CheckTransaction from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of check_transaction
        if self.check_transaction:
            _dict['check_transaction'] = self.check_transaction.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CheckTransaction:
        """Create an instance of CheckTransaction from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CheckTransaction.parse_obj(obj)

        _obj = CheckTransaction.parse_obj({
            ...
            "type": obj.get("type"),
            "check_transaction": CheckTransactionData.from_dict(obj.get("check_transaction")) if obj.get("check_transaction") is not None else None,
