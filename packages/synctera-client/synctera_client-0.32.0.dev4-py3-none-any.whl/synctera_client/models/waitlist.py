...
class Waitlist(BaseModel):
    ...
    increment: StrictInt = Field(..., description="Number of points earned per verified referral")
    ...
    waitlist_name: StrictStr = Field(..., description="Waitlist Name")
    __properties = ["creation_time", "id", "last_updated_time", "num_admitted", "num_created", "num_prospects", "num_verified", "num_withdrawn", "description", "increment", "max_prospects", "waitlist_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Waitlist:
        """Create an instance of Waitlist from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Waitlist:
        """Create an instance of Waitlist from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Waitlist.parse_obj(obj)

        _obj = Waitlist.parse_obj({
