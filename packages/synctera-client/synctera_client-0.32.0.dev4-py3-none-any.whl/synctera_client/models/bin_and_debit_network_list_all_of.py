...
class BinAndDebitNetworkListAllOf(BaseModel):
    ...
    __properties = ["bin_and_debit_networks"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BinAndDebitNetworkListAllOf:
        """Create an instance of BinAndDebitNetworkListAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BinAndDebitNetworkListAllOf:
        """Create an instance of BinAndDebitNetworkListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BinAndDebitNetworkListAllOf.parse_obj(obj)

        _obj = BinAndDebitNetworkListAllOf.parse_obj({
