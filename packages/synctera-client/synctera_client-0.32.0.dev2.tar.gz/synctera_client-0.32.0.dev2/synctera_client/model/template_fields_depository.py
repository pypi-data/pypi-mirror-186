...
class TemplateFieldsDepository(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["balance_ceiling", "balance_floor", "fee_product_ids", "interest_product_id", "is_ach_enabled", "is_card_enabled", "is_p2p_enabled", "is_wire_enabled", "overdraft_limit", "spend_control_ids", "spending_limits", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["balance_ceiling", "balance_floor", "fee_product_ids", "interest_product_id", "is_ach_enabled", "is_card_enabled", "is_p2p_enabled", "is_wire_enabled", "overdraft_limit", "spend_control_ids", "spending_limits", ], str]):
