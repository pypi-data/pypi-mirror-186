...
class Reconciliation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ingestion_status() -> typing.Type['IngestionStatus']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ingestion_status"]) -> 'IngestionStatus': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file_name", "id", "ingestion_status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ingestion_status"]) -> 'IngestionStatus': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file_name", "id", "ingestion_status", ], str]):
