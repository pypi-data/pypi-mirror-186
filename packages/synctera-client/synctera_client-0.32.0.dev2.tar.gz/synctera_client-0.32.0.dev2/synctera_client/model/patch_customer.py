...
class PatchCustomer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dob", "email", "first_name", "last_name", "legal_address", "metadata", "middle_name", "phone_number", "shipping_address", "ssn", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dob", "email", "first_name", "last_name", "legal_address", "metadata", "middle_name", "phone_number", "shipping_address", "ssn", "status", ], str]):
