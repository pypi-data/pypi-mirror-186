...
from src.wantedposter.wantedposter import WantedPoster, VerticalAlignment, HorizontalAlignment, CaptureCondition
...
def main():
    ...
    # Generate poster
    path = wanted_poster.generate(portrait_horizontal_align=HorizontalAlignment.CENTER,
