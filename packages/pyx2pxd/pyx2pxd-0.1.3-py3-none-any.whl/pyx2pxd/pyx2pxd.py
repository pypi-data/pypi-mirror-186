...
def autogenerate_pxd_files(pyx_filename):
    ...
    autogen = False
    pxd_lines = ["# autogenerated by pyx2pxd - https://github.com/HenriquesLab/pyx2pxd", ""]
    ...
    if os.path.exists(pxd_filename) and open(pxd_filename).read() == pxd_text:
        return "- Skipping .pxd autogen (already exists, no changes needed): " + pyx_filename
...
def main():
    ...
    print(f"Autogenerating .pxd files...")
    msgs = []
    for file in pyx_files:
        msgs.append(autogenerate_pxd_files(file))
