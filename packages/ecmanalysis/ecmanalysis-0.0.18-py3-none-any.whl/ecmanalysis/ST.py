...
# Tools for analysis of extracellular matrix in spatial transcriptomic (ST) datasets 

# Tools available at the moment: 
#     1. MatriClust - Clusters full matrisome or divisions/categories. 
...
# Package 
class MatriClust:
  ''' Clusters matrisome in  spatial transcriptomic datasets '''
  def __init__(self, pf=None,cf=None, multiple_datasets=None, dataset_names=None):
    ''' 
    ...
    if not os.path.isfile('matrisome_hs_masterlist.xls'): 
      ...
      download_file('http://matrisomeproject.mit.edu/static/media/uploads/Files/Human%20in%20silico%20matrisome/matrisome_hs_masterlist.xls', 'matrisome_hs_masterlist.xls')
