...
class STMatriClust:
  ...
  def __init__(self, pf,cf, multiple_datasets, dataset_names):
    ...
    if not os.path.isfile('matrisome_hs_masterlist.xls'): 
      ...
      wget.download('http://matrisomeproject.mit.edu/static/media/uploads/Files/Human%20in%20silico%20matrisome/matrisome_hs_masterlist.xls')
    ...
    if not os.path.isfile('display.aspx?DocID=57554'): 
      ...
      wget.download('https://documents.manchester.ac.uk/display.aspx?DocID=57554')
    else:
