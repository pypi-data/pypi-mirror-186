...
def jam_lnprob(pars, surf_lum=None, sigma_lum=None, qobs_lum=None,
    ...
    jam = jam_axi_proj(surf_lum, sigma_lum, qobs_lum, surf_pot*10**lg_ml, sigma_pot, qobs_pot,
...
def jam_black_hole_adamet_example():
    ...
    bounds = [[0.051, 0.5, bh0/1.3, lg_ml0-0.04], [qmin, 1.5, bh0*1.3, lg_ml0+0.04]]
    ...
    pars, lnprob = adamet(jam_lnprob, p0, sigpar, bounds, nstep, fignum=1,
                          kwargs=kwargs, nprint=nstep/10, labels=labels, seed=3)
