...
def flip(override_context: typing.Union[typing.
         ...
         undo: typing.Optional[bool] = None,
         *,
         use_flip_horizontal: typing.Union[bool, typing.Any] = False,
         use_flip_vertical: typing.Union[bool, typing.Any] = False):
    ''' Flip the image
    ...
    :type use_flip_horizontal: typing.Union[bool, typing.Any]
    :param use_flip_vertical: Vertical, Flip the image vertically
    :type use_flip_vertical: typing.Union[bool, typing.Any]
    '''
