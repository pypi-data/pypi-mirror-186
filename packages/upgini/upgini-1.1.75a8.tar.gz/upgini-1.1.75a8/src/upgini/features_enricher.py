...
class FeaturesEnricher(TransformerMixin):
            ...
            try:
                ...
                with Spinner():
                    ...
                    if not isinstance(_cv, BaseCrossValidator):
                        date_column = self.__get_date_column(self.search_keys)
    ...
    def _prepare_data_for_metrics(
        ...
        if not self.imbalanced:
            ...
            if self.eval_set is not None:
                ...
                for idx in enriched_eval_set[EVAL_SET_INDEX].unique():
                    enriched_eval_x = enriched[enriched[EVAL_SET_INDEX] == idx].copy()
        ...
        client_features = [c for c in extended_X.columns.to_list() if c not in search_keys.keys()]
        ...
        return validated_X, fitting_X, y_sorted, fitting_enriched_X, enriched_y_sorted, fitting_eval_set_dict
