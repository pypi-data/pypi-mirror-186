...
def Command():
    ...
    if mode == "-e":
        ...
        elif algorithm == "--morse":print("Write your message with ''. Example: 'pycryptools --morse -mode 'text-example''\nEncrypt: ", Morse.encrypt(message))
